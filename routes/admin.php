...
Route::prefix('/admin')->middleware('auth:admin', 'Demo')->group(function () {
  ...
  Route::prefix('package')->group(function () {
    ...
    Route::post('/settings', 'BackEnd\PackageController@updateSettings')->name('admin.package.settings.update');
    // Package routes
  ...
  // missions route start (Gestion Clients)
  Route::prefix('/missions')->middleware('permission:Service Orders')->group(function () {
    Route::get('', 'BackEnd\MissionAdminController@index')->name('admin.missions.index');
    Route::get('/{id}', 'BackEnd\MissionAdminController@show')->name('admin.missions.show');
    Route::put('/{id}/update-status', 'BackEnd\MissionAdminController@updateStatus')->name('admin.missions.update-status');
  });
  // missions route end
