...
<?php $__env->startSection('style'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/front/css/services-hub.css')); ?>">
  <style>
    :root {
      --royal-blue: #4169E1;
...
<?php $__env->startSection('content'); ?>
  ...
  <section class="hero-modern" <?php if($soieImagePath): ?> style="background-image: url('<?php echo e($soieImagePath); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;" <?php endif; ?>>
    <div class="container">
      <div class="row align-items-center">
        <!-- Contenu gauche -->
        <div class="col-lg-6 hero-content-left" data-aos="fade-right">
          <h1 class="hero-title mb-5">
            <span class="hero-title-line-1"><?php echo e(__('Des missions pour vos besoins.')); ?></span>
            <span class="hero-title-line-2"><?php echo e(__('Des rituels pour vos résultats.')); ?></span>
          </h1>
          ...
          <div id="heroSegmentationContainer" style="position: relative; z-index: 10;">
            ...
            <div class="hero-segmentation" data-aos="fade-up" data-aos-delay="150">
              ...
              <a href="<?php echo e(route('freelance.onboarding.start')); ?>" class="segmentation-link-freelance">
                Freelance
              </a>
              </div>
            ...
            <div class="hero-ctas" data-aos="fade-up" data-aos-delay="180">
              ...
              <div id="cta-entreprise" class="cta-group">
                <a href="<?php echo e(route('mission.form')); ?>" class="btn-cta-primary">
                  Déposer une mission
                </a>
                <a href="<?php echo e(route('services')); ?>" class="btn-cta-secondary">
                  Trouver un freelance
                </a>
                <a href="<?php echo e(route('freelance.onboarding.start')); ?>" class="btn-cta-link">
              ...
              <div id="cta-particulier" class="cta-group" style="display: none;">
                <a href="<?php echo e(route('services')); ?>" class="btn-cta-primary">
                  Réserver un rituel
                </a>
              </div>
            </div>
            ...
            <div class="hero-proof-container">
              <div class="hero-proof-item">
                ...
                <div class="hero-proof-text">
                  <?php echo e(__('Profils vérifiés')); ?>
              ...
              <div class="hero-proof-item">
                ...
                <div class="hero-proof-text">
                  <span style="display: block; white-space: nowrap;"><?php echo e(__('Séance d\'essai')); ?></span>
                  <span style="display: block; white-space: nowrap;"><?php echo e(__('de 1h')); ?></span>
                </div>
              </div>
              ...
              <div class="hero-proof-item">
                ...
                <div class="hero-proof-text">
                  <span style="display: block; white-space: nowrap;"><?php echo e(__('Réservation simple')); ?></span>
                  <span style="display: block; white-space: nowrap;"><?php echo e(__('et paiement sécurisé')); ?></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 hero-photo-column" data-aos="fade-left">
          ...
          <div class="hero-freelancer-card">
            <img src="<?php echo e($heroFreelancerImage); ?>" 
                 alt="<?php echo e($heroFreelancerName); ?>" 
            ...
            <div class="hero-freelancer-info">
              <h3 class="hero-freelancer-name"><?php echo e($heroFreelancerName); ?></h3>
              <p class="hero-freelancer-role"><?php echo e($heroFreelancerRole); ?></p>
              <p class="hero-freelancer-location"><?php echo e($heroFreelancerLocation); ?></p>
          </div>
        </div>
      </div>
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.search-filter','data' => ['formId' => 'homeHubSearchFilter','formAction' => route('services'),'universe' => 'hub','hubUniverses' => $hubUniverses ?? [],'hubUniverseDomains' => $hubUniverseDomains ?? [],'keywordPlaceholder' => 'Essayez « Pilates », « Marketing Digital », « Anglais »...','locationPlaceholder' => 'Lieu de la mission (ex: Paris, Lyon...)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['formId' => 'homeHubSearchFilter','formAction' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('services')),'universe' => 'hub','hubUniverses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUniverses ?? []),'hubUniverseDomains' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($hubUniverseDomains ?? []),'keywordPlaceholder' => 'Essayez « Pilates », « Marketing Digital », « Anglais »...','locationPlaceholder' => 'Lieu de la mission (ex: Paris, Lyon...)']); ?>
...
<?php endif; ?>
      ...
      <div class="rituels-universes-grid">
        <?php if(isset($universes)): ?>
          <?php $__currentLoopData = $universes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $universe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rituel-universe-item" data-index="<?php echo e($index); ?>">
              <div class="rituel-universe-bubble">
                <div class="rituel-universe-content">
                  <div class="rituel-universe-header">
                    ...
                    <h3 class="rituel-universe-title"><?php echo e($universe['title']); ?></h3>
                </div>
                  <a href="<?php echo e($universe['url']); ?>" class="rituel-universe-cta">
      ...
      <div class="row">
        <div class="col-12">
          <div class="text-center" data-aos="fade-up" style="max-width: 900px; margin: 0 auto; padding: 0 20px;">
            <h2 class="section-title-modern mb-5"><?php echo e(__('Notre Vision')); ?></h2>
            ...
            <div style="text-align: left; font-size: 1.1rem; line-height: 1.9; color: #1a202c; margin-bottom: 2rem;">
              ...
              <div id="visionMoreContent" style="display: none; margin-bottom: 1.5rem; animation: fadeIn 0.3s ease-in;">
                ...
                <div style="text-align: center; margin-top: 3rem;">
                  ...
                  <a href="<?php echo e(route('explore')); ?>" class="btn-vision-rituel">
                    <?php echo e(__('Réserver un Rituel d\'essai')); ?>
  ...
  <?php if(isset($popularRituals) && count($popularRituals) > 0): ?>
    <section class="section-modern">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title-modern" data-aos="fade-up"><?php echo e(__('Nos Rituels en Vedette')); ?></h2>
            <p class="section-subtitle-modern" data-aos="fade-up" data-aos-delay="100">
              <?php echo e(__('Découvrez nos domaines de Rituels les plus demandés')); ?>

            </p>
                  </div>
                </div>
        <div class="row g-4">
          <?php $__currentLoopData = $popularRituals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ritual): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 50); ?>">
              <div class="popular-category-card" data-universe-index="<?php echo e($ritual['universeIndex']); ?>">
                <div class="popular-category-icon" style="background: <?php echo e($ritual['colorGradient']); ?>;">
                  <?php
                    $iconMap = [
                ...
                <h5 class="popular-category-title"><?php echo e($ritual['name']); ?></h5>
                <a href="<?php echo e($ritual['url']); ?>" class="popular-category-link">
                  <?php echo e(__('Réserver un Rituel d\'essai')); ?> <i class="fas fa-arrow-right ms-1"></i>
                </a>
          </div>
                                  </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <?php if(isset($highlightedFreelancers) && $highlightedFreelancers->count() > 0): ?>
    <section class="section-modern bg-light">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title-modern" data-aos="fade-up"><?php echo e(__('Freelances du mois')); ?></h2>
            <p class="section-subtitle-modern" data-aos="fade-up" data-aos-delay="100">
              <?php echo e(__('Découvrez nos meilleurs freelances experts, vérifiés et notés par la communauté')); ?>
        ...
        <div class="freelancers-slider-container">
          <div class="swiper freelancers-recommended-slider">
            <div class="swiper-wrapper">
              ...
              ?>
              <?php $__currentLoopData = $highlightedFreelancers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freelancer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="swiper-slide">
                  <a href="<?php echo e($freelancerUrl); ?>" class="freelancer-card-link" style="text-decoration: none; display: block;">
                    <div class="freelancer-card-slider-modern">
                      <?php if($photoUrl): ?>
                        <img src="<?php echo e($photoUrl); ?>" alt="" class="freelancer-card-photo" loading="lazy"
                             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                      <?php endif; ?>
                      <div class="freelancer-card-photo-fallback" style="display: <?php echo e($photoUrl ? 'none' : 'flex'); ?>;">
                        <i class="fas fa-image"></i>
                      </div>
                      <div class="freelancer-card-overlay <?php echo e($photoUrl ? 'freelancer-card-overlay-with-photo' : ''); ?>"></div>
                      <div class="freelancer-card-content">
                        <div class="freelancer-card-content-inner">
                          <h5 class="freelancer-card-name"><?php echo e($displayName); ?></h5>
                          <div class="freelancer-card-meta">
                            <span><i class="fas fa-map-marker-alt"></i> <?php echo e($user->country_code ?? '—'); ?></span>
                            <span><strong><?php echo e(number_format($freelancer->hourly_rate ?? 0, 0, ',', ' ')); ?> €/h</strong></span>
                            <?php if($freelancer->reliability_score): ?>
                              <span class="freelancer-card-score"><?php echo e($freelancer->reliability_score); ?>/100</span>
                            <?php endif; ?>
                          </div>
                          <?php if($user->is_verified_freelancer ?? $freelancer->is_verified ?? false): ?>
                            <span class="freelancer-card-badge-verified"><i class="fas fa-check-circle"></i> Vérifié</span>
                          <?php endif; ?>
                          <div class="freelancer-card-cta"><?php echo e(__('Voir le profil')); ?></div>
                        </div>
        ...
        <div class="row mt-5">
          <div class="col-12">
            <div class="freelances-actions">
              <a href="<?php echo e(route('explore')); ?>" class="btn btn-primary-modern btn-lg">
                <?php echo e(__('Voir tous les freelances')); ?>

                <i class="fas fa-arrow-right ms-2"></i>
              </a>
              <a href="<?php echo e(route('freelance.onboarding.start')); ?>" class="btn btn-outline-modern btn-lg">
      ...
      <div class="container">
        ...
        <div class="blog-header-premium">
          ...
          <div class="blog-header-actions">
            <a href="<?php echo e(route('blog')); ?>" class="btn-blog-primary">
            ...
            <?php if($servicesRoute): ?>
              <a href="<?php echo e($servicesRoute); ?>" class="btn-blog-secondary">
              ...
              <div class="blog-slider-track">
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <article class="blog-card-premium">
                    <a href="<?php echo e(route('blog.post_details', ['slug' => $post->slug, 'id' => $post->id])); ?>" class="blog-card-link-premium">
                      <div class="blog-image-wrapper-premium">
                        <?php if(!empty($post->image)): ?>
                          <img class="blog-image-premium lazyload" 
                            data-src="<?php echo e(asset('assets/img/posts/' . $post->image)); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(isset($post->categoryName)): ?>
                          <span class="blog-category-badge"><?php echo e($post->categoryName); ?></span>
                        <?php endif; ?>
                      </div>
                      <div class="blog-card-content-premium">
                        <h3 class="blog-card-title-premium">
                          <?php echo e(strlen($post->title) > 80 ? mb_substr($post->title, 0, 80, 'UTF-8') . '...' : $post->title); ?>

                        </h3>
                        <p class="blog-card-excerpt-premium">
                          <?php echo strlen(strip_tags($post->content)) > 120
                        ...
                        <div class="blog-card-meta-premium">
                          <span class="blog-reading-time">
                            ...
                            ?>
                            <?php echo e($readingTime); ?>mn à lire
                          </span>
                        </div>
                      </div>
                    </a>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/frontend/home/index-v3.blade.php ENDPATH**/ ?>