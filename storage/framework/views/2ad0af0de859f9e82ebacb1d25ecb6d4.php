  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        <?php echo e(__('Avec qui voulez-vous continuer ?')); ?>

      </h2>
      
      <div class="transfer-select-subtitle">
        <?php echo e(__('Pas encore abonné(e)')); ?>
    ...
    <div class="transfer-modal-body" style="max-height: calc(90vh - 200px); overflow-y: auto;">
      ...
      <div x-show="loading" class="transfer-loading">
        ...
        <p><?php echo e(__('Chargement des freelances...')); ?></p>
      </div>
      ...
      <div x-show="!loading && notSubscribedFreelances.length > 0" class="transfer-freelancers-list">
        <div class="transfer-freelancers-group">
          <div class="transfer-freelancers-group-title"><?php echo e(__('Pas encore abonné(e)')); ?></div>
          <template x-for="freelance in notSubscribedFreelances" :key="freelance.id">
            ...
            >
              <div class="transfer-freelance-avatar">
                <img 
                  x-bind:src="freelance.avatar || '<?php echo e(asset('assets/img/noimage.jpg')); ?>'"
              ...
              <div class="transfer-freelance-info">
                ...
                <div class="transfer-freelance-details">
                  <span x-show="freelance.trial_done"><?php echo e(__('Rituel d\'essai effectué')); ?> · </span>
                  <span x-text="formatPrice(freelance.price_per_session)"></span> <?php echo e(__('/ Rituel')); ?>
      ...
      <div x-show="!loading && cancelledFreelances.length > 0" class="transfer-freelancers-list">
        <div class="transfer-freelancers-group">
          <div class="transfer-freelancers-group-title"><?php echo e(__('Abonnements annulés')); ?></div>
      ...
      <div x-show="!loading && notSubscribedFreelances.length === 0 && cancelledFreelances.length === 0" class="transfer-empty-state">
        ...
        <p class="transfer-empty-text"><?php echo e(__('Aucun freelance disponible')); ?></p>
      </div>
    </div>
  </div>
</div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\add\step2-select-freelance.blade.php ENDPATH**/ ?>