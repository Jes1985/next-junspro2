  ...
  >
    ...
    <div class="transfer-entry-modal-header">
      ...
      <h2 class="transfer-entry-modal-title">
        <?php echo e(__('Que souhaitez-vous faire ?')); ?>
    ...
    <div class="transfer-entry-modal-body">
      ...
      >
        ...
        <div class="transfer-entry-option-content">
          <div class="transfer-entry-option-title">
            <?php echo e(__('Remplacer')); ?> <span x-text="tutorName"></span> <?php echo e(__('par un autre freelance')); ?>

          </div>
          <div class="transfer-entry-option-description">
            <?php echo e(__('Annulez votre abonnement avec')); ?> <span x-text="tutorName"></span> 
            <?php echo e(__('et utilisez votre solde restant pour régler votre abonnement avec un nouveau freelance.')); ?>
      ...
      >
        ...
        <div class="transfer-entry-option-content">
          <div class="transfer-entry-option-title">
            <?php echo e(__('Ajouter un autre freelance')); ?>

          </div>
          <div class="transfer-entry-option-description">
            <?php echo e(__('Gardez votre abonnement avec')); ?> <span x-text="tutorName"></span> 
            <?php echo e(__('et utilisez votre solde pour en souscrire un nouveau avec un autre freelance.')); ?>
      ...
      >
        ...
        <div class="transfer-entry-option-content">
          <div class="transfer-entry-option-title">
            <?php echo e(__('Transférer des rituels à un autre freelance actif')); ?>
      ...
      >
        ...
        <div class="transfer-entry-option-content">
          <div class="transfer-entry-option-title">
            <?php echo e(__('Trouvez un nouveau freelance')); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\entry.blade.php ENDPATH**/ ?>