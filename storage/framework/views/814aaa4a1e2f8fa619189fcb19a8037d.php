  ...
  <div class="dashboard-container">
    ...
    <aside class="sidebar">
      ...
      <div class="nav-section">
        ...
        <div class="nav-list">
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'overview'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'overview' ? 'active' : ''); ?>">
            <span class="nav-icon">📈</span>
            <span>Aperçu</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'requests'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'requests' ? 'active' : ''); ?>">
            <span class="nav-icon">📥</span>
            <span>Demandes</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'jobs'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'jobs' ? 'active' : ''); ?>">
            <span class="nav-icon">⚙️</span>
            <span>Prestations</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'calendar'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'calendar' ? 'active' : ''); ?>">
            <span class="nav-icon">📅</span>
            <span>Agenda</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'services'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'services' ? 'active' : ''); ?>">
            <span class="nav-icon">🛠️</span>
            <span>Services</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'messages'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'messages' ? 'active' : ''); ?>">
            <span class="nav-icon">✉️</span>
            <span>Messages</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'earnings'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'earnings' ? 'active' : ''); ?>">
            <span class="nav-icon">💳</span>
            <span>Revenus</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'profile'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'profile' ? 'active' : ''); ?>">
            <span class="nav-icon">👤</span>
            <span>Profil</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'settings'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'settings' ? 'active' : ''); ?>">
            <span class="nav-icon">⚙️</span>
            <span>Paramètres</span>
          </a>
          <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'rituals'])); ?>" class="nav-item <?php echo e($currentActiveTab === 'rituals' ? 'active' : ''); ?>">
            <span class="nav-icon">✨</span>
            <span>Rituels</span>
          </a>
        </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\dashboard\partials\dashboard-shell.blade.php ENDPATH**/ ?>