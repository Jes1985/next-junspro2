<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Conversation')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="<?php echo e(route('admin.support_tickets')); ?>"><?php echo e(__('All Tickets')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e($ticket->subject); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e(__('Conversation')); ?></a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="<?php echo e(route('admin.support_tickets')); ?>">
            ...
            <div class="col-12">
              ...
              <?php if($ticket->status != 'closed'): ?>
                <form class="ticketForm d-inline-block"
                  action="<?php echo e(route('admin.support_ticket.close', ['id' => $ticket->id])); ?>" method="post">
                  <?php echo csrf_field(); ?>
              ...
              <?php else: ?>
                <div class="messages-container">
                  <?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php elseif($conversation->person_type == 'seller'): ?>
                    ...
                    <?php else: ?>
                      ...
                      <div class="single-message">
                        <div class="user-details">
                          <div class="user-img">
                            <img
                              src="<?php echo e(!is_null($user->image) ? asset('assets/img/users/' . $user->image) : asset('assets/img/blank-user.jpg')); ?>"
                              alt="<?php echo e($user->first_name . ' ' . $user->last_name); ?>">
                          </div>

                          <div class="user-infos">
                            <h6 class="name"><?php echo e($user->first_name . ' ' . $user->last_name); ?></h6>
                            <span class="type"><i class="fas fa-user mr-2"></i><?php echo e(__('Customer')); ?></span>
                            <span
                              class="badge badge-secondary"><?php echo e($conversation->created_at->format('M d, Y - h:i A')); ?></span>
                          </div>
                        </div>
    ...
    <?php if($ticket->status != 'closed'): ?>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form id="replyForm" action="<?php echo e(route('admin.support_ticket.reply', ['id' => $ticket->id])); ?>"
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="attachment"
                          data-url="<?php echo e(route('admin.support_tickets.store_temp_file')); ?>">
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\support-ticket\conversation.blade.php ENDPATH**/ ?>