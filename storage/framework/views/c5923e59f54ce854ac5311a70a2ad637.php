...
<form action="<?php echo e($formAction); ?>" method="GET" id="<?php echo e($formId); ?>" class="search-filter-form" data-lock-route="<?php echo e($universe ? '1' : '0'); ?>" data-universe="<?php echo e($universe ?? ''); ?>" <?php if($hasLocationDuo): ?> data-initial-city="<?php echo e(request('city')); ?>" data-has-location-duo="1" <?php endif; ?>>
      ...
      <div class="filter-row-main <?php if($hasHeroDomainSpec): ?> filter-row-main--projects-hero <?php elseif($hasLocationDuo): ?> filter-row-main--has-location-duo <?php endif; ?> <?php if($isProjects): ?> filter-row-main--projects-hero-grid <?php endif; ?> <?php if($isLessons): ?> filter-row-main--lessons-hero-grid <?php endif; ?> <?php if($isAtHome): ?> filter-row-main--at-home-hero-grid <?php endif; ?> <?php if($isWellnesslive): ?> filter-row-main--wellnesslive-hero-grid <?php endif; ?> <?php if($isCorporate): ?> filter-row-main--corporate-hero-grid <?php endif; ?>">
        <?php if($hasHeroDomainSpec && ($isHub || $isProjects || $isLessons || $isAtHome || $isWellnesslive || $isCorporate)): ?>
        ...
        <div class="filter-input-group filter-hero-domain-spec filter-hero-domain-select-wrapper">
          ...
          <?php if($isHub): ?>
          <select name="universe" id="<?php echo e($heroDomainSelectId); ?>" class="filter-input filter-select filter-select-domain-hero" aria-label="<?php echo e(__('Tous les univers')); ?>">
            <option value=""><?php echo e(__('Tous les univers')); ?></option>
            <?php $__currentLoopData = $heroCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $__selectedUniverse = request('universe') ?: ($initialUniverse ?? ''); ?>
              <option value="<?php echo e($cat['slug'] ?? ''); ?>" <?php echo e($__selectedUniverse === ($cat['slug'] ?? '') ? 'selected' : ''); ?>><?php echo e(in_array(($cat['label'] ?? ''), ['WellnessLive', 'Wellnesslive']) ? 'Ritual Motion' : ($cat['label'] ?? '')); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          <?php elseif(in_array($universe, ['projects', 'corporate', 'lessons', 'at-home', 'wellnesslive']) && !empty($heroCategories) && isset($heroCategories[0]['description'])): ?>
          
          <input type="hidden" name="category" id="<?php echo e($heroDomainSelectId); ?>" value="<?php echo e(request('category')); ?>">
          <div class="hero-domain-custom-wrapper" style="position:relative;width:100%;">
            <div class="hero-domain-trigger filter-input filter-select filter-select-domain-hero" id="heroDomainTrigger-<?php echo e($universe); ?>" role="button" tabindex="0" aria-haspopup="listbox" aria-expanded="false" aria-label="<?php echo e(__('Tous les domaines')); ?>" style="display:flex;align-items:center;justify-content:space-between;cursor:pointer;padding-left:3rem;">
              <span class="hero-domain-trigger-text"><?php echo e(__('Tous les domaines')); ?></span>
            ...
            <div class="hero-domain-menu" id="heroDomainMenu-<?php echo e($universe); ?>" role="listbox" style="display:none;position:absolute;top:100%;left:0;right:0;margin-top:4px;background:#fff;border:1px solid var(--preply-border, #e5e7eb);border-radius:12px;box-shadow:0 10px 40px rgba(0,0,0,0.12);max-height:320px;overflow-y:auto;z-index:100;">
              <div class="hero-domain-option" data-value="" role="option"><?php echo e(__('Tous les domaines')); ?></div>
              <?php $__currentLoopData = $heroCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="hero-domain-option" data-value="<?php echo e($cat['slug'] ?? ''); ?>" role="option">
                <span class="domain-option-label"><?php echo e($cat['label'] ?? ''); ?></span>
                <?php if(!empty($cat['description'] ?? '')): ?>
                <span class="domain-option-desc"><?php echo e($cat['description']); ?></span>
                <?php endif; ?>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          ...
          <?php else: ?>
          <select name="category" id="<?php echo e($heroDomainSelectId); ?>" class="filter-input filter-select filter-select-domain-hero" aria-label="<?php echo e(__('Tous les domaines')); ?>">
            <option value=""><?php echo e(__('Tous les domaines')); ?></option>
            <?php $__currentLoopData = $heroCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($cat['slug'] ?? ''); ?>" <?php echo e(request('category') === ($cat['slug'] ?? '') ? 'selected' : ''); ?>><?php echo e($cat['label'] ?? ''); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          <?php endif; ?>
        </div>
        <div class="filter-input-group filter-hero-domain-spec" id="<?php echo e($heroSpecWrapperId); ?>" data-initial-specialization="<?php echo e(request('specialization') ?: ($initialDomain ?? '')); ?>" data-spec-disabled-text="<?php echo e($isHub ? __('Tous les domaines') : 'Spécialisation'); ?>" <?php if($isHub): ?> style="overflow:visible;position:relative;z-index:50;" <?php endif; ?>>
          <i class="fas fa-folder-open filter-input-icon" style="left: 1rem;" aria-hidden="true"></i>
        ...
        <script type="application/json" id="<?php echo e($heroDomainSpecsMapId); ?>"><?php echo json_encode($heroDomainSpecs, 15, 512) ?></script>
        <?php if($isHub): ?>
        ...
        <script>
        (function() {
          var mapId = '<?php echo e($heroDomainSpecsMapId); ?>';
          var domainSelectId = '<?php echo e($heroDomainSelectId); ?>';
          var specSelectId = '<?php echo e($heroSpecSelectId); ?>';
          var specWrapperId = '<?php echo e($heroSpecWrapperId); ?>';
          var universe = '<?php echo e($universe); ?>';
        ...
        <div class="filter-input-group">
          ...
          <input 
            ...
            placeholder="<?php echo e($keywordPlaceholder); ?>"
            class="filter-input"
            autocomplete="off"
          >
        </div>
        ...
        <div class="filter-input-group filter-mode-intervention-hero" data-hero-filter="<?php echo e($heroFilterScope); ?>">
          <span class="mode-intervention-label"><?php echo e(__('Mode d\'intervention')); ?></span>
          <div class="mode-intervention-segmented" role="group" aria-label="<?php echo e(__('Mode d\'intervention')); ?>">
            ...
            <label class="mode-intervention-pill mode-intervention-pill--hybrid <?php echo e($isHybrid ? 'is-active' : ''); ?>" data-mode="hybrid">
              <input type="radio" name="mode[]" value="hybrid" <?php echo e($isHybrid ? 'checked' : ''); ?> class="sr-only mode-intervention-radio">
              <span class="mode-intervention-pill-icon" aria-hidden="true">⚡</span>
              <span class="mode-intervention-pill-text"><?php echo e(__('Hybride')); ?></span>
            </label>
          </div>
        </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if(in_array($universe, ['at-home', 'wellnesslive', 'hub'])): ?>
        <script>
        (function() {
        ...
        <div class="filter-input-group">
          ...
          <input 
            ...
            placeholder="<?php echo e($locationPlaceholder); ?>"
            class="filter-input"
            autocomplete="off"
          >
        </div>
...
<?php endif; ?>
        ...
        <div class="filters-level filters-level-1 <?php if($universe === 'lessons'): ?> besoin-lessons <?php endif; ?>" data-level="besoin">
          ...
          <div class="filters-level-inner">
            ...
            <?php echo $__env->make('components.services.filters.partials.engagement-rituel-lessons', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="mission_type[]" value="one-shot" <?php echo e(in_array('one-shot', (array) request('mission_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Projet Unique</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="mission_type[]" value="long-term" <?php echo e(in_array('long-term', (array) request('mission_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Accompagnement à Long Terme</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="mission_type[]" value="maintenance" <?php echo e(in_array('maintenance', (array) request('mission_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group besoin-langues filter-group--full">
              ...
              <div class="besoin-langues-row">
                ...
                <div class="besoin-other-langs-wrap" id="besoin_other_langs_wrap_homeswap">
                  ...
                  <input type="hidden" name="other_languages" id="other_languages_input_homeswap" value="<?php echo e(is_string(request('other_languages')) ? request('other_languages') : ''); ?>">
            ...
            <div class="besoin-rituel-row">
              <div class="filter-group besoin-tarif-rituel">
                ...
                <div class="rituel-price-filter-wrapper">
                  ...
                  <div class="rituel-price-range-display">
                    <input type="number" name="price_min" id="rituel-price-min" class="rituel-price-input" min="10" max="100" value="<?php echo e(request('price_min', 10)); ?>" step="1">
                    <span class="rituel-price-separator">-</span>
...
<?php endif; ?>
            ...
            <div class="filter-group" id="budgetGroup">
              <label class="filter-label"><i class="fas fa-euro-sign me-2"></i><?php echo e(__('Budget')); ?> (€)</label>
              <div class="filter-budget-range">
                <input type="number" name="budget_min" id="budgetMin" placeholder="<?php echo e(__('Min')); ?>" class="filter-input-small" value="<?php echo e(request('budget_min')); ?>">
...
<?php endif; ?>
        ...
        <div class="filters-level filters-level-3-extra" data-level="avances-extra">
          <?php if($universe === 'homeswap'): ?>
            ...
            <div class="filter-group">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                <div>
                  ...
                  <input type="date" name="date_from" class="filter-input" value="<?php echo e(request('date_from')); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--preply-border); border-radius: 8px; font-size: 0.9375rem;">
                </div>
                <div>
                  <label style="font-size: 0.8125rem; color: var(--preply-text-light); margin-bottom: 4px; display: block;">Au</label>
                  <input type="date" name="date_to" class="filter-input" value="<?php echo e(request('date_to')); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--preply-border); border-radius: 8px; font-size: 0.9375rem;">
                </div>
              </div>
              <input type="text" name="date_text" class="filter-input" placeholder="Dates (texte libre) ex: Juillet 2026, flexible" value="<?php echo e(request('date_text')); ?>" style="margin-bottom: 8px;">
              <div class="filter-checkboxes" style="display: flex; gap: 16px;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="date_flexible" value="1" <?php echo e(request('date_flexible') ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Dates flexibles</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="date_fixed" value="1" <?php echo e(request('date_fixed') ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 12px;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="wifi" <?php echo e(in_array('wifi', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">WiFi</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="bureau" <?php echo e(in_array('bureau', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Bureau</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="cuisine" <?php echo e(in_array('cuisine', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Cuisine équipée</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="lave-linge" <?php echo e(in_array('lave-linge', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Lave-linge</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="lave-vaisselle" <?php echo e(in_array('lave-vaisselle', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Lave-vaisselle</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="seche-linge" <?php echo e(in_array('seche-linge', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Sèche-linge</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="climatisation" <?php echo e(in_array('climatisation', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Climatisation</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="chauffage" <?php echo e(in_array('chauffage', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Chauffage</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="equipment[]" value="lit-bebe" <?php echo e(in_array('lit-bebe', (array) request('equipment', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 12px;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="outdoor[]" value="balcon" <?php echo e(in_array('balcon', (array) request('outdoor', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Balcon</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="outdoor[]" value="terrasse" <?php echo e(in_array('terrasse', (array) request('outdoor', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Terrasse</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="outdoor[]" value="cour" <?php echo e(in_array('cour', (array) request('outdoor', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Cour</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="outdoor[]" value="jardin" <?php echo e(in_array('jardin', (array) request('outdoor', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="non-fumeurs" <?php echo e(in_array('non-fumeurs', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Non-fumeurs</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="animaux-non-acceptes" <?php echo e(in_array('animaux-non-acceptes', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Animaux non acceptés</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="enfants-acceptes" <?php echo e(in_array('enfants-acceptes', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Enfants acceptés</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="calme" <?php echo e(in_array('calme', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Logement calme</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="teletravail" <?php echo e(in_array('teletravail', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Adapté au télétravail</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="rules[]" value="voisinage" <?php echo e(in_array('voisinage', (array) request('rules', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes" style="display: flex; gap: 16px;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="exchange_type[]" value="simultane" <?php echo e(in_array('simultane', (array) request('exchange_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Échange simultané</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="exchange_type[]" value="non-simultane" <?php echo e(in_array('non-simultane', (array) request('exchange_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Échange non simultané</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="exchange_type[]" value="points" <?php echo e(in_array('points', (array) request('exchange_type', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
            ...
            <div class="filter-group">
              ...
              <div class="filter-checkboxes" style="display: flex; gap: 16px; flex-wrap: wrap;">
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="trip_purpose[]" value="vacances" <?php echo e(in_array('vacances', (array) request('trip_purpose', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Vacances</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="trip_purpose[]" value="travail-distance" <?php echo e(in_array('travail-distance', (array) request('trip_purpose', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
                  <span class="filter-checkbox-text">Travail à distance</span>
                </label>
                <label class="filter-checkbox-label">
                  <input type="checkbox" name="trip_purpose[]" value="echange-linguistique" <?php echo e(in_array('echange-linguistique', (array) request('trip_purpose', [])) ? 'checked' : ''); ?>>
                  <span class="filter-checkbox-custom"></span>
          ...
          <div class="filter-group">
            ...
            <div class="filter-checkboxes">
              <label class="filter-checkbox-label">
                <input type="checkbox" name="mode[]" value="online" <?php echo e(in_array('online', (array) request('mode', [])) ? 'checked' : ''); ?>>
                <span class="filter-checkbox-custom"></span>
              ...
              <label class="filter-checkbox-label">
                ...
                <span class="filter-checkbox-custom"></span>
                <span class="filter-checkbox-text"><?php echo e(__('Hors ligne')); ?></span>
              </label>
              <?php endif; ?>
              <label class="filter-checkbox-label">
                <input type="checkbox" name="mode[]" value="onsite" <?php echo e(in_array('onsite', (array) request('mode', [])) ? 'checked' : ''); ?>>
                <span class="filter-checkbox-custom"></span>
                <span class="filter-checkbox-text"><?php echo e(__('Présentiel')); ?></span>
              </label>
            </div>
          </div>
          <?php endif; ?>
        ...
        <?php if(!$universe): ?>
        <div class="filter-group">
          <label class="filter-label"><i class="fas fa-globe me-2"></i><?php echo e(__('Univers')); ?></label>
          <div class="filter-checkboxes">
            <?php
            ...
            ?>
            <?php $__currentLoopData = $universes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <label class="filter-checkbox-label">
                <input type="checkbox" name="universe[]" value="<?php echo e($key); ?>" <?php echo e(in_array($key, $selectedUniverses) ? 'checked' : ''); ?>>
                <span class="filter-checkbox-custom"></span>
                <span class="filter-checkbox-text"><?php echo e($label); ?></span>
              </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
...
<?php if (! $__env->hasRenderedOnce('7faa8a40-27e6-44f3-8347-3f8a46db6d32')): $__env->markAsRenderedOnce('7faa8a40-27e6-44f3-8347-3f8a46db6d32'); ?>
<style>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    (function initCountryCityCascade() {
      ...
      var cascadeCountryId = '<?php echo e($locationCountryId); ?>';
      var cascadeCityId = '<?php echo e($locationCityId); ?>';
    ...
    const universeRoutes = {
      'projects': '<?php echo e(route("services.projects")); ?>',
      'lessons': '<?php echo e(route("services.lessons")); ?>',
      'at-home': '<?php echo e(route("services.at-home")); ?>',
      'wellnesslive': '<?php echo e(route("services.wellnesslive")); ?>',
      'corporate': '<?php echo e(route("services.corporate")); ?>',
      'homeswap': '<?php echo e(route("services.homeswap")); ?>'
    };
    ...
    if (form) {
      form.addEventListener('submit', function(e) {
        ...
        let targetUrl = '<?php echo e(route("services")); ?>'; // Par défaut : page hub
        ...
        if (form.dataset.lockRoute === '1') {
          ...
          targetUrl = '<?php echo e(route("services")); ?>';
        }
...
<?php endif; ?>
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/components/home/search-filter.blade.php ENDPATH**/ ?>