<?php $__env->startSection('pageHeading'); ?>
  Cours | <?php echo e($websiteInfo->website_title); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.services.hero','data' => ['title' => 'Cours','subtitle' => 'Des progrès qui se voient.','micro' => 'Séance d\'essai, objectifs clairs, suivi régulier. Vous avancez sereinement.','cta' => ['text' => 'Réserver un essai', 'url' => '#results', 'variant' => 'primary']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cours','subtitle' => 'Des progrès qui se voient.','micro' => 'Séance d\'essai, objectifs clairs, suivi régulier. Vous avancez sereinement.','cta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['text' => 'Réserver un essai', 'url' => '#results', 'variant' => 'primary'])]); ?>
...
<?php endif; ?>
  ...
  <section class="preply-intro-section">
    <div class="preply-intro-container">
      ...
      <div class="preply-intro-description collapsed" id="introDescription">
        Envie d'apprendre ? Vous êtes entre de bonnes mains ! Avec Junspro, trouvez le <strong>Rituel en ligne</strong> qu'il vous faut pour développer vos compétences. Nous vous offrons le meilleur pour apprendre : Plus de <?php echo e($freelancers->total() ?? 0); ?> freelances disponibles sur notre plateforme Des freelances vérifiés et certifiés Une évaluation moyenne de 4.92/5 donnée par plus de <?php echo e($freelancers->total() * 10 ?? 0); ?> clients satisfaits Une salle de classe virtuelle et toutes les ressources pour progresser Profitez de la qualité d'un Rituel dans le confort de votre domicile, avec tous les avantages d'un accompagnement à distance ! Envie de progresser ? Découvrez nos ressources pour apprendre.
    </div>
  ...
  <section class="preply-filters-section">
    <div class="preply-filters-container">
      <form method="GET" action="<?php echo e(route('services.lessons')); ?>" id="preplyFiltersForm">
        <div class="preply-filters-row">
          <div class="preply-filter-group">
            ...
            <select name="category" class="preply-filter-select">
              ...
              <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e(strtolower($category)); ?>" <?php echo e((request('category') == strtolower($category)) ? 'selected' : ''); ?>>
                  <?php echo e($category); ?>
          ...
          <div class="preply-filter-group">
            ...
            <select name="country" class="preply-filter-select">
              ...
              <option value="FR" <?php echo e(request('country') == 'FR' ? 'selected' : ''); ?>>France</option>
              <option value="US" <?php echo e(request('country') == 'US' ? 'selected' : ''); ?>>États-Unis</option>
              <option value="GB" <?php echo e(request('country') == 'GB' ? 'selected' : ''); ?>>Royaume-Uni</option>
              <option value="ES" <?php echo e(request('country') == 'ES' ? 'selected' : ''); ?>>Espagne</option>
            </select>
          </div>
        ...
        <div class="preply-filters-advanced">
          ...
          <div class="preply-filter-advanced preply-search-input">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Saisir nom ou mot-clé" class="preply-filter-input">
          </div>
        </div>
      </form>
    </div>
  ...
  <section id="results" class="preply-results-section" style="overflow: visible;">
    <div class="preply-results-container" style="overflow: visible;">
      <div class="preply-results-header">
        <h2 class="preply-results-count"><?php echo e($freelancers->total() ?? 0); ?> freelances disponibles</h2>
      ...
      <div class="preply-teachers-list" style="overflow: visible;">
        <?php $__empty_1 = true; $__currentLoopData = $freelancers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freelancer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <div class="preply-teacher-card-wrapper" data-freelancer-id="<?php echo e($freelancer->id); ?>">
            <?php
            ...
            <div class="preply-teacher-card" 
                 data-has-video="<?php echo e($hasVideo ? 'true' : 'false'); ?>"
                 data-freelancer-id="<?php echo e($freelancer->id); ?>"
                 <?php if($hasVideo): ?>
                   data-video-thumbnail="<?php echo e($thumbnailUrl ?? ''); ?>"
                   data-video-url="<?php echo e($videoUrl ?? ''); ?>"
                   data-teacher-name="<?php echo e($displayName); ?>"
                   data-teacher-first-name="<?php echo e($firstName); ?>"
                   data-teacher-profile-url="<?php echo e(route('freelance.show', $freelancer->id)); ?>"
                 <?php endif; ?>>
              
              <div class="preply-teacher-photo">
                <div class="preply-teacher-photo-avatar">
                  <?php if($user->image): ?>
                    <img src="<?php echo e(asset('assets/img/users/' . $user->image)); ?>" alt="<?php echo e($displayName); ?>">
                  <?php else: ?>
                  ...
                  <?php if($showOnlineBadge): ?>
                    <div class="preply-teacher-online-badge" title="En ligne">
                      En ligne
                    </div>
                  <?php endif; ?>
                  
                  <?php if($showLastSeenBadge): ?>
                    
                    <div class="preply-teacher-last-seen-badge" data-last-seen="<?php echo e($lastSeenText ?? 'Il y a longtemps'); ?>">
                      <div class="preply-teacher-last-seen-tooltip">
                        Dernière connexion <?php echo e($lastSeenText ?? 'Il y a longtemps'); ?>
              ...
              <div class="preply-teacher-info">
                <h3 class="preply-teacher-name">
                  <a href="<?php echo e(route('freelance.show', $freelancer->id)); ?>"><?php echo e($displayName); ?></a>
                  <?php if($freelancer->is_verified): ?>
                ...
                <div class="preply-teacher-country"><?php echo e($countryName); ?> <?php echo e($flag); ?></div>
                <div class="preply-teacher-subject">
                  <?php if(!empty($freelancer->skills) && is_array($freelancer->skills)): ?>
                    <?php echo e($freelancer->skills[0]['name'] ?? 'Rituel'); ?>

                  <?php else: ?>
                    Rituel
                  <?php endif; ?>
                </div>
                <div class="preply-teacher-languages"><?php echo e($langText); ?></div>
                <div class="preply-teacher-bio"><?php echo e($shortBio); ?></div>
                <a href="<?php echo e(route('freelance.show', $freelancer->id)); ?>" class="preply-teacher-learn-more">En savoir plus</a>
                <div class="preply-teacher-popularity">Très populaire. <?php echo e(rand(5, 25)); ?> réservations récentes</div>
              </div>

              
              <div class="preply-teacher-pricing">
                <div class="preply-teacher-price"><?php echo e(number_format($hourlyRate, 0)); ?> €</div>
                <div class="preply-teacher-price-label">Cours de 50 min</div>
                <div class="preply-teacher-rating">
                  <span class="preply-teacher-rating-score"><?php echo e($rating); ?></span>
                  <span class="preply-teacher-rating-count"><?php echo e($reviewsCount); ?> avis</span>
                </div>
                <div class="preply-teacher-stats">
                  <?php echo e($studentsCount); ?> élèves<br>
                  <?php echo e(number_format($coursesCount)); ?> cours
                </div>
                <a href="<?php echo e(route('freelance.show', $freelancer->id)); ?>" class="preply-teacher-btn preply-teacher-btn-primary">
            ...
            <?php if($hasVideo): ?>
              <a href="#" 
                 ...
                 onclick="event.preventDefault(); openVideoModal(<?php echo e($freelancer->id); ?>); return false;">
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\services\bienetreenentreprise.blade.php ENDPATH**/ ?>