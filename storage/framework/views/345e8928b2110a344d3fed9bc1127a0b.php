          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm"
                action="<?php echo e(route('admin.seller_management.seller.update_password', ['id' => $sellerInfo->id])); ?>"
                method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\end-user\seller\change-password.blade.php ENDPATH**/ ?>