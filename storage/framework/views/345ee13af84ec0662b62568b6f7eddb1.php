  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        <?php echo e(__('Confirmez votre abonnement avec')); ?> <span x-text="selectedFreelance?.name"></span>.
      </h2>
    </div>
      ...
      <div class="transfer-confirm-info-list">
        ...
        <div class="transfer-confirm-info-item">
          ...
          <div class="transfer-confirm-info-content">
            <p><?php echo e(__('Votre abonnement avec')); ?> <span x-text="currentTutorName"></span> <?php echo e(__('sera annulé et vous ne serez plus facturé.')); ?></p>
            <button 
              type="button"
              @click="showThanksModal = true"
              class="transfer-thanks-btn"
            >
              <?php echo e(__('Envoyer vos remerciements')); ?>
        ...
        <div class="transfer-confirm-info-item">
          ...
          <div class="transfer-confirm-info-content">
            <p><?php echo e(__('Votre solde avec')); ?> <span x-text="currentTutorName"></span> (<span x-text="formatPrice(creditAmount)"></span>) <?php echo e(__('sera utilisé pour régler votre abonnement avec')); ?> <span x-text="selectedFreelance?.name"></span>.</p>
          </div>
        </div>
        ...
        <div class="transfer-confirm-info-item">
          ...
          <div class="transfer-confirm-info-content">
            <p><?php echo e(__('Votre abonnement de')); ?> <span x-text="selectedPlan?.sessions_per_week"></span> <span x-text="selectedPlan?.sessions_per_week === 1 ? 'Rituel' : 'Rituels'"></span> <?php echo e(__('/ semaine')); ?> (<span x-text="selectedPlan?.total_sessions"></span> <?php echo e(__('Rituels')); ?> / x 4 semaines) <?php echo e(__('commence aujourd\'hui.')); ?></p>
          </div>
        </div>
        ...
        <div class="transfer-confirm-info-item" x-show="remainingCredit > 0">
          ...
          <div class="transfer-confirm-info-content">
            <p><?php echo e(__('La somme de')); ?> <span x-text="formatPrice(remainingCredit)"></span> <?php echo e(__('qu\'il vous reste sera ajoutée à vos crédits Junspro. Elle apparaîtra lors de votre prochain paiement.')); ?></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="transfer-modal-footer">
      <button 
        ...
        :disabled="processing"
      >
        <span x-show="!processing"><?php echo e(__('Passer au paiement')); ?></span>
  ...
  >
    ...
    >
      <div class="transfer-modal-header">
        ...
        <h2 class="transfer-modal-title"><?php echo e(__('Envoyer vos remerciements')); ?></h2>
      </div>
      <div class="transfer-modal-body">
        <textarea 
          x-model="thanksMessage"
          class="transfer-thanks-textarea"
          placeholder="<?php echo e(__('Votre message de remerciement...')); ?>"
          rows="5"
        ></textarea>
        <button 
          type="button"
        ...
        >
          <span x-show="!sendingThanks"><?php echo e(__('Envoyer')); ?></span>
          <span x-show="sendingThanks"><?php echo e(__('Envoi...')); ?></span>
        </button>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\replace\step3-confirm.blade.php ENDPATH**/ ?>