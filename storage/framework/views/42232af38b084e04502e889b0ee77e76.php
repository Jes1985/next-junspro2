    ...
    <div class="settings-wrapper">
      ...
      <main class="settings-content">
        ...
        <div class="settings-header">
          <h1><?php echo e(__('Paramètres du compte')); ?></h1>
          <p><?php echo e(__("Gérez vos informations personnelles et votre profil Junspro.")); ?></p>
        </div>

        <!-- Bloc photo de profil -->
        <div class="profile-photo-section">
          <?php if($avatarUrl): ?>
            <img src="<?php echo e($avatarUrl); ?>" alt="<?php echo e(__('Photo de profil')); ?>" class="profile-photo-preview" id="profile-photo-preview">
          <?php else: ?>
          ...
          <div class="profile-photo-actions">
            <h3><?php echo e(__('Photo de profil')); ?></h3>
            <label for="profile-photo-input" class="btn-upload-photo">
              <i class="fas fa-upload"></i> <?php echo e(__('Importer une photo')); ?>
            ...
            <div class="profile-photo-help">
              <?php echo e(__('Taille maximale : 2 Mo')); ?><br>
              <?php echo e(__('Format JPG ou PNG')); ?>
        ...
        <form action="<?php echo e(route('user.update_profile')); ?>" method="POST" enctype="multipart/form-data" id="settings-form" class="settings-form">
          <?php echo csrf_field(); ?>

          <div class="form-section">
            <h3 class="form-section-title"><?php echo e(__('Informations personnelles')); ?></h3>

            <div class="form-group">
              <label for="first_name" class="form-label"><?php echo e(__('Prénom')); ?></label>
              <input type="text" 
                     id="first_name" 
                     name="first_name" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              <label for="last_name" class="form-label"><?php echo e(__('Nom')); ?></label>
              <input type="text" 
                     id="last_name" 
                     name="last_name" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              <label for="phone_number" class="form-label"><?php echo e(__('Numéro de téléphone')); ?></label>
              <input type="tel" 
                     id="phone_number" 
                     name="phone_number" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              <label for="username" class="form-label"><?php echo e(__('Nom d\'utilisateur')); ?></label>
              <input type="text" 
                     id="username" 
                     name="username" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              <label for="city" class="form-label"><?php echo e(__('Ville')); ?></label>
              <input type="text" 
                     id="city" 
                     name="city" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              <label for="country" class="form-label"><?php echo e(__('Pays')); ?></label>
              <input type="text" 
                     id="country" 
                     name="country" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <select id="timezone" 
                      name="timezone" 
                      class="form-control <?php $__errorArgs = ['timezone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> has-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                <option value="Europe/Paris" <?php echo e(old('timezone', $user->timezone ?? 'Europe/Paris') == 'Europe/Paris' ? 'selected' : ''); ?>>
                  Europe/Paris (GMT +1:00)
                </option>
                <option value="Europe/London" <?php echo e(old('timezone', $user->timezone) == 'Europe/London' ? 'selected' : ''); ?>>
                  Europe/London (GMT +0:00)
                </option>
                <option value="America/New_York" <?php echo e(old('timezone', $user->timezone) == 'America/New_York' ? 'selected' : ''); ?>>
                  America/New_York (GMT -5:00)
                </option>
                <option value="America/Los_Angeles" <?php echo e(old('timezone', $user->timezone) == 'America/Los_Angeles' ? 'selected' : ''); ?>>
                  America/Los_Angeles (GMT -8:00)
                </option>
                <option value="Asia/Tokyo" <?php echo e(old('timezone', $user->timezone) == 'Asia/Tokyo' ? 'selected' : ''); ?>>
                  Asia/Tokyo (GMT +9:00)
                </option>
              </select>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="social-connections">
            <h3 class="form-section-title"><?php echo e(__('Réseaux sociaux')); ?></h3>
            ...
            <div class="social-connection-item">
              <div class="social-connection-info">
                ...
                <div class="social-connection-text">
                  ...
                  <span id="facebook-status"><?php echo e(__('Le compte Facebook n\'est pas connecté')); ?></span>
                </div>
              </div>
                ...
                <div class="social-connection-text">
                  ...
                  <span id="google-status">
                    <?php if($user->provider == 'google'): ?>
                      <?php echo e(__('Connecté(e) en tant que')); ?> <?php echo e($user->email_address); ?>

                    <?php else: ?>
                      <?php echo e(__('Le compte Google n\'est pas connecté')); ?>
          ...
          <div class="settings-form-submit">
            <button type="submit" class="btn-save">
              <i class="fas fa-save"></i> <?php echo e(__('Enregistrer')); ?>
  ...
  <script>
      ...
      if (file) {
        ...
        reader.onload = function(e) {
          ...
          if (preview.tagName === 'IMG') {
            ...
            img.alt = '<?php echo e(__("Photo de profil")); ?>';
    ...
    document.getElementById('connect-facebook')?.addEventListener('click', function() {
      <?php if($facebookRoute !== '#'): ?>
        ...
        // window.location.href = '<?php echo e($facebookRoute); ?>';
        alert('<?php echo e(__("La connexion Facebook sera disponible prochainement.")); ?>');
      <?php else: ?>
        alert('<?php echo e(__("La connexion Facebook n\'est pas disponible.")); ?>');
      <?php endif; ?>
    });
    ...
    document.getElementById('connect-google')?.addEventListener('click', function() {
      <?php if($googleRoute !== '#'): ?>
        ...
        // window.location.href = '<?php echo e($googleRoute); ?>';
        alert('<?php echo e(__("La connexion Google sera disponible prochainement.")); ?>');
      <?php else: ?>
        alert('<?php echo e(__("La connexion Google n\'est pas disponible.")); ?>');
      <?php endif; ?>
    });

    document.getElementById('disconnect-google')?.addEventListener('click', function() {
      // TODO: Implémenter la déconnexion OAuth
      if (confirm('<?php echo e(__("Êtes-vous sûr de vouloir déconnecter votre compte Google ?")); ?>')) {
        alert('<?php echo e(__("La déconnexion sera disponible prochainement.")); ?>');
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\client\settings\index.blade.php ENDPATH**/ ?>