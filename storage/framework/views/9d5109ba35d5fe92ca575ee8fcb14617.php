        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="serviceForm"
                action="<?php echo e(route('admin.service_management.update_service', ['id' => $service->id])); ?>"
                    ...
                    <div class="form-group">
                      ...
                      <select name="seller_id" id="seller_id_service" class="select2">
                        ...
                        <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option <?php if($seller->id == $service->seller_id): echo 'selected'; endif; ?> value="<?php echo e($seller->id); ?>"><?php echo e($seller->username); ?>
...
<?php $__env->startSection('script'); ?>
  <script>
    ...
    const imgDetachUrl = "<?php echo e(route('admin.service_management.detach_slider_image')); ?>";
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\service\edit.blade.php ENDPATH**/ ?>