...
<div class="filter-group filter-group-rituel lessons-engagement-block" data-lessons-filters>
  ...
  <div class="engagement-select-wrapper">
    <select name="price_range" class="filter-select budget-filter" id="lessonsBudgetFilter">
      ...
      <option value="0-1000" data-min="0" data-max="1000" <?php echo e(request('price_range') == '0-1000' ? 'selected' : ''); ?>>0 – 1 000 € — Budget formation — Exploratoire</option>
      <option value="1000-2500" data-min="1000" data-max="2500" <?php echo e(request('price_range') == '1000-2500' ? 'selected' : ''); ?>>1 000 – 2 500 € — Budget formation — Standard</option>
      <option value="2500-5000" data-min="2500" data-max="5000" <?php echo e(request('price_range') == '2500-5000' ? 'selected' : ''); ?>>2 500 – 5 000 € — Budget formation — Intensif</option>
      <option value="5000-10000" data-min="5000" data-max="10000" <?php echo e(request('price_range') == '5000-10000' ? 'selected' : ''); ?>>5 000 – 10 000 € — Budget formation — Avancé</option>
      <option value="10000-20000" data-min="10000" data-max="20000" <?php echo e(request('price_range') == '10000-20000' ? 'selected' : ''); ?>>10 000 – 20 000 € — Budget formation — Partenariat</option>
      <option value="20000-60000" data-min="20000" data-max="60000" <?php echo e(request('price_range') == '20000-60000' ? 'selected' : ''); ?>>20 000 – 60 000 € — Budget formation — Long terme</option>
      <option value="60000+" data-min="60000" data-max="999999" <?php echo e(request('price_range') == '60000+' ? 'selected' : ''); ?>>60 000 € et + — Budget formation — Stratégique étendu</option>
    </select>
  </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\services\filters\partials\engagement-rituel-lessons.blade.php ENDPATH**/ ?>