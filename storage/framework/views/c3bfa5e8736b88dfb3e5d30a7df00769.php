...
<?php $__env->startSection('content'); ?>
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="<?php echo e(route('admin.service_management.services', ['language' => $defaultLang->code])); ?>"><?php echo e(__('Service')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-lg-right float-left mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.service_management.service.bulk_delete_faq')); ?>">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('admin.service_management.service.delete_faq', ['id' => $faq->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
  ...
  <?php echo $__env->make('backend.client-service.faq.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

  
  <?php echo $__env->make('backend.client-service.faq.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\faq\index.blade.php ENDPATH**/ ?>