...
<head>
  ...
  <title><?php echo $__env->yieldContent('pageHeading'); ?> <?php echo e('| ' . ($websiteInfo->website_title ?? 'Junspro')); ?></title>
  <!-- Favicon -->
  ...
  <?php if($basicInfo->theme_version == 1): ?>
    <?php if ($__env->exists('frontend.partials.styles.style-v1')) echo $__env->make('frontend.partials.styles.style-v1', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php elseif($basicInfo->theme_version == 2): ?>
    <?php if ($__env->exists('frontend.partials.styles.style-v2')) echo $__env->make('frontend.partials.styles.style-v2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php elseif($basicInfo->theme_version == 3): ?>
    <?php if ($__env->exists('frontend.partials.styles.style-v3')) echo $__env->make('frontend.partials.styles.style-v3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php else: ?>
  ...
  <style>
    :root {
      ...
      --color-primary-rgb: <?php echo e(hexToRgb($primaryColor)); ?>;
...
<body>
  ...
  <div class="main-wrapper">
    <!-- Header-area start -->
    <?php if($basicInfo->theme_version == 1): ?>
      <?php if ($__env->exists('frontend.partials.header.header-nav-v1')) echo $__env->make('frontend.partials.header.header-nav-v1', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($basicInfo->theme_version == 2): ?>
      <?php if ($__env->exists('frontend.partials.header.header-nav-v2')) echo $__env->make('frontend.partials.header.header-nav-v2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($basicInfo->theme_version == 3): ?>
      <?php if ($__env->exists('frontend.partials.header.header-nav-v3')) echo $__env->make('frontend.partials.header.header-nav-v3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
    ...
    <?php if ($__env->exists('frontend.freelance.partials.navbar')) echo $__env->make('frontend.freelance.partials.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    
    <?php echo $__env->yieldContent('content'); ?>
  </div>

  
  <?php if ($__env->exists('frontend.partials.popups')) echo $__env->make('frontend.partials.popups', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

  
  <?php if(!is_null($cookieAlertInfo) && $cookieAlertInfo->cookie_alert_status == 1): ?>
    <?php if ($__env->exists('cookie-consent::index')) echo $__env->make('cookie-consent::index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php endif; ?>

  <!-- Footer-area start -->
  <?php if ($__env->exists('frontend.partials.footer.footer-v3')) echo $__env->make('frontend.partials.footer.footer-v3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <!-- Footer-area end-->

  <!-- Jquery JS -->
  <?php if($basicInfo->theme_version == 1): ?>
    <?php if ($__env->exists('frontend.partials.scripts.script-v1')) echo $__env->make('frontend.partials.scripts.script-v1', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php elseif($basicInfo->theme_version == 2): ?>
    <?php if ($__env->exists('frontend.partials.scripts.script-v2')) echo $__env->make('frontend.partials.scripts.script-v2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php elseif($basicInfo->theme_version == 3): ?>
    <?php if ($__env->exists('frontend.partials.scripts.script-v3')) echo $__env->make('frontend.partials.scripts.script-v3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  <?php else: ?>
  ...
  <script>
    ...
    window.junsproUserEmail = <?php echo json_encode(Auth::guard('web')->check() ? Auth::guard('web')->user()->email : '', 15, 512) ?>;
  </script>
  <script type="text/javascript" src="<?php echo e(asset('assets/front/js/junspro-chatbot-premium.js')); ?>?v=6.3"></script>
</body>

</html>

<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\layouts\app.blade.php ENDPATH**/ ?>