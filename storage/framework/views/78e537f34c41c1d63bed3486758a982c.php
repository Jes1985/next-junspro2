    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form id="searchForm" action="<?php echo e(route('seller.service_orders')); ?>" method="GET">
                <div class="row">
                  <div class="col-lg-3">
            ...
            <div class="col-lg-2">
              <button class="btn btn-danger btn-sm d-none bulk-delete float-lg-right card-header-button"
                data-href="<?php echo e(route('seller.service_orders.bulk_delete')); ?>">
                      ...
                      <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <?php if(!empty($order->serviceSlug)): ?>
                              <a target="_blank"
                                ...
                                <?php echo e(strlen($order->serviceTitle) > 60 ? mb_substr($order->serviceTitle, 0, 60, 'UTF-8') . '...' : $order->serviceTitle); ?>
                          ...
                          <td>
                            ...
                            <?php else: ?>
                              <?php if($order->payment_status == 'pending' && is_null($order->grand_total)): ?>
                                <form id="paymentStatusForm-<?php echo e($order->id); ?>" class="d-inline-block"
                                  action="<?php echo e(route('seller.service_order.update_payment_status', ['id' => $order->id])); ?>"
                                  method="post">
                                  <?php echo csrf_field(); ?>
                                  <select
                          ...
                          <td>
                            <span
                              class="badge <?php if($order->order_status == 'pending'): ?> badge-warning <?php elseif($order->order_status == 'processing'): ?> badge-primary <?php elseif($order->order_status == 'completed'): ?> badge-success <?php elseif($order->order_status == 'rejected'): ?> badge-danger <?php endif; ?>"><?php echo e(ucfirst($order->order_status)); ?></span>
                          </td>
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="<?php echo e(route('seller.service_order.details', ['id' => $order->id])); ?>"
                                  class="dropdown-item">
                                ...
                                ?>
                                <?php if($chatPermission == true): ?>
                                  <a href="<?php echo e(route('seller.service_order.message', ['id' => $order->id])); ?>"
                                    class="dropdown-item">
                                ...
                                <a href="<?php echo e('#emailModal-' . $order->id); ?>" data-toggle="modal" class="dropdown-item">
                                  <?php echo e(__('Send via Mail')); ?>

                                </a>
                                <form class="deleteForm d-block"
                                  action="<?php echo e(route('seller.service_order.delete', ['id' => $order->id])); ?>"
                                  method="post">
                                  <?php echo csrf_field(); ?>
                        ...
                        <!-- Email Modal -->
                        <?php if ($__env->exists('seller.order.send-mail')) echo $__env->make('seller.order.send-mail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                        <?php echo $__env->renderWhen($order->receipt, 'seller.order.show-receipt', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
...
<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\order\index.blade.php ENDPATH**/ ?>