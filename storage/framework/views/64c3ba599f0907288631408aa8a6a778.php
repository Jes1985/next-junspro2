        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" action="<?php echo e(route('admin.service_management.settings.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                  <label for=""><?php echo e(__('Tax') . ' (%)'); ?></label>
                  <input type="number" name="tax" step="0.1" class="form-control"
                    value="<?php echo e($service_settings->tax); ?>">
                  <p class="text-danger" id="err_tax"></p>
                </div>
                <div class="form-group">
                  <label for=""><?php echo e(__('Max file upload in chat box')); ?> (<?php echo e(__('KB')); ?>)</label>
                  <input type="number" name="chat_max_file" step="100" class="form-control"
                    value="<?php echo e($service_settings->chat_max_file); ?>">
                  <p class="text-danger" id="err_chat_max_file"></p>
                  <p class="text-warning"><?php echo e(__('Ex : 1000')); ?>,
                    <strong><?php echo e(__('Note:')); ?></strong><?php echo e(__('1000=1MB')); ?>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\service\settings.blade.php ENDPATH**/ ?>