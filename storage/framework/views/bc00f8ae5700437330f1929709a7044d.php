  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="modal-form" action="<?php echo e(route('seller.qr_codes.save_qr')); ?>" method="post" id="qrSaveForm">
          <?php echo csrf_field(); ?>
          <div class="row">
            <div class="col-12">
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\qr-code\save.blade.php ENDPATH**/ ?>