  ...
  <div class="freelancer-card-compact-content">
    ...
    <div class="freelancer-card-compact-center">
      ...
      <?php if($sellerInfo && $sellerInfo->designation): ?>
        <p class="freelancer-card-compact-specialty"><?php echo e($sellerInfo->designation); ?></p>
      <?php endif; ?>
      <div class="freelancer-card-compact-rating">
        ...
        <span class="rating-value"><?php echo e(number_format($avgRating, 1)); ?></span>
      </div>
    </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\seller\partials\freelancer-card-compact.blade.php ENDPATH**/ ?>