<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Monthly Total Earning')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#"><?php echo e(__('Monthly Total Earning')); ?></a>
      </li>
    </ul>
  </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-5">
              <div class="card-title d-inline-block">
                <?php echo e(__('Monthly Total Earning ')); ?>

              </div>
            </div>
            <div class="col-lg-7">
              <div class="card-title d-inline-block">
                <form action="<?php echo e(route('admin.monthly_earning')); ?>" id="year" method="get">
                  <div class="row">
                    <div class="col-md-12">
              ...
              <table class="table table-striped mt-3" id="">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><?php echo e(__('Total Earning')); ?></th>
                  </tr>
                </thead>
                <tbody>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\admin\lifetime-earning.blade.php ENDPATH**/ ?>