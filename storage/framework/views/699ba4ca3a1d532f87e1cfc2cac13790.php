                ...
                <?php if(!property_exists($menuData, 'children')): ?>
                  <li class="nav-item">
                    <a class="nav-link <?php echo e(url()->current() == $href ? 'active' : ''); ?>"
                      href="<?php echo e($href); ?>"><?php echo e(str_replace(['Tarification', 'Tarificatication'], 'Abonnement', $menuData->text)); ?></a>
                  </li>
                <?php else: ?>
                  <li class="nav-item">
                    <a class="nav-link toggle <?php echo e(url()->current() == $href ? 'active' : ''); ?>"
                      href="<?php echo e($href); ?>"><?php echo e(str_replace(['Tarification', 'Tarificatication'], 'Abonnement', $menuData->text)); ?><i class="fal fa-plus"></i></a>
                      ...
                      <?php $__currentLoopData = $childMenuDatas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childMenuData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="nav-item">
                          <a class="nav-link <?php echo e(url()->current() == $child_href ? 'active' : ''); ?>"
                            href="<?php echo e($child_href); ?>"><?php echo e(str_replace(['Tarification', 'Tarificatication'], 'Abonnement', $childMenuData->text)); ?></a>
                        </li>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\partials\header\header-nav-v1.blade.php ENDPATH**/ ?>