  ...
  >
    ...
    <div class="topup-modal-header">
      ...
      <h2 class="topup-modal-title">
        <?php echo e(__('Suivez des Rituels supplémentaires avec')); ?> <span x-text="tutorName"></span>
      </h2>
    </div>
    ...
    <div class="topup-modal-body">
      ...
      <div class="topup-quota-info" x-show="!loadingQuota">
        <span x-show="!isQuotaReached">
          ...
          <span>
            <?php echo e(__('Il vous reste')); ?> <strong x-text="quota.remaining"></strong> <?php echo e(__('Rituels')); ?> <?php echo e(__('sur')); ?> <strong x-text="quota.max"></strong> <?php echo e(__('Rituels')); ?>

            <span x-show="quota.window_end">
              (<?php echo e(__('jusqu\'au')); ?> <span x-text="formatDate(quota.window_end)"></span>)
            </span>
          </span>
        </span>
        <span x-show="isQuotaReached" class="topup-quota-warning">
          ...
          <span>
            <?php echo e(__('Quota atteint, réessayez le')); ?> <strong x-text="formatDate(quota.next_available_at)"></strong>
          </span>
        </span>
      </div>
      ...
      <div class="topup-stepper" :class="{ 'topup-stepper-disabled': isQuotaReached }">
        ...
        <div class="topup-stepper-value">
          <span x-text="qty"></span> <span class="topup-stepper-unit"><?php echo e(__('Rituels')); ?></span>
        </div>
      ...
      <div class="topup-info-banner" x-show="scheduleUntil && !isQuotaReached">
        ...
        <span>
          <?php echo e(__('Bonne nouvelle ! Vous pouvez programmer ces Rituels jusqu\'au')); ?> 
      ...
      <div class="topup-quota-reached-banner" x-show="isQuotaReached">
        <i class="fas fa-info-circle"></i>
        <div>
          <strong><?php echo e(__('Ce cycle atteint la limite de votre formule. Pour continuer, sélectionnez la formule supérieure.')); ?></strong>
        </div>
      </div>
      ...
      <div class="topup-upgrade-section" x-show="upgradeDetails">
        <div class="topup-upgrade-header">
          <h3><?php echo e(__('Passer aussi à la formule supérieure')); ?></h3>
    ...
    <div class="topup-modal-footer">
      ...
      >
        <span x-show="!loading && !isQuotaReached"><?php echo e(__('Confirmer')); ?></span>
        <span x-show="loading" class="topup-loading">
          <i class="fas fa-spinner fa-spin"></i> <?php echo e(__('Traitement...')); ?>

        </span>
        <span x-show="isQuotaReached && !loading"><?php echo e(__('Quota atteint')); ?></span>
      </button>
    </div>
  </div>
</div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\topup-modal.blade.php ENDPATH**/ ?>