  ...
  >
    <div class="change-plan-modal-header">
      ...
      <h2 class="change-plan-modal-title">
        <?php echo e(__('Créez la formule qui vous convient le mieux')); ?>
    ...
    <div class="change-plan-modal-body">
      ...
      <div class="change-plan-current-info">
        <span><?php echo e(__('Formule actuelle')); ?> :</span>
        <strong x-text="currentHours + 'h • ' + formatPrice(currentPrice)"></strong>
        <span><?php echo e(__('toutes les 4 semaines')); ?></span>
      </div>
      ...
      <div class="change-plan-stepper">
        ...
        <div class="change-plan-stepper-value">
          ...
          <span class="change-plan-stepper-label"><?php echo e(__('h')); ?></span>
        </div>
      ...
      <div class="change-plan-new-price">
        <div class="change-plan-new-price-label"><?php echo e(__('Nouveau prix')); ?> :</div>
        <div class="change-plan-new-price-value" x-text="formatPrice(newPrice)"></div>
        <div class="change-plan-new-price-period"><?php echo e(__('toutes les 4 semaines')); ?></div>
      </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\change-plan-upgrade-builder.blade.php ENDPATH**/ ?>