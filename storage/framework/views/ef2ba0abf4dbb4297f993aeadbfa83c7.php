  ...
  >
    ...
    <div class="transfer-modal-body transfer-payment-body">
      ...
      <div class="transfer-payment-invoice">
        <h4><?php echo e(__('Détails de la facture')); ?></h4>
        <div class="transfer-payment-invoice-item">
          <span><?php echo e(__('Formule')); ?></span>
          <span><span x-text="selectedPlan?.sessions_per_week"></span> <?php echo e(__('rituels par semaine')); ?></span>
        </div>
        <div class="transfer-payment-invoice-item">
          <span><?php echo e(__('Total')); ?></span>
          <span><span x-text="selectedPlan?.total_sessions"></span> <?php echo e(__('rituels')); ?></span>
        </div>
        <div class="transfer-payment-invoice-item">
          <span><?php echo e(__('Prix')); ?></span>
          <span x-text="formatPrice(selectedPlan?.price)"></span>
        </div>
        <div class="transfer-payment-invoice-item" x-show="creditAmount > 0">
          <span><?php echo e(__('Solde utilisé')); ?></span>
        ...
        <div class="transfer-payment-invoice-total">
          <span><?php echo e(__('Total à payer')); ?></span>
      ...
      <div class="transfer-payment-info">
        <p><?php echo e(__('Vous pouvez changer gratuitement de freelance ou annuler votre abonnement à tout moment')); ?></p>
        <p><?php echo e(__('Renouvellement automatique toutes les 4 semaines')); ?></p>
        <p x-show="amountToPay > 0"><?php echo e(__('Nous prélèverons')); ?> <span x-text="formatPrice(amountToPay)"></span> <?php echo e(__('sur le mode de paiement enregistré pour ajouter')); ?> <span x-text="selectedPlan?.total_sessions"></span> <?php echo e(__('rituels toutes les 4 semaines, à moins que vous n\'annuliez votre abonnement')); ?></p>
      </div>

      <!-- Mode de paiement -->
      <div class="transfer-payment-methods">
        <h4><?php echo e(__('Mode de paiement')); ?></h4>
        ...
        >
          ...
          <div class="transfer-payment-method-content">
            <div class="transfer-payment-method-title"><?php echo e(__('Crédit Junspro')); ?></div>
            <div class="transfer-payment-method-details" x-show="junsproCredit > 0">
              <span x-text="formatPrice(junsproCredit)"></span> <?php echo e(__('disponible')); ?>
        ...
        >
          ...
          <div class="transfer-payment-method-content">
            <div class="transfer-payment-method-title"><?php echo e(__('Carte enregistrée')); ?></div>
        ...
        <div class="transfer-payment-other-methods">
          ...
          >
            ...
            <div class="transfer-payment-method-content">
              <div class="transfer-payment-method-title"><?php echo e(__('Autre mode de paiement')); ?></div>
            </div>
        ...
        <div x-show="selectedPaymentMethod === 'new_card' && showOtherMethods" class="transfer-payment-card-form">
          <div class="transfer-payment-form-group">
            <label><?php echo e(__('Numéro de carte')); ?></label>
            <input 
              type="text"
              x-model="cardNumber"
          ...
          <div class="transfer-payment-form-row">
            <div class="transfer-payment-form-group">
              <label><?php echo e(__('Date d\'expiration')); ?></label>
              <input 
                type="text"
                x-model="cardExpiry"
                placeholder="MM/AA"
    ...
    <div class="transfer-modal-footer">
      ...
      >
        <span x-show="!processing"><?php echo e(__('Valider le paiement')); ?></span>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\replace\step4-payment.blade.php ENDPATH**/ ?>