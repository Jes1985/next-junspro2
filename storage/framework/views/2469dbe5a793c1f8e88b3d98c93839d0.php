      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.payment_gateways.store_offline_gateway')); ?>" method="POST">
          ...
          <div class="form-group">
            ...
            <textarea id="add_summernote" class="form-control summernote" name="instructions" placeholder="Enter Gateway Instructions" data-height="150"></textarea>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\payment-gateways\offline-gateways\create.blade.php ENDPATH**/ ?>