...
<?php $__env->startSection('pageHeading'); ?>
  Pause Souffle | <?php echo e($websiteInfo->website_title); ?>
  ...
  <section class="pause-souffle-intake" id="intake">
    <div class="pause-souffle-container">
      ...
      <div class="pause-souffle-intake-container">
        <form id="pauseSouffleForm" class="pause-souffle-form" method="POST" action="<?php echo e(route('presence.pause-souffle.submit')); ?>">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\presence\pause-souffle.blade.php ENDPATH**/ ?>