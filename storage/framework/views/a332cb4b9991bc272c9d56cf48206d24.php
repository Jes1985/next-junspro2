        ...
        <div class="freelancers-grid-premium" style="display: flex; flex-direction: column; gap: 20px;">
          ...
          <?php
            ...
            <?php endif; ?>
                            ...
                            <div class="video-placeholder-fallback" style="display: <?php echo e(($hasThumbnail && !empty($thumbnailUrl)) ? 'none' : 'flex'); ?>; flex-direction: column; align-items: center; justify-content: center; width: 100%; height: 100%; background: linear-gradient(135deg, #FDBA74 0%, #F97316 50%, #EA580C 100%); color: white; text-align: center; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 1;">
