...
<div class="service-card-premium">
  ...
  <div class="service-card-image-wrapper">
    <a href="<?php echo e(route('service_details', ['slug' => $service->slug, 'id' => $service->id])); ?>" 
       class="service-image-link" title="<?php echo e($service->title); ?>">
    ...
    <a href="<?php echo e(route('service.update_wishlist', ['slug' => $service->slug])); ?>"
      ...
      <?php if(auth()->guard('web')->check()): ?>
        <i class="fas fa-heart <?php echo e(@$service->wishlisted == true ? 'wishlist-active' : ''); ?>"></i>
      <?php endif; ?>
  ...
  <div class="service-card-body">
    ...
    <h3 class="service-card-title">
      <a href="<?php echo e(route('service_details', ['slug' => $service->slug, 'id' => $service->id])); ?>">
        <?php echo e(strlen($service->title) > 60 ? mb_substr($service->title, 0, 60, 'UTF-8') . '...' : $service->title); ?>
    ...
    <div class="service-freelancer-info">
      <?php if($seller): ?>
        <a href="<?php echo e(route('frontend.seller.details', ['username' => $seller->username])); ?>" class="freelancer-link">
          ...
          <?php else: ?>
            <div class="freelancer-avatar-initials">
              <?php echo e(strtoupper(mb_substr($seller->username, 0, 2, 'UTF-8'))); ?>

            </div>
          <?php endif; ?>
          <div class="freelancer-details">
            <span class="freelancer-name"><?php echo e(strlen($seller->username) > 18 ? mb_substr($seller->username, 0, 18, 'UTF-8') . '..' : $seller->username); ?></span>
            <?php if(@$seller->seller_info && @$seller->seller_info->country): ?>
              <span class="freelancer-location"><?php echo e($seller->seller_info->country); ?></span>
            <?php endif; ?>
          </div>
        </a>
      <?php elseif($admin): ?>
        <a href="<?php echo e(route('frontend.seller.details', ['username' => $admin->username, 'admin' => true])); ?>" class="freelancer-link">
          <?php if(!empty($admin->image)): ?>
            <img class="freelancer-avatar" 
                 src="<?php echo e(asset('assets/img/admins/' . $admin->image)); ?>"
                 alt="<?php echo e($admin->username); ?>">
          <?php else: ?>
            <div class="freelancer-avatar-initials">
              <?php echo e(strtoupper(mb_substr($admin->username, 0, 2, 'UTF-8'))); ?>

            </div>
          <?php endif; ?>
          <div class="freelancer-details">
            <span class="freelancer-name"><?php echo e(strlen($admin->username) > 18 ? mb_substr($admin->username, 0, 18, 'UTF-8') . '..' : $admin->username); ?></span>
          </div>
        </a>
      <?php endif; ?>
    </div>
    ...
    <div class="service-rating">
      <div class="rating-stars">
        <div class="star-background" data-bg-img="<?php echo e(asset('assets/front/images/rate-star-md.png')); ?>">
          <div class="star-fill" style="width: <?php echo e(($service->average_rating ?? 0) * 20); ?>%"></div>
        </div>
        <span class="rating-text">
          <strong><?php echo e(number_format($service->average_rating ?? 0, 1)); ?></strong>
    ...
    <div class="service-card-footer">
      <?php if($service->quote_btn_status == 1): ?>
        <span class="price-label"><?php echo e(__('Sur devis')); ?></span>
      <?php else: ?>
        <div class="price-info">
          <span class="price-label"><?php echo e(__('À partir de')); ?></span>
          ...
          <?php if($previousPackagePrice): ?>
            <span class="price-old"><?php echo e($position == 'left' ? $symbol : ''); ?><?php echo e(formatPrice($previousPackagePrice)); ?><?php echo e($position == 'right' ? $symbol : ''); ?></span>
          <?php endif; ?>
        </div>
      <?php endif; ?>
    </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\service\partials\service-card.blade.php ENDPATH**/ ?>