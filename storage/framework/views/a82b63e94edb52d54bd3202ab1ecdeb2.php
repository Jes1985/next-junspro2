<?php $__env->startSection('content'); ?>
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="<?php echo e(route('seller.service_orders')); ?>"><?php echo e(__('All Orders')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
    ...
    <a href="<?php echo e(route('seller.service_orders')); ?>" class="btn btn-primary ml-auto"><?php echo e(__('Back')); ?></a>
  </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="payment-information">
            ...
            <div class="row mb-2">
              <div class="col-lg-3">
                <strong><?php echo e(__('Recived Amount') . ' :'); ?></strong>
              </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-9">
                <?php if($orderInfo->gateway_type == 'online'): ?>
                  ...
                  <?php endif; ?>
                <?php else: ?>
                  <?php if($orderInfo->payment_status == 'pending' && is_null($orderInfo->grand_total)): ?>
                    <form id="paymentStatusForm" class="d-inline-block"
                      action="<?php echo e(route('seller.service_order.update_payment_status', ['id' => $orderInfo->id])); ?>"
                      method="post">
                      <?php echo csrf_field(); ?>
                      <select
            ...
            <div class="row mb-1">
              ...
              <div class="col-lg-9">
                <span
                  class="badge <?php if($orderInfo->order_status == 'pending'): ?> badge-primary <?php elseif($orderInfo->order_status == 'completed'): ?> badge-success <?php elseif($orderInfo->order_status == 'rejected'): ?> badge-danger <?php endif; ?>"><?php echo e(ucfirst($orderInfo->order_status)); ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="payment-information">
            <div class="row mb-2">
              ...
              <div class="col-lg-9"><?php echo e($orderInfo->name); ?></div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-lg-9"><?php echo e($orderInfo->email_address); ?></div>
            </div>
            ...
            <?php if(!is_null($informations)): ?>
              <?php $__currentLoopData = $informations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $information): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php elseif($information->type == 5): ?>
                  ...
                  <?php echo $__env->make('seller.order.show-text', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <?php else: ?>
                  <div class="row <?php echo e($loop->iteration == $length ? 'mb-1' : 'mb-2'); ?>">
                    ...
                    <div class="col-lg-9"><?php echo e($information->value); ?></div>
                  </div>
                <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
...
<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\order\details.blade.php ENDPATH**/ ?>