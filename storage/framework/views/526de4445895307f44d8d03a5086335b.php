      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-2">
              <a href="<?php echo e(route('admin.service_management.form.input', ['id' => request()->route('form_id'), 'language' => request()->input('language')])); ?>"
          ...
          <div class="row justify-content-center">
            <div class="col-lg-6">
              <form id="ajaxEditForm"
                action="<?php echo e(route('admin.service_management.form.update_input', ['id' => $inputField->id])); ?>"
                method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\form-input\edit.blade.php ENDPATH**/ ?>