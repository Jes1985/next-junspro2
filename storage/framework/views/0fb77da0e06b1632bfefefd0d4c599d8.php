<div class="col-lg-5">
  <table class="table table-striped mdb_242">
    ...
    <tbody>
      ...
      <?php endif; ?>
      <?php if($templateInfo->mail_type == 'balance_add' || $templateInfo->mail_type == 'balance_subtract'): ?>
        <tr>
          <td>{username}</td>
          <td scope="row"><?php echo e(__('Username of Seller')); ?></td>
        </tr>
        <tr>
          <td>{amount}</td>
          <td scope="row"><?php echo e(__('Amount')); ?></td>
        </tr>
        <tr>
          <td>{current_balance}</td>
          <td scope="row"><?php echo e(__('Current Balance of Seller')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if($templateInfo->mail_type == 'product_order' || $templateInfo->mail_type == 'service_order'): ?>
        <tr>
          <td>{order_number}</td>
          <td scope="row"><?php echo e(__('Order Number')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if($templateInfo->mail_type == 'product_order' || $templateInfo->mail_type == 'service_order'): ?>
        <tr>
          <td>{order_link}</td>
          <td scope="row"><?php echo e(__('Link to View Order Details')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(
        ...
        <tr>
          ...
          <td scope="row"><?php echo e(__('Invoice Number')); ?></td>
        </tr>
      <?php endif; ?>
      <?php if($templateInfo->mail_type == 'withdraw_approve' || $templateInfo->mail_type == 'withdraw_rejected'): ?>
        <tr>
          <td>{seller_username}</td>
          <td><?php echo e(__('Seller Username')); ?></td>
        </tr>
        <tr>
          <td>{withdraw_id}</td>
          <td><?php echo e(__('Withdrawal  Id')); ?></td>
        </tr>
        <tr>
          <td>{current_balance}</td>
          <td><?php echo e(__('Amount Current Balance')); ?></td>
        </tr>
      <?php endif; ?>

      <?php if($templateInfo->mail_type == 'withdraw_approve'): ?>
        <tr>
          <td>{withdraw_amount}</td>
          <td><?php echo e(__('Amount of Withdrawal')); ?></td>
        </tr>
        <tr>
          <td>{charge}</td>
          <td><?php echo e(__('Charge')); ?></td>
        </tr>
        <tr>
          <td>{payable_amount}</td>
          <td><?php echo e(__('Payable Amount')); ?></td>
        </tr>
        <tr>
          <td>{withdraw_method}</td>
          <td><?php echo e(__('Withdraw Method')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(
        ...
        <tr>
          ...
          <td scope="row"><?php echo e(__('Replace Package Name')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(
        ...
        <tr>
          <td>{package_title}</td>
          <td scope="row"><?php echo e(__('Package Name')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(
        ...
        <tr>
          <td>{package_price}</td>
          <td scope="row"><?php echo e(__('Price of Package')); ?></td>
        </tr>
      <?php endif; ?>

      <?php if($templateInfo->mail_type == 'registration_with_premium_package'): ?>
        <tr>
          <td>{total}</td>
          <td scope="row"><?php echo e(__('Total Paid Amount')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <?php if(
        ...
        <tr>
          ...
          <td scope="row"><?php echo e(__('Package activation date')); ?></td>
        </tr>
      <?php endif; ?>
      <?php if(
          $templateInfo->mail_type == 'admin_changed_current_package' ||
        ...
        <tr>
          <td>{expire_date}</td>
          <td scope="row"><?php echo e(__('Package expire date')); ?></td>
        </tr>
      <?php endif; ?>

      <?php if($templateInfo->mail_type == 'membership_expiry_reminder'): ?>
        <tr>
          <td>{last_day_of_membership}</td>
          <td scope="row"><?php echo e(__('Package expire last date')); ?></td>
        </tr>
      <?php endif; ?>
      <?php if($templateInfo->mail_type == 'membership_expiry_reminder' || $templateInfo->mail_type == 'membership_expired'): ?>
        <tr>
          <td>{login_link}</td>
          <td scope="row"><?php echo e(__('Login Url')); ?></td>
        </tr>
      <?php endif; ?>

      <?php if($templateInfo->mail_type == 'add_user_by_admin'): ?>
        <tr>
          <td>{username}</td>
          <td scope="row"><?php echo e(__('Username')); ?></td>
        </tr>
        <tr>
          <td>{user_type}</td>
          <td scope="row"><?php echo e(__('Customer / Seller')); ?></td>
        </tr>
        <tr>
          <td>{password}</td>
          <td scope="row"><?php echo e(__('Password of Cutomer/Seller')); ?></td>
        </tr>
      <?php endif; ?>
      ...
      <tr>
        <td>{website_title}</td>
        <td scope="row"><?php echo e(__('Your Website Name')); ?></td>
      </tr>
    </tbody>
  </table>
</div>
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\basic-settings\email\bbcode.blade.php ENDPATH**/ ?>