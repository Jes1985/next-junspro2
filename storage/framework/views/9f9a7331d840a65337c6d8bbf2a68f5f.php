            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end user-menu-premium">
                ...
                <?php if(auth()->guard('web')->check()): ?>
                  ...
                  <li>
                    <a class="dropdown-item" href="<?php echo e(route('referral.index')); ?>">
                      <svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                      ...
                      <span><?php echo e(__('Parrainage')); ?></span>
                    </a>
                  </li>
                  <li>
...
<!-- Header-area end -->
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\partials\header\header-nav-v3-backup.blade.php ENDPATH**/ ?>