...
<?php $__env->startSection('content'); ?>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-lg-right float-left mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('seller.service_management.service.bulk_delete_addon')); ?>">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="<?php echo e(route('seller.service_management.service.delete_addon', ['id' => $addon->id])); ?>"
                              method="post">
                              <?php echo csrf_field(); ?>
  ...
  <?php echo $__env->make('seller.addon.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

  
  <?php echo $__env->make('seller.addon.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\addon\index.blade.php ENDPATH**/ ?>