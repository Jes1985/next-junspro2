...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="url" class="form-control" name="url" value="<?php echo e($bs->qr_url); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control jscolor" name="color" value="<?php echo e($bs->qr_color); ?>" onchange="generateQR()">
                  <p class="mt-1 mb-0 text-warning">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="size" min="200" max="350" value="<?php echo e($bs->qr_size); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="margin" min="0" max="5" value="<?php echo e($bs->qr_margin); ?>" onchange="generateQR()">
            ...
            <div class="row qrcode-type" id="image-type">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    ...
                    <?php else: ?>
                      <img src="<?php echo e(asset('assets/img/qr-codes/' . $bs->qr_inserted_image)); ?>" alt="inserted image" class="uploaded-img">
                    <?php endif; ?>
                  </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="image_size" min="1" max="20" value="<?php echo e($bs->qr_inserted_image_size); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="img_x_pos" min="0" max="100" value="<?php echo e($bs->qr_inserted_image_x); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="img_y_pos" min="0" max="100" value="<?php echo e($bs->qr_inserted_image_y); ?>" onchange="generateQR()">
            ...
            <div class="row qrcode-type" id="text-type">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="text" value="<?php echo e($bs->qr_text); ?>" onchange="generateQR()">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control jscolor" name="text_color" value="<?php echo e($bs->qr_text_color); ?>" onchange="generateQR()">
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="text_size" min="1" max="15" value="<?php echo e($bs->qr_text_size); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="txt_x_pos" min="0" max="100" value="<?php echo e($bs->qr_text_x); ?>" onchange="generateQR()">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="range" class="form-control p-0" name="txt_y_pos" min="0" max="100" value="<?php echo e($bs->qr_text_y); ?>" onchange="generateQR()">
      ...
      <div class="card bg-white">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-8">
              <form action="<?php echo e(route('admin.qr_codes.clear')); ?>" method="post" class="d-inline-block float-lg-right float-left">
                <?php echo csrf_field(); ?>
              ...
              <a href="#" data-toggle="modal" data-target="#saveModal" class="btn btn-success btn-sm float-lg-right float-left mr-2"><?php echo e(__('Save')); ?></a>
            </div>
          </div>
        </div>
        ...
        <div class="card-footer text-center">
          <a href="<?php echo e(asset('assets/img/qr-codes/' . $bs->qr_image)); ?>" class="btn btn-primary btn-sm" download="qrcode.png" id="btn-download">
  ...
  <?php if ($__env->exists('backend.qr-code.save')) echo $__env->make('backend.qr-code.save', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('script'); ?>
  <script>
    let regenerateUrl = "<?php echo e(route('admin.qr_codes.regenerate_code')); ?>";
  </script>

  <script type="text/javascript" src="<?php echo e(asset('assets/js/qr-code.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\qr-code\generate.blade.php ENDPATH**/ ?>