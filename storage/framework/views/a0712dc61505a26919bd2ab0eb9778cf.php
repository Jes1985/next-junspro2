...
<?php if (! $__env->hasRenderedOnce('029fce32-e7c6-435c-ad0c-43933bc2c65e')): $__env->markAsRenderedOnce('029fce32-e7c6-435c-ad0c-43933bc2c65e'); ?>
<style>
...
<div class="onboarding-super-stepper" aria-label="Progression onboarding premium">
  <div class="onboarding-super-row">
    <?php $__currentLoopData = $logicLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="onboarding-super-item <?php echo e($step < $logicStep ? 'is-done' : ($step === $logicStep ? 'is-active' : '')); ?>">
        <span class="onboarding-super-dot"><?php echo e($step < $logicStep ? '✓' : $step); ?></span>
        <span class="onboarding-super-label"><?php echo e($label); ?></span>
      </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\onboarding\partials\premium-stepper.blade.php ENDPATH**/ ?>