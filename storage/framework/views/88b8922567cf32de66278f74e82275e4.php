<?php $__env->startSection('pageHeading'); ?>
  Rituals Services | <?php echo e($websiteInfo->website_title); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('metaDescription'); ?>
  Services à domicile : beauté, bien-être, ménage. Réservez un créneau et profitez.
<?php $__env->stopSection(); ?>
...
<style>
  /* ============================================
     PAGE PREPLY STYLE - ADAPTÉE JUNSPRO (Rituals Services)
     ============================================ */
  ...
  :root {
    ...
    --preply-pink-light: #F59E0B; /* Amber-500 */
    --preply-text: #1F2937;
  ...
  /* Hero At Home - Dégradé jaune orange bleu royal */
  .services-hero {
  ...
  /* Boutons hero At Home - Adaptation jaune orange */
  ...
  /* Informations freelance - Style Preply exact */
  .preply-teacher-info {
    flex: 1;
    min-width: 0;
  }
  ...
  .preply-teacher-btn-primary {
    ...
    border: none;
    margin-bottom: 6px; /* Espacement réduit */
    box-shadow: 0 2px 4px rgba(251, 146, 60, 0.2); /* Ombre subtile */
  }

  /* Effet premium au hover */
  .preply-teacher-btn-primary:hover {
    transform: translateY(-1px);
    box-shadow: 0 4px 12px rgba(251, 146, 60, 0.35), 0 2px 4px rgba(251, 146, 60, 0.2); /* Ombre plus prononcée */
  }
  ...
  /* Bouton play rond jaune orange At Home */
  .preply-popover-play-btn {
    ...
    width: 52px;
    height: 52px;
    background: linear-gradient(135deg, #FBBF24 0%, #FB923C 50%, #2563EB 100%); /* Jaune orange bleu royal */
    border-radius: 50%;
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  .services-page-wrapper.page-at-home {
  ...
  .services-page-wrapper.page-at-home::before { content: ''; position: fixed; top: -20%; left: -10%; width: 60%; height: 60%; background: radial-gradient(circle at 30% 30%, rgba(196, 181, 253, 0.06) 0%, transparent 55%); pointer-events: none; z-index: 0; }
  .services-page-wrapper.page-at-home::after { content: ''; position: fixed; bottom: -20%; right: -10%; width: 55%; height: 55%; background: radial-gradient(circle at 70% 70%, rgba(196, 181, 253, 0.05) 0%, transparent 55%); pointer-events: none; z-index: 0; }
  .services-page-wrapper.page-at-home > * { position: relative; z-index: 1; }
  .services-page-wrapper.page-at-home .preply-filters-section, .services-page-wrapper.page-at-home .preply-results-section { background: transparent; }
  .page-at-home .services-hero { position: relative; border-radius: 0 0 32px 32px; box-shadow: 0 12px 40px rgba(251, 146, 60, 0.18), 0 0 0 1px rgba(255, 255, 255, 0.08) inset; }
  .page-at-home .services-hero::before { content: ''; position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(255,255,255,0.12) 0%, transparent 50%); pointer-events: none; z-index: 1; }
  .page-at-home .services-hero::after { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 160px; background: linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(255,255,255,0.5) 50%, transparent 100%); pointer-events: none; z-index: 2; }
  .page-at-home .preply-filters-section { border-bottom: 1px solid var(--preply-border); box-shadow: 0 2px 12px rgba(0, 0, 0, 0.04); }
  .page-at-home .preply-filter-select, .page-at-home .preply-filter-input { border: 1px solid var(--preply-border); border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05); }
  .page-at-home .preply-filter-select:focus, .page-at-home .preply-filter-input:focus { box-shadow: 0 0 0 3px rgba(var(--preply-primary-rgb), 0.12); }
  .page-at-home .preply-results-header { border-bottom: 1px solid var(--preply-border); padding-bottom: 1rem; margin-bottom: 1rem; }
  .page-at-home .freelancer-card-premium-v2 { border: 1px solid rgba(229, 231, 235, 0.9); border-radius: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.06); transition: transform 0.25s ease-out, box-shadow 0.25s ease-out; }
...
<div class="services-page-wrapper page-at-home">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.services.hero','data' => ['title' => 'Rituals Services','subtitle' => 'Le bon service, au bon moment, chez vous.','micro' => 'Des prestations cadrées, des créneaux clairs, une réservation fluide.','cta' => ['text' => 'Trouver un service', 'url' => '#results', 'variant' => 'primary']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Rituals Services','subtitle' => 'Le bon service, au bon moment, chez vous.','micro' => 'Des prestations cadrées, des créneaux clairs, une réservation fluide.','cta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['text' => 'Trouver un service', 'url' => '#results', 'variant' => 'primary'])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.search-filter','data' => ['formId' => 'atHomeFiltersForm','formAction' => route('services.at-home'),'universe' => 'at-home','keywordPlaceholder' => 'Essayez \'Massage\', \'Ménage\', \'Beauté\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)','categories' => $categories,'categoryDescriptions' => $categoryDescriptions ?? [],'lessonGoals' => $lessonGoals ?? []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['formId' => 'atHomeFiltersForm','formAction' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('services.at-home')),'universe' => 'at-home','keywordPlaceholder' => 'Essayez \'Massage\', \'Ménage\', \'Beauté\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)','categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'categoryDescriptions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categoryDescriptions ?? []),'lessonGoals' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lessonGoals ?? [])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
  ...
  <div class="container">
    <?php echo $__env->make('frontend.components.pause-souffle.inline-premium-projects', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  ...
  <section id="results" class="preply-results-section" style="overflow: visible;">
    <div class="preply-results-container" style="overflow: visible;">
      <div class="preply-results-header">
        <h2 class="preply-results-count"><?php echo e($freelancers->total() ?? 0); ?> professionnels disponibles</h2>
        ...
        <div class="freelancers-grid-premium" style="display: flex; flex-direction: column; gap: 20px;">
          <?php if($freelancers->isEmpty()): ?>
            <div style="text-align: center; padding: 60px 20px;">
              <p style="font-size: 1.125rem; color: var(--preply-text-light);">Aucun professionnel trouvé pour le moment.</p>
            </div>
          <?php else: ?>
          ...
          <?php
            $user = $freelancer->user;
                  ...
                  if (count($nameParts) >= 2) {
                    ...
                    if (!empty($username) && strtolower($username) !== 'freelance') {
                      ...
                      $displayName = 'Professionnel ' . substr($user->id ?? 'P', 0, 3);
                ...
                <div class="freelancer-card-wrapper-premium" data-freelancer-id="<?php echo e($freelancer->id); ?>">
                  ...
                  <?php endif; ?>
                          ...
                          <div class="freelancer-job-line" style="white-space: nowrap;">
                            🗣️ Le professionnel parle <?php echo e($langDisplay); ?>

                </div>
                          
                          <!-- Phrase d'accroche (headline) -->
                          <?php
                            $headline = $freelancer->headline ?? 'Professionnel expérimenté pour vos services à domicile.';
                          ?>
                          ...
                          <?php
                            ...
                            $fullBio = $freelancer->bio ?? $freelancer->about ?? 'Professionnel expérimenté prêt à vous aider pour vos services à domicile.';
                            // Si la bio est trop courte, utiliser un texte par défaut réduit
                            if (empty($fullBio) || strlen($fullBio) < 30) {
                              $fullBio = 'Professionnel expérimenté prêt à vous aider pour vos services à domicile.';
                            }
                      ...
                      <div class="freelancer-pricing-section">
                        ...
                        <!-- Stats services : 2 colonnes alignées -->
                        <div class="freelancer-stats-v2">
                          <div class="stat-item-v2">
                            ...
                            <span class="stat-label-v2">prestations livrées</span>
                          </div>
                          <div class="stat-item-v2">
                            <span class="stat-number"><?php echo e($freelancer->subscriptions()->where('status', 'active')->count() ?? 0); ?></span>
                            <span class="stat-label-v2">clients récurrents</span>
                          </div>
                        </div>
            ...
            <?php endif; ?>
                            ...
                            <div class="video-placeholder-fallback" style="display: <?php echo e(($hasThumbnail && !empty($thumbnailUrl)) ? 'none' : 'flex'); ?>; flex-direction: column; align-items: center; justify-content: center; width: 100%; height: 100%; background: linear-gradient(135deg, #FBBF24 0%, #FB923C 50%, #2563EB 100%); color: white; text-align: center; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 1;">
...
<script>
  ...
  var currentAbortControllerAtHome = null;
  function applyFiltersAjax(params) {
    var resultsSection = document.getElementById('results');
    var resultsContainer = document.getElementById('resultsContainer');
    var form = document.getElementById('atHomeFiltersForm');
    if (!resultsSection || !resultsContainer || !form) return;
    if (currentAbortControllerAtHome) currentAbortControllerAtHome.abort();
    currentAbortControllerAtHome = new AbortController();
    ...
    fetch(url, { method: 'GET', headers: { 'Accept': 'text/html', 'X-Requested-With': 'XMLHttpRequest' }, signal: currentAbortControllerAtHome.signal })
  ...
  // Initialiser la modale vidéo + tri
  ...
  document.querySelectorAll('.preply-filter-select, .preply-filter-input').forEach(el => {
    el.addEventListener('change', function() {
      document.getElementById('atHomeFiltersForm').submit();
    });
  });
    ...
    function createPopoverPortal() {
      ...
      popover.innerHTML = `
        ...
        <div class="preply-popover-video-thumbnail">
          ...
          <div id="popover-placeholder" style="width: 100%; height: 100%; background: linear-gradient(135deg, #FBBF24 0%, #FB923C 50%, #2563EB 100%); display: flex; align-items: center; justify-content: center; color: white;">
  ...
  (function initCountryDropdown() {
    ...
    function selectCountry(code) {
      ...
      // Soumettre le formulaire
      const form = document.getElementById('atHomeFiltersForm');
      if (form) {
        form.submit();
      }
    }
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\services\at-home.blade.php ENDPATH**/ ?>