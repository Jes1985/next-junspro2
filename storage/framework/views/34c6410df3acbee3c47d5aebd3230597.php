    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Add Service Category')); ?></h5>
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create"
                    action="<?php echo e(route('admin.service_management.store_category')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\category\create.blade.php ENDPATH**/ ?>