    ...
    <div class="settings-wrapper">
      ...
      <main class="settings-content">
        ...
        <div class="settings-header">
          <h1><?php echo e(__('Sécurisez votre e-mail')); ?></h1>
          <p><?php echo e(__("Mettez à jour l'adresse e-mail de votre compte Junspro. Pour votre sécurité, nous vous demandons d'abord votre mot de passe actuel. Une fois modifiée, nous vous enverrons un e-mail de confirmation.")); ?></p>
        </div>

        <?php if(session('status') === 'email-updated' || session('success')): ?>
          <div class="alert alert-success">
            ✅ <?php echo e(session('success', __('Votre adresse e-mail a été mise à jour. Vérifiez votre boîte de réception pour confirmer ce changement.'))); ?>
        ...
        <div class="email-status-section">
          <div class="email-status-label"><?php echo e(__('E-mail actuel :')); ?></div>
          <div class="email-status-value"><?php echo e($user->email_address); ?></div>
          <?php if($isEmailVerified): ?>
            <span class="email-status-badge verified">
              ● <?php echo e(__('Vérifié')); ?>

            </span>
          <?php else: ?>
            <span class="email-status-badge pending">
              ● <?php echo e(__('Vérification en attente')); ?>

            </span>
          <?php endif; ?>
        </div>

        <form method="POST" action="<?php echo e(route('user.settings.email.update')); ?>" class="settings-form">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            <label for="email_address" class="form-label"><?php echo e(__('Nouvelle adresse e-mail')); ?></label>
            <input
              id="email_address"
              type="email"
              name="email_address"
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            <label for="email_confirmation" class="form-label"><?php echo e(__('Confirmer la nouvelle adresse e-mail')); ?></label>
            <input
              id="email_confirmation"
              type="email"
              name="email_confirmation"
              class="form-control <?php $__errorArgs = ['email_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> has-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-actions">
            <button type="submit" class="btn-primary-gradient">
              <i class="fas fa-envelope"></i> <?php echo e(__('Mettre à jour mon e-mail')); ?>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\client\settings\email.blade.php ENDPATH**/ ?>