...
<?php $__env->startSection('pageHeading'); ?>
    <?php echo e(__('Termes et conditions')); ?>
        ...
        <div class="terms-page-inner">
            ...
            <main class="terms-page-main">
                <div class="legal-page-header">
                    <h1 class="legal-page-title"><?php echo e(__('Termes et conditions')); ?></h1>
                ...
                <div class="legal-page-footer">
                    ...
                    <a href="#" class="terms-back-to-top" id="terms-back-to-top"><?php echo e(__('Retour en haut')); ?></a>
                </div>
            </main>
        </div>
    </div>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\terms-conditions.blade.php ENDPATH**/ ?>