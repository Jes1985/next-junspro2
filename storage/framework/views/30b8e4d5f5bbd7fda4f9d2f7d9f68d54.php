  ...
  >
    ...
    <div class="transfer-modal-body">
      ...
      <div class="transfer-confirm-summary">
        ...
        <div class="transfer-confirm-summary-item">
          <span x-text="selectedQty"></span> <span x-text="selectedQty === 1 ? '<?php echo e(__('Rituel')); ?>' : '<?php echo e(__('Rituels')); ?>'"></span> <?php echo e(__('avec')); ?> <span x-text="selectedFreelance?.name"></span> :</span>
      ...
      <div class="transfer-confirm-next">
        ...
        <ul class="transfer-confirm-next-list">
          <li>
            <span><?php echo e(__('Vous recevez')); ?> <strong x-text="selectedQty"></strong> <span x-text="selectedQty === 1 ? '<?php echo e(__('Rituel')); ?>' : '<?php echo e(__('Rituels')); ?>'"></span> (<strong x-text="formatPrice(usedAmount)"></strong>) <?php echo e(__('avec')); ?> <span x-text="selectedFreelance?.name"></span> <?php echo e(__('aujourd\'hui.')); ?></span>
          </li>
          <li>
            <span><?php echo e(__('Le premier paiement de votre Rituel avec')); ?> <span x-text="selectedFreelance?.name"></span> <?php echo e(__('aura lieu dans 4 semaines')); ?> (<strong x-text="selectedPlan?.total_sessions"></strong> <?php echo e(__('Rituels')); ?> · <strong x-text="formatPrice(selectedPlan?.price)"></strong> <?php echo e(__('toutes les 4 semaines')); ?>)</span>
          </li>
          <li x-show="remainingAmount > 0">
            <span><?php echo e(__('Il vous reste')); ?> <strong x-text="formatPrice(remainingAmount)"></strong> <?php echo e(__('avec')); ?> <span x-text="currentTutorName"></span>, <?php echo e(__('et votre abonnement reste actif.')); ?></span>
          </li>
        </ul>
      </div>
    </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\add\step5-confirm.blade.php ENDPATH**/ ?>