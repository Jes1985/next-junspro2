      ...
      <div class="row gx-xl-5 justify-content-between">
        <div class="col-xl-4 col-lg-5 col-md-6">
          <div class="footer-widget">
            ...
            <div class="logo mb-20">
              <a class="navbar-brand" href="<?php echo e(route('index')); ?>" target="_self" title="Link">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="footer-widget">
            ...
            <form id="newsletterForm2" action="<?php echo e(route('store_subscriber')); ?>" class="subscription-form"
              method="POST">
              <?php echo csrf_field(); ?>
        ...
        <?php if(count($socialMediaInfos) > 0): ?>
          <div class="social-link rounded style-2 justify-content-center mb-10">
            <?php $__currentLoopData = $socialMediaInfos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $socialMediaInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e($socialMediaInfo->url); ?>" target="_blank" title="Link"><i
...
<!-- Footer-area end-->
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\partials\footer\footer-v2.blade.php ENDPATH**/ ?>