      ...
      <div class="overview-content">
        ...
        <section class="focus-area">
          <div class="welcome-card">
            <p class="tagline">Bonjour, <?php echo e($displayName); ?>. Prête pour une journée créative ?</p>
            <h2>Focus du jour</h2>
            <div class="today-status">
              <div class="time-slot">🕘 09:00 - 10:00</div>
              <h3>✨ Rituel de conception</h3>
              <p class="client">Pour : <strong>Maison Blanc</strong></p>
              <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'rituals'])); ?>" class="btn-primary">Commencer la session</a>
            </div>
            <p class="hint">Votre prochain créneau est à 14h. <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'calendar'])); ?>">Ajouter du temps focus</a></p>
          </div>
        </section>
        ...
        <section class="cards-horizontal-row">
          <div class="priority-card">
            ...
            <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'profile'])); ?>" class="btn-refined">Optimiser mon profil</a>
          </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/frontend/freelance/dashboard/tabs/overview.blade.php ENDPATH**/ ?>