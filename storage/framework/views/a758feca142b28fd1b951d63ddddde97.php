...
<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Form Inputs')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="<?php echo e(route('admin.service_management.forms', ['language' => $defaultLang->code])); ?>"><?php echo e(__('Forms')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e($form->name); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#"><?php echo e(__('Input Fields')); ?></a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-lg-7">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col">
              <div class="card-title d-inline-block"><?php echo e(__('Form Input Fields')); ?></div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col">
              <p class="text-warning">
                <?php echo e('*' . __('Do not create')); ?> <span class="text-info"><?php echo e(__('Name, Email & Phone Number')); ?></span>
                <?php echo e(__('input field, it will be in the form by default.')); ?><br>
                <?php echo e('*' . __('Drag & drop to sort the input fields of this form.')); ?>
                  ...
                  <?php $__currentLoopData = $inputFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inputField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($inputField->type == 1): ?>
                      <form class="ui-state-default"
                        action="<?php echo e(route('admin.service_management.form.delete_input', ['id' => $inputField->id])); ?>"
                        method="POST" data-id="<?php echo e($inputField->id); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                          <label>
                            <?php echo e($inputField->label); ?><?php echo e($inputField->is_required == 1 ? '*' : ''); ?>

                          </label>
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <input type="text" class="form-control" name="<?php echo e($inputField->name); ?>"
                                placeholder="<?php echo e($inputField->placeholder); ?>">
                            </div>

                            <div class="col-lg-1">
                              <a href="<?php echo e(route('admin.service_management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')])); ?>"
                          ...
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <select class="form-control" name="<?php echo e($inputField->name); ?>">
                                <option selected disabled><?php echo e($inputField->placeholder); ?></option>
                            ...
                            <div class="col-lg-9 mr-3">
                              <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="custom-control custom-checkbox">
                                  <input type="checkbox" id="<?php echo e('option-' . $loop->iteration); ?>" name="values[]"
                                    class="custom-control-input">
                                  <label class="custom-control-label"
                                    for="<?php echo e('option-' . $loop->iteration); ?>"><?php echo e($option); ?></label>
                                </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <?php elseif($inputField->type == 5): ?>
                      <form class="ui-state-default"
                        ...
                        <div class="form-group">
                          ...
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <textarea class="form-control" name="<?php echo e($inputField->name); ?>" rows="5" cols="50"
                                placeholder="<?php echo e($inputField->placeholder); ?>"></textarea>
                            </div>

                            <div class="col-lg-1">
                              <a href="<?php echo e(route('admin.service_management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')])); ?>"
                                class="btn btn-sm btn-secondary mt-1"><i class="fas fa-edit text-white"></i>
                              </a>
                            </div>
                    ...
                    <?php elseif($inputField->type == 6): ?>
                      <form class="ui-state-default"
                        ...
                        <div class="form-group">
                          ...
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <input type="text" class="form-control datepicker" name="<?php echo e($inputField->name); ?>"
                                placeholder="<?php echo e($inputField->placeholder); ?>" readonly autocomplete="off">
                            </div>
                    ...
                    <?php elseif($inputField->type == 7): ?>
                      <form class="ui-state-default"
                        ...
                        <div class="form-group">
                          ...
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <input type="text" class="form-control timepicker" name="<?php echo e($inputField->name); ?>"
                                placeholder="<?php echo e($inputField->placeholder); ?>" readonly autocomplete="off">
                            </div>
                      ...
                      <form class="ui-state-default"
                        ...
                        <div class="form-group">
                          <label>
                            ...
                            (<?php echo e('Maximum Size' . ' ' . $inputField->file_size . ' ' . 'MB'); ?>)
                          </label>
                          <div class="row no-gutters">
                            <div class="col-lg-9 mr-3">
                              <input type="file" name="<?php echo e($inputField->name); ?>" class="ltr">
                            </div>
    ...
    <div class="col-lg-5">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-9">
              <div class="card-title d-inline-block"><?php echo e(__('Create Input Field')); ?></div>
            </div>

            <div class="col-lg-3">
              <a href="<?php echo e(route('admin.service_management.forms', ['language' => request()->input('language')])); ?>"
        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              <form id="ajaxForm"
                action="<?php echo e(route('admin.service_management.form.store_input', ['id' => $form->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                  <label><?php echo e(__('Input Field Type') . '*'); ?></label><br>
                  <div class="form-check form-check-inline pl-0">
                    ...
                    <label class="form-check-label mt-2" for="input-type-1"><?php echo e(__('Text Field')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="2" id="input-type-2"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-2"><?php echo e(__('Number Field')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="3" id="input-type-3"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-3"><?php echo e(__('Select')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="4" id="input-type-4"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-4"><?php echo e(__('Checkbox')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="5" id="input-type-5"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-5"><?php echo e(__('Textarea')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="6" id="input-type-6"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-6"><?php echo e(__('Datepicker')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="7" id="input-type-7"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-7"><?php echo e(__('Timepicker')); ?></label>
                  </div>

                  <div class="form-check form-check-inline pl-0">
                    <input type="radio" class="form-check-input" name="type" value="8" id="input-type-8"
                      v-model="inputType" v-on:change="changeInputType()">
                    <label class="form-check-label mt-2" for="input-type-8"><?php echo e(__('File')); ?></label>
                  </div>
...
<?php $__env->startSection('script'); ?>
  <script type="text/javascript">
    let optArr = <?php echo json_encode([]); ?>;

    const sortURL = "<?php echo e(route('admin.service_management.form.sort_input')); ?>";
  </script>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\client-service\form-input\index.blade.php ENDPATH**/ ?>