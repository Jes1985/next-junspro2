  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-success-title">
        <?php echo e(__('Transfert terminé')); ?>

      </h2>
      
      <p class="transfer-success-message">
        <?php echo e(__('Et voilà ! Vous avez')); ?> <strong x-text="selectedQty"></strong> <span x-text="selectedQty === 1 ? '<?php echo e(__('rituel')); ?>' : '<?php echo e(__('rituels')); ?>'"></span> <?php echo e(__('avec')); ?> <span x-text="selectedFreelance?.name"></span>. <?php echo e(__('Programmez votre rituel dès maintenant.')); ?>
    ...
    <div class="transfer-modal-footer">
      ...
      >
        <?php echo e(__('Programmer le rituel')); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\active\step5-success.blade.php ENDPATH**/ ?>