<?php $__env->startSection('pageHeading'); ?>
  <?php if(!empty($pageHeading)): ?>
    <?php echo e($pageHeading->services_page_title); ?>
...
<?php $__env->startSection('metaKeywords'); ?>
  <?php if(!empty($seoInfo)): ?>
    <?php echo e($seoInfo->meta_keyword_services); ?>
...
<?php $__env->startSection('metaDescription'); ?>
  <?php if(!empty($seoInfo)): ?>
    <?php echo e($seoInfo->meta_description_services); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="services-hero-container">
      <div class="services-hero-content">
          <h1 class="services-hero-title">
            <span class="hero-title-line-1"><?php echo e(__('Trouvez le')); ?> <span class="highlight"><?php echo e(__('service idéal')); ?></span></span>
            <span class="hero-title-line-2"><?php echo e(__('pour votre projet')); ?></span>
          </h1>
        <p class="services-hero-subtitle">
          <?php echo e(__('Filtrez par prix horaire, langues, pays et découvrez les profils les plus adaptés à votre besoin.')); ?>

        </p>
        <div class="services-hero-stats">
          <span class="hero-stat-text"><?php echo e(__('+10 000 freelances vérifiés')); ?></span>
            </div>
      </div>
    </div>
  </section>
          ...
          <div class="sidebar-content">
            ...
            <!-- Catégories - Version Premium -->
              ...
              <div class="filter-section">
                <h4 class="filter-title"><?php echo e(__('Catégories')); ?></h4>
                <div class="categories-premium-card">
                  <!-- Option "Tout" -->
                  <div class="category-parent-item <?php echo e(empty(request()->input('category')) ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('services')); ?>" class="category-parent-link">
                      <div class="category-parent-content">
                        <span class="category-icon">📋</span>
                        <span class="category-name"><?php echo e(strtoupper(__('Tout'))); ?></span>
                      </div>
                    </a>
                  </div>
                    ...
                    ?>
                    <div class="category-parent-item <?php echo e($isCategoryActive ? 'active' : ''); ?> <?php echo e($isCategoryOpen ? 'open' : ''); ?> <?php echo e($shouldHide ? 'category-hidden' : ''); ?>" 
                         data-category-id="category-<?php echo e($category->id); ?>">
                      <button type="button" class="category-parent-toggle" data-category-id="category-<?php echo e($category->id); ?>">
                        <div class="category-parent-content">
                          <span class="category-icon"><?php echo e($categoryIcon); ?></span>
                          <span class="category-name"><?php echo e(strtoupper($category->name)); ?></span>
                        </div>
                        ...
                        <div class="category-children <?php echo e($isCategoryOpen ? 'open' : ''); ?>">
                              <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('services', ['category' => $category->slug, 'subcategory' => $subcategory->slug])); ?>" 
                               class="category-child-link <?php echo e(($subcategory->slug == $currentSubcategorySlug && $isCategoryActive) ? 'active' : ''); ?>">
                  ...
                  <?php if(count($categories) > 5): ?>
                    <button type="button" class="show-more-categories-btn" id="show-more-categories-btn">
                      <span class="btn-text-show"><?php echo e(__('Afficher plus')); ?></span>
                      <span class="btn-text-hide" style="display: none;"><?php echo e(__('Afficher moins')); ?></span>
                    </button>
                  <?php endif; ?>
                </div>
                  </div>
            ...
            <!-- Compétences -->
            <div class="filter-section">
              <h4 class="filter-title"><?php echo e(__('Compétences')); ?></h4>
              <div class="filter-content">
                ...
                <div class="skills-search-wrapper">
                  <input type="text" 
                         ...
                         placeholder="<?php echo e(__('Rechercher une compétence...')); ?>">
                </div>
                <div class="filter-checkboxes" id="skills-checkboxes-container">
                    <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="filter-checkbox-item" data-skill-name="<?php echo e(strtolower($skill->name)); ?>">
                      <input type="checkbox" 
                             class="filter-checkbox" 
                             name="skills[]" 
                             value="<?php echo e($skill->id); ?>"
                             <?php if(in_array($skill->id, (array)request()->input('skills', []))): echo 'checked'; endif; ?>>
              ...
              <div class="filter-content">
                <div class="filter-options">
                  <label class="filter-option">
                    <input type="radio" class="filter-radio" name="hours_per_week" value="" <?php echo e(empty(request()->input('hours_per_week')) ? 'checked' : ''); ?>>
                    <span><?php echo e(__('Toutes les disponibilités')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio" name="hours_per_week" value="1-8" <?php echo e(request()->input('hours_per_week') == '1-8' ? 'checked' : ''); ?>>
                    <span><?php echo e(__('1 à 8h/semaine')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio" name="hours_per_week" value="8-16" <?php echo e(request()->input('hours_per_week') == '8-16' ? 'checked' : ''); ?>>
                    <span><?php echo e(__('8 à 16h/semaine')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio" name="hours_per_week" value="16-24" <?php echo e(request()->input('hours_per_week') == '16-24' ? 'checked' : ''); ?>>
                    <span><?php echo e(__('16 à 24h/semaine')); ?></span>
                  </label>
                </div>
                  </div>
                  </div>
              ...
              <div class="filter-section">
                ...
                <div class="filter-content">
                  <select class="filter-select" name="country">
                    <option value=""><?php echo e(__('Tous les pays')); ?></option>
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($country); ?>" <?php echo e(request()->input('country') == $country ? 'selected' : ''); ?>>
                        <?php echo e($country); ?>
                    ...
                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <label class="filter-checkbox-item">
                        <input type="checkbox" 
                               ...
                               <?php if(in_array($lang, (array)request()->input('languages', []))): echo 'checked'; endif; ?>>
            ...
            <!-- Délai de livraison -->
            <div class="filter-section">
              <h4 class="filter-title"><?php echo e(__('Délai de livraison')); ?></h4>
              <div class="filter-content">
                <div class="filter-checkboxes">
                  <label class="filter-checkbox-item">
                    <input type="radio" 
                           ...
                           name="delivery_mode" 
                           value="standard"
                           <?php if(request()->input('delivery_mode') == 'standard' || empty(request()->input('delivery_mode'))): echo 'checked'; endif; ?>>
                    <span><?php echo e(__('Standard')); ?> <small class="text-muted">(<?php echo e(__('Livraison hebdomadaire')); ?>)</small></span>
                  </label>
                  <label class="filter-checkbox-item">
                    <input type="radio" 
                           class="filter-radio" 
                           name="delivery_mode" 
                           value="express_72h"
                           <?php if(request()->input('delivery_mode') == 'express_72h'): echo 'checked'; endif; ?>>
                    <span><?php echo e(__('Express 72h')); ?> <small class="text-muted">(+10%)</small></span>
                  </label>
                  <label class="filter-checkbox-item">
                    <input type="radio" 
                           class="filter-radio" 
                           name="delivery_mode" 
                           value="express_48h"
                           <?php if(request()->input('delivery_mode') == 'express_48h'): echo 'checked'; endif; ?>>
                    <span><?php echo e(__('Express 48h')); ?> <small class="text-muted">(+20%)</small></span>
                  </label>
                  <label class="filter-checkbox-item">
                    <input type="radio" 
                           class="filter-radio" 
                           name="delivery_mode" 
                           value="express_24h"
                           <?php if(request()->input('delivery_mode') == 'express_24h'): echo 'checked'; endif; ?>>
                    <span><?php echo e(__('Express 24h')); ?> <small class="text-muted">(+30%)</small></span>
                  </label>
                </div>
              </div>
                </div>
            ...
            <div class="filter-section">
              ...
              <div class="filter-content">
                <div class="filter-options">
                  <label class="filter-option">
                    <input type="radio" class="filter-radio rating-search" name="filter_rating" value="" <?php echo e(empty(request()->input('rating')) ? 'checked' : ''); ?>>
                    <span><?php echo e(__('Toutes')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio rating-search" name="filter_rating" value="5" <?php echo e(request()->input('rating') == 5 ? 'checked' : ''); ?>>
                    <span><?php echo e(__('5 étoiles')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio rating-search" name="filter_rating" value="4" <?php echo e(request()->input('rating') == 4 ? 'checked' : ''); ?>>
                    <span><?php echo e(__('4 étoiles et plus')); ?></span>
                  </label>
                  <label class="filter-option">
                    <input type="radio" class="filter-radio rating-search" name="filter_rating" value="3" <?php echo e(request()->input('rating') == 3 ? 'checked' : ''); ?>>
                    <span><?php echo e(__('3 étoiles et plus')); ?></span>
                  </label>
              </div>
            </div>
          </div>
            ...
            <div class="filter-reset">
              <button type="button" class="reset-filters-btn">
                ...
                <span><?php echo e(__('Réinitialiser')); ?></span>
              </button>
        </div>
          </div>
        </aside>
        ...
        <main class="services-main-premium">
          ...
          <div class="search-bar-mobile">
              ...
              <div class="search-input-wrapper">
                <input type="text" 
                       placeholder="<?php echo e(__('Rechercher un service...')); ?>"
                       class="search-input"
          ...
          <?php if(!empty($currentCategory)): ?>
            <div class="current-category-info">
              <h2 class="current-category-title"><?php echo e($currentCategory->name); ?></h2>
              <p class="current-category-description">
                <?php echo e(__('Logos, identités visuelles et visuels pour vos campagnes, créés par des freelances triés sur le volet.')); ?>
            ...
            <div class="context-bar-left">
              <span class="context-text">
                <?php if($servicesCount == 0): ?>
                  <?php echo e(__('Aucun service trouvé pour le moment')); ?>

                <?php else: ?>
                  <?php echo e($servicesCount); ?> <?php echo e($servicesCount == 1 ? __('service trouvé') : __('services trouvés')); ?>
            ...
            <?php if(count($services) == 0): ?>
              ...
              <div class="empty-state-premium">
                ...
                <h2 class="empty-state-title">
                  <?php if($servicesCount == 0 && empty(request()->input('category'))): ?>
                    <?php echo e(__('Aucun service disponible pour le moment')); ?>

            <?php else: ?>
                    <?php echo e(__('Aucun service ne correspond à vos filtres.')); ?>

                  <?php endif; ?>
                </h2>
                <p class="empty-state-description">
                  <?php if($servicesCount == 0 && empty(request()->input('category'))): ?>
                    <?php echo e(__('Les services seront bientôt disponibles sur la plateforme.')); ?>

                                <?php else: ?>
                    <?php echo e(__('Essayez de modifier vos critères ou de réinitialiser la recherche.')); ?>

                                <?php endif; ?>
                </p>
                <div class="empty-state-actions">
                  <?php if(!empty(request()->input('category')) || !empty(request()->input('keyword'))): ?>
                    <a href="<?php echo e(route('services')); ?>" class="btn-primary-premium">
                      <?php echo e(__('Réinitialiser les filtres')); ?>

                    </a>
                                <?php endif; ?>
                  <?php if(!empty($currentCategory) && $servicesCount == 0): ?>
                    <a href="<?php echo e(route('services')); ?>" class="btn-secondary-premium">
                      <?php echo e(__('Voir toutes les catégories')); ?>

                    </a>
                          <?php endif; ?>
                            <?php if(auth()->guard('web')->check()): ?>
                    <?php if(Auth::guard('web')->user()->is_seller ?? false): ?>
                      <a href="<?php echo e(route('seller.service.create') ?? '#'); ?>" class="btn-secondary-premium">
                        <?php echo e(__('Créer mon premier service')); ?>
              ...
              <?php if(isset($popularServices) && count($popularServices) > 0): ?>
                <div class="popular-services-premium">
                  <div class="popular-header">
                    <h3 class="popular-title"><?php echo e(__('Services populaires')); ?></h3>
                    <?php if(!empty($currentCategory)): ?>
                      <p class="popular-subtitle"><?php echo e(__('dans')); ?> <?php echo e($currentCategory->name); ?></p>
                          <?php endif; ?>
                        </div>
                  <div class="services-grid-premium">
                    <?php $__currentLoopData = $popularServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php echo $__env->make('frontend.service.partials.service-card', [
                        'service' => $service,
  ...
  <form class="d-none" action="<?php echo e(route('services')); ?>" method="GET" id="searchForm">
    ...
    <input type="hidden" id="subcategory-id" name="subcategory" value="<?php echo e(!empty(request()->input('subcategory')) ? request()->input('subcategory') : ''); ?>">
    <input type="hidden" id="tag-id" name="tag" value="<?php echo e(!empty(request()->input('tag')) ? request()->input('tag') : ''); ?>">
    <input type="hidden" id="hours_per_week-id" name="hours_per_week" value="<?php echo e(!empty(request()->input('hours_per_week')) ? request()->input('hours_per_week') : ''); ?>">
    <input type="hidden" id="country-id" name="country" value="<?php echo e(!empty(request()->input('country')) ? request()->input('country') : ''); ?>">
    <input type="hidden" id="delivery-mode-id" name="delivery_mode" value="<?php echo e(!empty(request()->input('delivery_mode')) ? request()->input('delivery_mode') : ''); ?>">
    <input type="hidden" id="rating-id" name="rating" value="<?php echo e(!empty(request()->input('rating')) ? request()->input('rating') : ''); ?>">
    <input type="hidden" id="min-hourly-rate" name="min_hourly_rate" value="<?php echo e(!empty(request()->input('min_hourly_rate')) ? request()->input('min_hourly_rate') : '10'); ?>">
    <input type="hidden" id="max-hourly-rate" name="max_hourly_rate" value="<?php echo e(!empty(request()->input('max_hourly_rate')) ? request()->input('max_hourly_rate') : '299'); ?>">
    ...
    <textarea class="d-none" name="skills" id="skills" cols="30" rows="10">
      <?php if(request()->filled('skills') && !empty(request()->input('skills'))): ?>
        <?php echo e(json_encode(request()->input('skills'))); ?>

      <?php endif; ?>
    </textarea>
    <textarea class="d-none" name="languages" id="languages" cols="30" rows="10">
      <?php if(request()->filled('languages') && !empty(request()->input('languages'))): ?>
        <?php echo e(json_encode(request()->input('languages'))); ?>
...
<?php $__env->startSection('script'); ?>
  <script>
    let currency_info = <?php echo json_encode($currencyInfo ?? (object)['base_currency_symbol_position' => 'right', 'base_currency_symbol' => '€']); ?>;
    ...
    let curr_min_rate = <?php echo e((int)(request()->input('min_hourly_rate', 10))); ?>;
    let curr_max_rate = <?php echo e((int)(request()->input('max_hourly_rate', 299))); ?>;
    
    var searchUrl = "<?php echo e(route('search-service')); ?>";
    var serviceUrl = "<?php echo e(route('services')); ?>";
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\service\index.blade.php ENDPATH**/ ?>