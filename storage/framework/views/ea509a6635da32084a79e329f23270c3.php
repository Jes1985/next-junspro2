                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <p><?php echo e(!empty($membership->seller) ? $membership->seller->username : '-'); ?></p>

                                <label><?php echo e(__('Email')); ?></label>
                                <p><?php echo e(!empty($membership->seller) ? $membership->seller->email : '-'); ?></p>
                                <label><?php echo e(__('Phone')); ?></label>
                                <p>
                                  <?php echo e(!empty($membership->seller->phone) ? $membership->seller->phone : '-'); ?>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\payment_log\index.blade.php ENDPATH**/ ?>