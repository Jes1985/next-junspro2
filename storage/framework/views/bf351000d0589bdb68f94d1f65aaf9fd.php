...
<?php $__env->startSection('content'); ?>
  <div class="onboarding-page">
    <div class="onboarding-container">
      <?php echo $__env->make('frontend.freelance.onboarding.partials.premium-stepper', ['routeStep' => 7], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <!-- Barre de progression -->
      ...
      <div class="onboarding-content">
        ...
        <form action="<?php echo e(route('freelance.onboarding.step7.store')); ?>" method="POST" id="availabilityForm">
          <?php echo csrf_field(); ?>
          ...
          <div class="section">
            ...
            <div class="advanced-matching-filters">
              <div class="preply-filter-group preply-availability-group">
                ...
                <input type="hidden" name="matching_availability" id="matchingAvailabilityInput" value="<?php echo e(old('matching_availability', $data['matching_availability'] ?? '')); ?>">
              </div>
            </div>
          </div>
          ...
          <div class="section" id="timezoneSelectSection" style="display: none;">
            ...
            <select name="timezone" id="timezone" class="timezone-select <?php $__errorArgs = ['timezone'];
...
unset($__errorArgs, $__bag); ?>">
              ...
              <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($tz); ?>" <?php echo e(old('timezone', $data['timezone'] ?? 'Europe/Paris') == $tz ? 'selected' : ''); ?>>
                  <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="section">
            ...
            <div class="days-list">
              <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayKey => $dayLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="day-row">
                  <input 
                    type="checkbox" 
                    name="availability[<?php echo e($dayKey); ?>][enabled]" 
                    id="day_<?php echo e($dayKey); ?>"
                    class="day-checkbox"
                    value="1"
                    <?php echo e($isActive ? 'checked' : ''); ?>

                    onchange="toggleDayAvailability('<?php echo e($dayKey); ?>', this.checked)"
                  >
                  <label for="day_<?php echo e($dayKey); ?>" class="day-label"><?php echo e($dayLabel); ?></label>
                  <div class="day-slots" id="slots_<?php echo e($dayKey); ?>" style="<?php echo e(!$isActive ? 'display: none;' : ''); ?>">
                    <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="time-slot-row" data-slot-index="<?php echo e($index); ?>">
                        <span class="time-label">De</span>
                        <input 
                          type="time" 
                          name="availability[<?php echo e($dayKey); ?>][slots][<?php echo e($index); ?>][from]"
                          class="time-input"
                          value="<?php echo e($slot['from'] ?? '09:00'); ?>"
                          <?php echo e($isActive ? 'required' : ''); ?>

                        >
                        <span class="time-label">À</span>
                        <input 
                          type="time" 
                          name="availability[<?php echo e($dayKey); ?>][slots][<?php echo e($index); ?>][to]"
                          class="time-input"
                          value="<?php echo e($slot['to'] ?? '17:00'); ?>"
                          <?php echo e($isActive ? 'required' : ''); ?>
                        ...
                        <?php if($index > 0): ?>
                          <button 
                            ...
                            onclick="removeTimeSlot('<?php echo e($dayKey); ?>', <?php echo e($index); ?>)"
                          >
                            Supprimer
                          </button>
                        <?php endif; ?>
                    ...
                    <button 
                      type="button" 
                      class="add-slot-link"
                      onclick="addTimeSlot('<?php echo e($dayKey); ?>')"
                    >
          ...
          <div class="onboarding-actions">
            <a href="<?php echo e(route('freelance.onboarding.step6')); ?>" class="btn-back">
              Retour
            </a>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\onboarding\step7.blade.php ENDPATH**/ ?>