    ...
    <div class="change-plan-modal-body">
      ...
      >
        ...
        <div class="change-plan-option-content">
          <div class="change-plan-option-title"><?php echo e(__('Passer à la formule supérieure')); ?></div>
        </div>
      ...
      >
        ...
        <div class="change-plan-option-content">
          <div class="change-plan-option-title"><?php echo e(__('Passer à la formule inférieure')); ?></div>
        </div>
        <div class="change-plan-option-arrow">
          <i class="fas fa-chevron-right"></i>
        </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\change-plan-entry.blade.php ENDPATH**/ ?>