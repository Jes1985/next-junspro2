<?php $__env->startSection('pageHeading'); ?>
  <?php echo e(__('Soumettre une Mission')); ?>
...
<div class="mission-form-container" id="missionFormApp">
  <div class="mission-form-wrapper">
    <div class="mission-form-main">
      ...
      <form action="<?php echo e(route('mission.submit')); ?>" method="POST" enctype="multipart/form-data" id="missionForm">
                        <?php echo csrf_field(); ?>
        ...
        <select name="univers_slug" id="univers_slug_hidden" class="mission-form-hidden-select" required>
          <option value=""><?php echo e(old('univers_slug', '')); ?></option>
        </select>
        <!-- ID pour JS -->
          ...
          <div class="mission-form-card">
            ...
            <div class="mission-univers-grid">
              <label class="mission-univers-card" data-value="projets-consulting">
                <input type="radio" name="univers_slug_radio" value="projets-consulting" <?php echo e(old('univers_slug') === 'projets-consulting' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">Projets & Consulting</div>
              </label>
              
              <label class="mission-univers-card" data-value="cours-mentorat">
                <input type="radio" name="univers_slug_radio" value="cours-mentorat" <?php echo e(old('univers_slug') === 'cours-mentorat' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">Cours & Mentorat</div>
              </label>
              
              <label class="mission-univers-card" data-value="service-domicile">
                <input type="radio" name="univers_slug_radio" value="service-domicile" <?php echo e(old('univers_slug') === 'service-domicile' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">Service à domicile</div>
              </label>
              
              <label class="mission-univers-card" data-value="echange-logement">
                <input type="radio" name="univers_slug_radio" value="echange-logement" <?php echo e(old('univers_slug') === 'echange-logement' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">Échange de logement</div>
              </label>
              
              <label class="mission-univers-card" data-value="wellnesslive">
                <input type="radio" name="univers_slug_radio" value="wellnesslive" <?php echo e(old('univers_slug') === 'wellnesslive' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">WellnessLive</div>
              </label>
              
              <label class="mission-univers-card" data-value="pause-souffle">
                <input type="radio" name="univers_slug_radio" value="pause-souffle" <?php echo e(old('univers_slug') === 'pause-souffle' ? 'checked' : ''); ?>>
                <div class="mission-univers-card-title">Pause Souffle</div>
              </label>
            </div>
            
            <?php $__errorArgs = ['univers_slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
              <div class="mission-form-error"><?php echo e($message); ?></div>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-top: 1.5rem;">
              ...
              <textarea id="about_you" 
                        name="about_you" 
                        rows="4"
                        class="mission-form-textarea <?php $__errorArgs = ['about_you'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 1rem; margin-bottom: 1rem;">
              <div>
                ...
                <input type="text" 
                       id="client_nom" 
                       name="client_nom" 
                       value="<?php echo e(old('client_nom')); ?>" 
                       class="mission-form-input <?php $__errorArgs = ['client_nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div>
                ...
                <input type="email" 
                       ...
                       class="mission-form-input <?php $__errorArgs = ['client_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
              ...
              <input type="tel" 
                     ...
                     value="<?php echo e(old('client_telephone')); ?>" 
                     class="mission-form-input <?php $__errorArgs = ['client_telephone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <?php $__errorArgs = ['client_telephone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
          ...
          <div class="mission-form-card">
            ...
            <div style="margin-bottom: 1.5rem;">
              ...
              <textarea id="js-description" 
                        ...
                        rows="6"
                        class="mission-form-textarea <?php $__errorArgs = ['description_mission'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        required><?php echo e(old('description_mission')); ?></textarea>
                                <?php $__errorArgs = ['description_mission'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="js-budget-section" style="margin-bottom: 1.5rem;">
              ...
              <input type="number" 
                     ...
                     min="0" 
                     step="5" 
                     class="mission-form-input <?php $__errorArgs = ['budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
              ...
              <input type="file" 
                     ...
                     class="mission-form-input <?php $__errorArgs = ['fichier_joint'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
              <div>
                ...
                <select id="preferred_contact" name="preferred_contact" class="mission-form-select">
                  ...
                  <option value="call" <?php echo e(old('preferred_contact') === 'call' ? 'selected' : ''); ?>>Appel</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select id="language" name="language" class="mission-form-select">
                  <option value="">Sélectionnez</option>
                  <option value="fr" <?php echo e(old('language') === 'fr' ? 'selected' : ''); ?>>Français</option>
                  <option value="en" <?php echo e(old('language') === 'en' ? 'selected' : ''); ?>>English</option>
                  <option value="it" <?php echo e(old('language') === 'it' ? 'selected' : ''); ?>>Italiano</option>
                </select>
              </div>
              ...
              <div id="js-location-mode-section">
                ...
                <select id="location_mode" name="location_mode" class="mission-form-select">
                  <option value="">Sélectionnez</option>
                  <option value="remote" <?php echo e(old('location_mode') === 'remote' ? 'selected' : ''); ?>>Distant</option>
                  <option value="hybrid" <?php echo e(old('location_mode') === 'hybrid' ? 'selected' : ''); ?>>Hybride</option>
                  <option value="onsite" <?php echo e(old('location_mode') === 'onsite' ? 'selected' : ''); ?>>Sur site</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="mission-form-step" data-step="4" id="step-4">
          <div id="js-option-section" class="mission-form-card">
            ...
            <div class="mission-form-radio-group" id="js-options-content">
              <div class="mission-form-radio-item">
                <input type="radio" name="offre" id="offre_accompagnement" value="Accompagnement" <?php echo e(old('offre') === 'Accompagnement' ? 'checked' : ''); ?>>
              ...
              <div class="mission-form-radio-item">
                <input type="radio" name="offre" id="offre_mise_relation" value="Mise_en_relation" <?php echo e(old('offre') === 'Mise_en_relation' ? 'checked' : (!old('offre') ? 'checked' : '')); ?>>
              ...
              <div class="mission-form-radio-item">
                <input type="radio" name="offre" id="offre_aucune" value="Aucune" <?php echo e(old('offre') === 'Aucune' ? 'checked' : ''); ?>>
      ...
      <div class="mission-summary-content">
        ...
        <div class="mission-summary-item hidden" id="js-summary-subscription-item">
          ...
          <div class="mission-summary-value" id="summarySubscription">
            ...
            <a href="<?php echo e(route('user.settings.subscription')); ?>" style="display: block; margin-top: 0.5rem; color: #64748b; font-size: 0.75rem; text-decoration: underline; text-align: center;">Gérer mon abonnement</a>
          </div>
        </div>
        <div class="mission-summary-item">
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\client\mission-form.blade.php ENDPATH**/ ?>