...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.services.hero','data' => ['title' => 'Cours et Tutorat','subtitle' => 'Des progrès qui se voient.','micro' => 'Séance d\'essai, objectifs clairs, suivi régulier. Vous avancez sereinement. Nous vous offrons le meilleur pour développer vos compétences.','cta' => ['text' => 'Réserver un essai', 'url' => '#results', 'variant' => 'primary']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cours et Tutorat','subtitle' => 'Des progrès qui se voient.','micro' => 'Séance d\'essai, objectifs clairs, suivi régulier. Vous avancez sereinement. Nous vous offrons le meilleur pour développer vos compétences.','cta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['text' => 'Réserver un essai', 'url' => '#results', 'variant' => 'primary'])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.search-filter','data' => ['formId' => 'preplyFiltersForm','formAction' => route('services.lessons'),'universe' => 'lessons','keywordPlaceholder' => 'Essayez \'Anglais\', \'Maths\', \'Excel\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)','categories' => $categories,'categoryDescriptions' => $categoryDescriptions ?? [],'lessonGoals' => $lessonGoals ?? []]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['formId' => 'preplyFiltersForm','formAction' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('services.lessons')),'universe' => 'lessons','keywordPlaceholder' => 'Essayez \'Anglais\', \'Maths\', \'Excel\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)','categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'categoryDescriptions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categoryDescriptions ?? []),'lessonGoals' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($lessonGoals ?? [])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <div class="freelancers-grid-premium" style="display: flex; flex-direction: column; gap: 20px;">
          ...
          <?php
            ...
            <?php endif; ?>
                            ...
                            <div class="video-placeholder-fallback" style="display: <?php echo e(($hasThumbnail && !empty($thumbnailUrl)) ? 'none' : 'flex'); ?>; flex-direction: column; align-items: center; justify-content: center; width: 100%; height: 100%; background: linear-gradient(135deg, #06B6D4 0%, #22D3EE 50%, #2563EB 100%); color: white; text-align: center; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 1;">
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\services\lessons.blade.php ENDPATH**/ ?>