                ...
                <div class="col-lg-12">
                  <div class="chat-wrapper-area">
                              ...
                              <div class="thumb">
                                <?php if(!is_null($msgInfo->user->image)): ?>
                                  <img src="<?php echo e(asset('assets/img/users/' . $msgInfo->user->image)); ?>" alt="user"
                                    title="User">
                                <?php else: ?>
                                  <img src="<?php echo e(asset('assets/img/blank-user.jpg')); ?>" alt="user" title="User">
                                <?php endif; ?>
                              </div>
                    ...
                    <div class="chat-bottom">
                      <form action="<?php echo e(route('seller.service_order.store_message', ['id' => $order->id])); ?>"
...
<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\order\message.blade.php ENDPATH**/ ?>