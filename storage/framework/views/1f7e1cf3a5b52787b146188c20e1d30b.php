...
<?php $__env->startSection('pageHeading'); ?>
  <?php echo e(__('Formules & Tarifs')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('metaDescription'); ?>
  <?php echo e(__("Découvrez les formules d'abonnement Junspro  de 1 à 22 Rituels par semaine. Transparent, flexible, sans engagement.")); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <section class="jp-pricing-hero">
    <div class="jp-pricing-hero__inner">
      ...
      <?php if(isset($selectedFreelancer) && $selectedFreelancer): ?>
        <div class="jp-pricing-hero__freelancer">
          <img src="<?php echo e($selectedFreelancer->user->profile_photo_path ? asset('storage/'.$selectedFreelancer->user->profile_photo_path) : asset('assets/img/noimage.jpg')); ?>"
               alt="<?php echo e($selectedFreelancer->user->name ?? ''); ?>" class="jp-pricing-hero__freelancer-img">
          <span><?php echo e($selectedFreelancer->user->name ?? 'Freelance sélectionné'); ?></span>
          <strong> <?php echo e(number_format($selectedFreelancer->hourly_rate ?? 0, 0, ',', ' ')); ?> €/h</strong>
        </div>
      <?php endif; ?>
    </div>
  ...
  <section class="jp-universe-section">
    <div class="jp-universe-section__inner">
      ...
      <div class="jp-plans-grid" id="universeA">
        <?php $__currentLoopData = $plansA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          ?>
          <div class="jp-plan-card <?php echo e($plan['popular'] ? 'jp-plan-card--popular' : ''); ?> <?php echo e($isCurrent ? 'jp-plan-card--current' : ''); ?>">
            <?php if($plan['popular']): ?><div class="jp-plan-card__popular-badge"> Le plus populaire</div><?php endif; ?>
            <?php if($isCurrent): ?><div class="jp-plan-card__current-badge"> Votre formule</div><?php endif; ?>
            <div class="jp-plan-card__header">
              <div class="jp-plan-card__icon-wrap"><i class="<?php echo e($plan['icon']); ?>"></i></div>
              <h3 class="jp-plan-card__name"><?php echo e($plan['name']); ?></h3>
              <p class="jp-plan-card__desc"><?php echo e($plan['description']); ?></p>
            </div>
            <div class="jp-plan-card__body">
              <div class="jp-plan-card__volume">
                <span class="jp-plan-card__volume-main"><?php echo e($plan['hours_per_cycle']); ?></span>
                <span class="jp-plan-card__volume-unit">Rituels<br><small>/cycle 4s</small></span>
              </div>
              <div class="jp-plan-card__rhythm"><?php echo e($plan['hours_per_week']); ?>h par semaine</div>
              <?php if($price !== null): ?>
                <div class="jp-plan-card__price">
                  <span class="jp-plan-card__price-amount"><?php echo e(number_format($price, 0, ',', ' ')); ?> €</span>
              ...
              <div class="jp-plan-card__topup">
                <div class="jp-plan-card__topup-row">
                  ...
                  <span class="jp-plan-card__topup-val">+<?php echo e($plan['topup_max']); ?> Rituels</span>
                </div>
                <div class="jp-plan-card__topup-row jp-plan-card__topup-row--total">
                  <span class="jp-plan-card__topup-label">Max cycle</span>
                  <span class="jp-plan-card__topup-val"><?php echo e($plan['cycle_max_total']); ?> Rituels</span>
                </div>
              </div>
            </div>
            <div class="jp-plan-card__footer">
              <?php if(isset($selectedFreelancer) && $selectedFreelancer): ?>
                <form method="POST" action="<?php echo e(route('pricing.subscribe')); ?>">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="freelancer_id" value="<?php echo e($selectedFreelancer->id); ?>">
                  <input type="hidden" name="weekly_hours" value="<?php echo e($plan['hours_per_week']); ?>">
                  <button type="submit" class="jp-plan-card__cta <?php echo e($plan['popular'] ? 'jp-plan-card__cta--primary' : ''); ?>">Choisir <?php echo e($plan['name']); ?></button>
                </form>
              <?php else: ?>
                <a href="<?php echo e(route('explore')); ?>" class="jp-plan-card__cta <?php echo e($plan['popular'] ? 'jp-plan-card__cta--primary' : ''); ?>">Choisir <?php echo e($plan['name']); ?></a>
              <?php endif; ?>
            </div>
          </div>
      ...
      <div class="jp-plans-grid" id="universeB" style="display:none;">
        <?php $__currentLoopData = $plansB; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
  ...
  <section class="jp-guarantees">
    <div class="jp-guarantees__inner">
      ...
      <div class="jp-guarantees__grid">
        <?php $__currentLoopData = $guarantees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="jp-guarantee-item">
            <div class="jp-guarantee-item__icon"><i class="<?php echo e($g['icon']); ?>"></i></div>
            <h4 class="jp-guarantee-item__title"><?php echo e($g['title']); ?></h4>
            <p class="jp-guarantee-item__desc"><?php echo e($g['description']); ?></p>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
  ...
  <section class="jp-cta-final">
    <div class="jp-cta-final__inner">
      ...
      <div class="jp-cta-final__btns">
        <a href="<?php echo e(route('explore')); ?>" class="jp-btn jp-btn--primary">Trouver un freelance</a>
        <?php if(auth()->guard()->check()): ?>
          <a href="<?php echo e(route('user.settings.subscription')); ?>" class="jp-btn jp-btn--ghost">Mon abonnement</a>
        <?php endif; ?>
      </div>
      <p class="jp-cta-final__signature"><?php echo e($ritualSignature); ?></p>
    </div>
  </section>
  ...
  (function() {
    document.addEventListener('DOMContentLoaded', function() {
      ...
      <?php if(isset($currentUniverse) && in_array($currentUniverse, ['projects','at-home'])): ?>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/frontend/pricing/index.blade.php ENDPATH**/ ?>