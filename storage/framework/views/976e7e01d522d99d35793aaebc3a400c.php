...
<?php if($variant === 'card'): ?>
  ...
  <div class="referral-cta-card">
    <div class="referral-cta-card-content">
      <h3 class="referral-cta-card-title"><?php echo e(__('Invitez un proche, recevez 10€')); ?></h3>
      <p class="referral-cta-card-text">
        <?php echo e(__('Ils profitent de 10€ offerts sur les frais de site sur leur première réservation éligible. Vous recevez 10€ de crédit Junspro après leur première prestation confirmée.')); ?>

      </p>
      <?php if($stats): ?>
        <div class="referral-cta-card-stats">
          <span><?php echo e(number_format($stats['earned_total'], 2, ',', ' ')); ?>€ obtenus</span>
          <span>•</span>
          <span><?php echo e($stats['pending_count']); ?> en attente</span>
        </div>
      <?php endif; ?>
    </div>
    <div class="referral-cta-card-actions">
      <?php if(request()->routeIs('referral.index')): ?>
        <button 
          type="button"
          class="referral-cta-btn"
          onclick="window.dispatchEvent(new CustomEvent('openInviteModal'))"
        >
          <?php echo e(__('Inviter')); ?>

        </button>
      <?php else: ?>
        <a href="<?php echo e(route('referral.index', ['openInvite' => 1])); ?>" class="referral-cta-btn">
          <?php echo e(__('Inviter')); ?>
...
<?php elseif($variant === 'inline'): ?>
  ...
  <div class="referral-cta-inline">
    <div class="referral-cta-inline-content">
      <strong class="referral-cta-inline-title"><?php echo e(__('Parrainage')); ?></strong>
      <span class="referral-cta-inline-text">
        <?php echo e(__('Invitez un proche : 10€ offerts pour lui, 10€ de crédit pour vous après sa première prestation confirmée.')); ?>
    ...
    <?php else: ?>
      <a href="<?php echo e(route('referral.index', ['openInvite' => 1])); ?>" class="referral-cta-inline-btn">
        <?php echo e(__('Inviter')); ?>
...
<?php elseif($variant === 'compact'): ?>
  ...
  <div class="referral-cta-compact">
    <a href="<?php echo e(route('referral.index')); ?>" class="referral-cta-compact-link">
      <?php echo e(__('Parrainage')); ?>

    </a>
  </div>

<?php elseif($variant === 'confirmation'): ?>
  
  <div class="referral-cta-confirmation">
    <h3 class="referral-cta-confirmation-title"><?php echo e(__('Invitez un proche et gagnez 10€')); ?></h3>
    <p class="referral-cta-confirmation-text">
      <?php echo e(__('Junspro, c\'est un cadre d\'exécution premium : sessions structurées, suivi, sécurité et discipline.')); ?>
    ...
    <div class="referral-cta-confirmation-actions">
      <?php if($referralCode): ?>
        <button 
          ...
          onclick="copyReferralLink('<?php echo e($referralLink); ?>')"
        >
          <?php echo e(__('Copier mon lien')); ?>
      ...
      <?php else: ?>
        <a href="<?php echo e(route('referral.index', ['openInvite' => 1])); ?>" class="referral-cta-btn-primary">
          <?php echo e(__('Inviter')); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\referral\referral-cta.blade.php ENDPATH**/ ?>