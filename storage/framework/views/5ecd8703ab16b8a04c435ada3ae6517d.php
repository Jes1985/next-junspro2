    ...
    <div class="transfer-modal-body transfer-payment-body">
      ...
      <div class="transfer-payment-methods" x-show="amountToPay > 0">
        ...
        <div class="transfer-payment-method-card">
          ...
          <div class="transfer-payment-method-info">
            <div class="transfer-payment-method-name"><?php echo e(__('Autres modes de paiement')); ?></div>
            <div class="transfer-payment-method-details"><?php echo e(__('Carte bancaire ou PayPal')); ?></div>
          </div>
        </div>
    ...
    <div class="transfer-modal-footer">
      ...
      >
        <span x-show="!processing">
          <span x-show="amountToPay === 0"><?php echo e(__('Confirmer')); ?></span>
          <span x-show="amountToPay > 0"><?php echo e(__('Payer')); ?> <span x-text="formatPrice(amountToPay)"></span></span>
        </span>
      ...
      async processPayment() {
        ...
        try {
          ...
          if (data.ok) {
            ...
            alert(data.message || '<?php echo e(__('Une erreur est survenue lors du paiement.')); ?>');
            this.processing = false;
          }
        } catch (error) {
          console.error('Erreur lors du paiement:', error);
          alert('<?php echo e(__('Une erreur est survenue lors du paiement.')); ?>');
          this.processing = false;
        }
      },
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\add\step6-payment.blade.php ENDPATH**/ ?>