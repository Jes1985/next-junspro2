    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create"
          action="<?php echo e(route('seller.service_management.service.store_package')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\package\create.blade.php ENDPATH**/ ?>