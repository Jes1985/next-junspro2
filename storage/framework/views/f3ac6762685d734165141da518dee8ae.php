<?php $__env->startSection('pageHeading'); ?>
  Projets | <?php echo e($websiteInfo->website_title); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.services.hero','data' => ['title' => 'Projets et Consulting','subtitle' => 'On avance vite. Et on fait ça bien.','micro' => 'Choisissez un rituel, exprimez votre besoin et avancez sereinement, en suivant chaque étape en toute simplicité.','cta' => ['text' => 'Trouver un freelance', 'url' => '#results', 'variant' => 'primary']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Projets et Consulting','subtitle' => 'On avance vite. Et on fait ça bien.','micro' => 'Choisissez un rituel, exprimez votre besoin et avancez sereinement, en suivant chaque étape en toute simplicité.','cta' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['text' => 'Trouver un freelance', 'url' => '#results', 'variant' => 'primary'])]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.home.search-filter','data' => ['formId' => 'preplyFiltersForm','formAction' => route('services.projects'),'universe' => 'projects','categories' => $categories,'domainSpecializations' => $domainSpecializations ?? [],'keywordPlaceholder' => 'Essayez \'SEO\', \'Développement web\', \'Design\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['formId' => 'preplyFiltersForm','formAction' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('services.projects')),'universe' => 'projects','categories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($categories),'domainSpecializations' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($domainSpecializations ?? []),'keywordPlaceholder' => 'Essayez \'SEO\', \'Développement web\', \'Design\'...','locationPlaceholder' => 'Lieu (ex: Paris, Lyon...)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
  ...
  <section id="results" class="preply-results-section" style="overflow: visible;">
    <div id="resultsContainer" class="preply-results-container" style="overflow: visible;">
      <div class="preply-results-header">
        <h2 class="preply-results-count"><?php echo e($freelancers->total() ?? 0); ?> freelances disponibles<span class="language-loader"><span class="language-loader-spinner"></span></span></h2>
        ...
        <div class="freelancers-grid-premium" style="display: flex; flex-direction: column; gap: 20px;">
          <?php if($freelancers->isEmpty()): ?>
            <div style="text-align: center; padding: 60px 20px; max-width: 600px; margin: 0 auto;">
              <?php if(isset($hasNoResults) && $hasNoResults): ?>
                <div style="margin-bottom: 2rem;">
                  ...
                  <a href="<?php echo e(route('referral.index')); ?>" class="btn-ambassador" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.875rem 2rem; font-size: 1.125rem; font-weight: 600; color: #ffffff; background: linear-gradient(135deg, #7c3aed 0%, #a78bfa 50%, #2563eb 100%); border-radius: 50px; text-decoration: none; box-shadow: 0 4px 12px rgba(124, 58, 237, 0.3); transition: all 0.3s ease;">
                ...
                <div class="freelancer-card-wrapper-premium" data-freelancer-id="<?php echo e($freelancer->id); ?>">
                  ...
                  <?php endif; ?>
                          ...
                          <div class="freelancer-job-line" style="white-space: nowrap;">
                            🗣️ Le freelance parle <?php echo e($langDisplay); ?>
                          ...
                          <div class="freelancer-popularity-v2">
                            ...
                            <span style="white-space: nowrap;"><?php echo e(__('Très populaire')); ?>. <?php echo e(rand(10, 50)); ?> <?php echo e(__('réservations récentes')); ?></span>
                          </div>
                      ...
                      <div class="freelancer-pricing-section">
                        ...
                        <div class="freelancer-rating-v2">
                          ...
                          <div class="rating-count"><?php echo e(rand(10, 100)); ?> <?php echo e(__('avis')); ?></div>
                        </div>
                        ...
                        <div class="freelancer-stats-v2">
                          <div class="stat-item-v2">
                            ...
                            <span class="stat-label-v2"><?php echo e(__('projets livrés')); ?></span>
                          </div>
                          <div class="stat-item-v2">
                            <span class="stat-number"><?php echo e($freelancer->subscriptions()->where('status', 'active')->count() ?? 0); ?></span>
                            <span class="stat-label-v2"><?php echo e(__('clients récurrents')); ?></span>
                          </div>
                        </div>
                      ...
                      <div class="quick-view-content-v2">
                        ...
                        <div class="quick-view-video-section">
                          <div class="video-thumbnail-wrapper">
                            ...
                            <button class="video-play-btn-v2" data-freelancer-id="<?php echo e($freelancer->id); ?>" data-video-url="<?php echo e($videoUrl ?? ''); ?>" aria-label="<?php echo e(__('Lire la vidéo de présentation')); ?>" style="z-index: 10;">
                        ...
                        <div class="quick-view-actions-v2">
                          ...
                          <a href="<?php echo e(route('freelance.show', $freelancer->id)); ?>#agenda" 
                            ...
                            <?php echo e(__('Voir tout l\'agenda')); ?>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\services\projects.blade.php ENDPATH**/ ?>