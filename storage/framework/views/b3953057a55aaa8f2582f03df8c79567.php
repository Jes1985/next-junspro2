...
<?php if(!empty($categories) && !($hideDomainSpec ?? false)): ?>
  <?php
  ...
  <div class="preply-filter-group">
    ...
    <div class="domain-dropdown-wrapper">
      ...
      <div class="domain-dropdown-menu domain-dropdown-menu-v1" id="domainDropdownMenu" style="display: none;">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $domainDesc = $cat['description'] ?? ($domainLongDescriptions[$cat['slug'] ?? ''] ?? ''); ?>
          <div class="domain-option" data-value="<?php echo e($cat['slug'] ?? ''); ?>">
            <span class="domain-option-label"><?php echo e($cat['label'] ?? ''); ?></span>
            <?php if(!empty($domainDesc)): ?>
              <span class="domain-option-desc"><?php echo e($domainDesc); ?></span>
            <?php endif; ?>
          </div>
    ...
    <div id="domainPremiumDesc" class="domain-premium-desc" style="display: none;" aria-live="polite" data-domain-descriptions='<?php echo json_encode($domainLongDescriptions, 15, 512) ?>'>
...
<?php if(($config['showSpecialization'] ?? false) && !($hideDomainSpec ?? false)): ?>
  <?php
  ...
  ?>
  <div class="preply-filter-advanced" id="specializationFilterWrapper" data-initial-specialization="<?php echo e(request('specialization') ?? ''); ?>" data-domain-specializations='<?php echo json_encode($domainSpecializations, 15, 512) ?>' style="display: none;">
  ...
  <script>
    window.__domainSpecializations = <?php echo json_encode($domainSpecializations, 15, 512) ?>;
  </script>
<?php endif; ?>

<?php if(($config['showSector'] ?? false) && in_array($universe ?? '', ['projects', 'lessons', 'at-home', 'wellnesslive'])): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/components/services/filters/partials/level-2-filters.blade.php ENDPATH**/ ?>