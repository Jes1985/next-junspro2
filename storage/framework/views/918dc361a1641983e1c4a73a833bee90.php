  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm2" class="modal-form" action="<?php echo e(route('admin.payment_gateways.update_offline_gateway')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <textarea id="in_instructions" class="form-control summernote2" name="instructions" rows="3" cols="80" placeholder="Enter Gateway Instructions" data-height="150"></textarea>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\payment-gateways\offline-gateways\edit.blade.php ENDPATH**/ ?>