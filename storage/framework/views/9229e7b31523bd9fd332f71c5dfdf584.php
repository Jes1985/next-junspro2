<div class="modal fade" id="<?php echo e('emailModal-' . $order->id); ?>" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <form class="modal-form" action="<?php echo e(route('seller.service_order.sendmail', ['id' => $order->id])); ?>"
        method="POST">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\order\send-mail.blade.php ENDPATH**/ ?>