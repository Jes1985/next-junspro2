        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          ...
          <div class="premium-card">
            ...
            <div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-top: 1rem;">
              <a href="<?php echo e(route('freelance.settings.identity')); ?>" class="btn-premium btn-premium-primary">Modifier mon profil</a>
              <a href="<?php echo e(route('freelance.show', ['id' => $freelancerProfile->id ?? 0])); ?>" target="_blank" class="btn-premium btn-premium-secondary">Voir mon profil public</a>
            </div>
          ...
          <div class="premium-card">
            ...
            <a href="<?php echo e(route('freelance.dashboard', ['tab' => 'rituals'])); ?>" class="empty-state-premium-cta" style="margin-top: 1rem;">Découvrir les Rituels</a>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\dashboard\tabs\profile.blade.php ENDPATH**/ ?>