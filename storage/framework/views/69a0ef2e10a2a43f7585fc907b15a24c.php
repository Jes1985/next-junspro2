...
<?php $__env->startSection('metaKeywords'); ?>
  <?php if(!empty($seoInfo)): ?>
    <?php echo e($seoInfo->meta_keyword_customer_forget_password); ?>
...
<?php $__env->startSection('metaDescription'); ?>
  <?php if(!empty($seoInfo)): ?>
    <?php echo e($seoInfo->meta_description_customer_forget_password); ?>
...
<div class="page-forget-password">
  ...
  <section class="page-forget-password__hero" aria-labelledby="forget-title">
    <div class="page-forget-password__hero-inner">
      <h1 id="forget-title" class="page-forget-password__title"><?php echo e($title); ?></h1>
      <nav class="page-forget-password__breadcrumb" aria-label="<?php echo e(__('Breadcrumb')); ?>">
        <a href="<?php echo e(route('index')); ?>"><?php echo e(__('Home')); ?></a>
    ...
    <div class="page-forget-password__card">
      ...
      <form action="<?php echo e(route('user.send_forget_password_mail')); ?>" method="POST">
        ...
        <div class="form-group">
          <label for="forget-email"><?php echo e(__('Email Address')); ?> *</label>
          <input
            type="email"
            id="forget-email"
            class="form-control <?php echo e($errors->has('email_address') ? 'has-error' : ''); ?>"
            name="email_address"
            value="<?php echo e(old('email_address')); ?>"
            placeholder="ex: vous@exemple.com"
            autocomplete="email"
            aria-invalid="<?php echo e($errors->has('email_address') ? 'true' : 'false'); ?>"
            aria-describedby="<?php echo e($errors->has('email_address') ? 'forget-email-error' : ''); ?>"
          >
...
$message = $__bag->first($__errorArgs[0]); ?>
            <p id="forget-email-error" class="text-danger" role="alert"><?php echo e($message); ?></p>
          <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="page-forget-password__links">
        <a href="<?php echo e(route('user.login')); ?>">Retour à la connexion</a>
        <a href="<?php echo e(route('user.signup')); ?>">Créer un compte</a>
        <a href="<?php echo e(route('contact')); ?>">Besoin d'aide ? Nous contacter</a>
      </div>
    </div>
  </section>
</div>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views/frontend/forget-password.blade.php ENDPATH**/ ?>