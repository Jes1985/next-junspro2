  ...
  <div class="homeswap-dropdown" data-homeswap-dropdown>
    ...
    <div class="homeswap-dropdown-panel" data-homeswap-panel aria-hidden="true">
      <div class="homeswap-section">
        ...
        <input type="text" name="date_text" class="homeswap-input" placeholder="Dates (texte libre) – ex : Juillet 2026, flexible" value="<?php echo e($dateText); ?>">
        <div class="homeswap-checkbox-row">
          <label class="homeswap-checkbox">
            <input type="checkbox" name="date_flexible" value="1" <?php echo e($dateFlexible ? 'checked' : ''); ?>>
            <span>Dates flexibles</span>
          </label>
          <label class="homeswap-checkbox">
            <input type="checkbox" name="date_fixed" value="1" <?php echo e($dateFixed ? 'checked' : ''); ?>>
        ...
        <div class="homeswap-grid">
          <div>
            ...
            <div class="homeswap-checkbox-grid">
              <?php $__currentLoopData = $tripPurposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="homeswap-checkbox">
                  <input type="checkbox" name="trip_purpose[]" value="<?php echo e($value); ?>" <?php echo e(in_array($value, $selectedTrip, true) ? 'checked' : ''); ?> <?php if($value === 'autre'): ?> data-trip-purpose-autre <?php endif; ?>>
                  <span><?php echo e($label); ?></span>
                </label>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <input type="text" name="trip_purpose_other" data-trip-purpose-other class="homeswap-input" placeholder="Précisez votre objectif" value="<?php echo e($tripOther); ?>" style="display: <?php echo e(in_array('autre', $selectedTrip, true) ? 'block' : 'none'); ?>; margin-top: 8px;">
          </div>
          <div>
            <div class="homeswap-subtitle">Type d'échange</div>
            <div class="homeswap-checkbox-grid">
              <?php $__currentLoopData = $exchangeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="homeswap-checkbox">
                  <input type="checkbox" name="exchange_type[]" value="<?php echo e($value); ?>" <?php echo e(in_array($value, $selectedExchange, true) ? 'checked' : ''); ?>>
                  <span><?php echo e($label); ?></span>
                </label>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="homeswap-grid">
          <div>
            ...
            <select name="accommodation_type" class="homeswap-select">
              ...
              <?php $__currentLoopData = $accommodationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($value); ?>" <?php echo e($selectedAccommodation === $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div>
            ...
            <select name="bedrooms" class="homeswap-select">
              ...
              <option value="1" <?php echo e($selectedBedrooms === '1' ? 'selected' : ''); ?>>1</option>
              <option value="2" <?php echo e($selectedBedrooms === '2' ? 'selected' : ''); ?>>2</option>
              <option value="3" <?php echo e($selectedBedrooms === '3' ? 'selected' : ''); ?>>3</option>
              <option value="4" <?php echo e($selectedBedrooms === '4' ? 'selected' : ''); ?>>4+</option>
            </select>
          </div>
          <div>
            ...
            <select name="bathrooms" class="homeswap-select">
              <option value="">Toutes</option>
              <option value="1" <?php echo e($selectedBathrooms === '1' ? 'selected' : ''); ?>>1</option>
              <option value="2" <?php echo e($selectedBathrooms === '2' ? 'selected' : ''); ?>>2</option>
              <option value="3" <?php echo e($selectedBathrooms === '3' ? 'selected' : ''); ?>>3+</option>
            </select>
          </div>
          <div>
            ...
            <select name="adults" class="homeswap-select">
              ...
              <option value="1" <?php echo e($selectedAdults === '1' ? 'selected' : ''); ?>>1</option>
              <option value="2" <?php echo e($selectedAdults === '2' ? 'selected' : ''); ?>>2</option>
              <option value="3" <?php echo e($selectedAdults === '3' ? 'selected' : ''); ?>>3+</option>
            </select>
          </div>
          <div>
            ...
            <select name="children" class="homeswap-select">
              <option value="">Tous</option>
              <option value="0" <?php echo e($selectedChildren === '0' ? 'selected' : ''); ?>>0</option>
              <option value="1" <?php echo e($selectedChildren === '1' ? 'selected' : ''); ?>>1</option>
              <option value="2" <?php echo e($selectedChildren === '2' ? 'selected' : ''); ?>>2+</option>
            </select>
          </div>
          <div>
            ...
            <select name="capacity" class="homeswap-select">
              <option value="">Toutes</option>
              <option value="1-2" <?php echo e($selectedCapacity === '1-2' ? 'selected' : ''); ?>>1-2</option>
              <option value="3-4" <?php echo e($selectedCapacity === '3-4' ? 'selected' : ''); ?>>3-4</option>
              <option value="5-6" <?php echo e($selectedCapacity === '5-6' ? 'selected' : ''); ?>>5-6</option>
              <option value="7+" <?php echo e($selectedCapacity === '7+' ? 'selected' : ''); ?>>7+</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="homeswap-section">
        ...
        <div class="homeswap-grid">
          <div>
            ...
            <div class="homeswap-checkbox-grid">
              <?php $__currentLoopData = $equipmentList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="homeswap-checkbox">
                  <input type="checkbox" name="equipment[]" value="<?php echo e($value); ?>" <?php echo e(in_array($value, $selectedEquipment, true) ? 'checked' : ''); ?>>
                  <span><?php echo e($label); ?></span>
                </label>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          ...
          <div>
            ...
            <div class="homeswap-checkbox-grid">
              <?php $__currentLoopData = $exteriorList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="homeswap-checkbox">
                  <input type="checkbox" name="exterior[]" value="<?php echo e($value); ?>" <?php echo e(in_array($value, $selectedExterior, true) ? 'checked' : ''); ?>>
                  <span><?php echo e($label); ?></span>
                </label>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          ...
          <div>
            ...
            <div class="homeswap-checkbox-grid">
              <?php $__currentLoopData = $rulesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$value, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="homeswap-checkbox">
                  <input type="checkbox" name="rules[]" value="<?php echo e($value); ?>" <?php echo e(in_array($value, $selectedRules, true) ? 'checked' : ''); ?>>
                  <span><?php echo e($label); ?></span>
                </label>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\onboarding\partials\matching\homeswap.blade.php ENDPATH**/ ?>