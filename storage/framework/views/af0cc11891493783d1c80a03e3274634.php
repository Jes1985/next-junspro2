...
<script>
  ...
  ?>
  <?php if($hasVideo): ?>
    window.videoUrl = <?php echo json_encode($videoUrlValue, 15, 512) ?>;
    console.log('✅ Video URL définie:', window.videoUrl);
  <?php else: ?>
    window.videoUrl = null;
    console.warn('⚠️ Aucune vidéo URL trouvée. Freelancer ID:', <?php echo json_encode(isset($freelancer) ? $freelancer->id : 'non défini', 15, 512) ?>, 'video_url:', <?php echo json_encode(isset($freelancer) && $freelancer ? $freelancer->video_url : 'non défini', 15, 512) ?>);
  <?php endif; ?>
  ...
  window.openVideoModal = function(videoUrl) {
    try {
      if (!videoUrl) {
        ...
        alert('<?php echo e(__("Aucune vidéo disponible pour le moment")); ?>');
        return;
      }
      ...
      alert('<?php echo e(__("Erreur lors du chargement de la vidéo")); ?>');
    }
  };
  ...
  window.handleScheduleClick = function() {
    try {
      ...
      if (confirm(`<?php echo e(__('Confirmer la programmation de')); ?> ${window.selectedSlots.length} ${rituelText} ?\n\n${slotsText}`)) {
        ...
        alert('<?php echo e(__("Programmation en cours... Cette fonctionnalité sera bientôt disponible.")); ?>');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    <?php if(isset($freelancer) && isset($freelancer->hourly_rate)): ?>
      const hourlyRate = <?php echo e($freelancer->hourly_rate); ?>;
    <?php else: ?>
      const hourlyRate = 0;
    <?php endif; ?>
  ...
  // Gestion du lien "Voir le texte original" (si traduction active)
    ...
    window.agendaTextShow = <?php echo json_encode(__("Voir le planning complet"), 15, 512) ?>;
    window.agendaTextHide = <?php echo json_encode(__("Masquer le planning"), 15, 512) ?>;
    ...
    if (saveToListBtn) {
      saveToListBtn.addEventListener('click', function() {
        const isAuthenticated = <?php echo e(Auth::guard('web')->check() ? 'true' : 'false'); ?>;
        if (isAuthenticated) {
          // Ici, ajouter la logique pour sauvegarder dans la liste
          alert('<?php echo e(__("Fonctionnalité à implémenter")); ?>');
        } else {
    ...
    if (contactForm) {
      contactForm.addEventListener('submit', function(e) {
        ...
        if (isAuthenticated) {
          ...
          alert(<?php echo json_encode(__("Fonctionnalité d'envoi de message à implémenter"), 15, 512) ?>);
    ...
    const aboutTogglePremium = document.getElementById('about-toggle-premium');
        ...
        // Textes traduits
        const textShowMore = <?php echo json_encode(__("Voir plus"), 15, 512) ?>;
        const textShowLess = <?php echo json_encode(__("Voir moins"), 15, 512) ?>;
    ...
    if (toggleTranslation) {
      ...
      toggleTranslation.addEventListener('click', function() {
        ...
        this.textContent = showingOriginal ? '<?php echo e(__("Voir la traduction")); ?>' : '<?php echo e(__("Voir le texte original")); ?>';
      ...
      <div>
        ...
        <script>
          (function() {
            ...
            <?php if($hasVideo): ?>
              window.videoUrl = <?php echo json_encode($currentVideoUrl, 15, 512) ?>;
        ...
        <div class="freelance-video-container" id="video-container">
            <?php if(file_exists(public_path('assets/img/video-placeholder.jpg'))): ?>
          ...
          <div class="freelance-video-label" style="pointer-events: none;"><?php echo e(__('Vidéo de présentation')); ?></div>
        </div>
        ...
        <div class="freelance-profile-premium-block" style="background: white; border-radius: 24px; padding: 48px; margin-top: 48px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06);">
          ...
          <div class="freelance-profile-header" style="display: flex; align-items: flex-start; gap: 32px; margin-bottom: 40px; padding-bottom: 40px; border-bottom: 1px solid #E5E7EB;">
            ...
            <div style="flex-grow: 1; min-width: 0;">
              ...
              <h1 style="font-size: 32px; font-weight: 700; color: #111827; margin: 0 0 12px 0; line-height: 1.2; letter-spacing: -0.02em;">
                <?php echo e($displayName ?: __('Freelance')); ?>
              ...
              <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px; flex-wrap: wrap;">
                ...
                <span style="font-size: 16px; color: #6B7280;">
                  <?php echo e($user->country ?? 'France'); ?>
                ...
                ?>
                <span style="font-size: 18px; line-height: 1;"><?php echo e($flag); ?></span>
              </div>
          ...
          <div class="freelance-about-section" style="margin-bottom: 40px; padding-bottom: 40px; border-bottom: 1px solid #E5E7EB;">
            ...
            <div style="display: flex; align-items: center; gap: 6px; margin-bottom: 20px;">
              ...
              <span style="font-size: 13px; color: #6B7280;"><?php echo e(__('Traduction')); ?></span>
              ...
              <button type="button" id="toggle-translation" class="translation-link" style="background: none; border: none; color: #4F46E5; font-size: 13px; text-decoration: none; cursor: pointer; padding: 0; transition: text-decoration 0.2s;">
                <?php echo e(__('Voir le texte original')); ?>
            ...
            <div id="about-text-container-premium">
              <?php if($freelancer->bio && strlen($freelancer->bio) > 0): ?>
                <p id="about-text-premium" style="font-size: 16px; line-height: 1.8; color: #374151; margin-bottom: 0; max-height: 7.2em; overflow: hidden; transition: max-height 0.4s ease;">
                    <?php echo nl2br(e($freelancer->bio)); ?>
                ...
                <script>
                  ...
                  (function() {
                    ...
                    var textShowMore = <?php echo json_encode(__("Voir plus"), 15, 512) ?>;
                    var textShowLess = <?php echo json_encode(__("Voir moins"), 15, 512) ?>;
              ...
              <?php else: ?>
                <p style="font-size: 16px; line-height: 1.8; color: #6B7280; margin-bottom: 0;">
                  <?php echo e(__('Aucune présentation disponible pour le moment.')); ?>
          ...
          <div class="freelance-languages-section">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
              ...
              <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <span class="language-badge" style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; border-radius: 20px; font-size: 14px; font-weight: 500; background: <?php echo e($isNative ? '#ECFDF5' : '#EEF2FF'); ?>; color: <?php echo e($isNative ? '#065F46' : '#3730A3'); ?>; border: 1px solid <?php echo e($isNative ? '#A7F3D0' : '#C7D2FE'); ?>;">
                  <span><?php echo e($langName); ?></span>
                  <?php if($langLevel): ?>
                    <span style="opacity: 0.8;">[<?php echo e($langLevel); ?>]</span>
                              <?php endif; ?>
                          </span>
        ...
        <div class="freelance-booking-card">
          ...
          <div class="profile-rating-price-row">
            <div>
              <div class="profile-rating-block">
                <div class="profile-rating-number"><?php echo e(number_format($averageRating ?? 4.5, 1)); ?></div>
                <div class="profile-rating-star"><i class="fas fa-star"></i></div>
            </div>
              <div class="profile-reviews-count"><?php echo e($reviewsCount ?? 0); ?> <?php echo e(__('avis')); ?></div>
            </div>
            <div class="profile-price-block">
              <div class="profile-price-main"><?php echo e(number_format($freelancer->hourly_rate, 0)); ?> €</div>
              <div class="profile-price-unit"><?php echo e(__('par heure')); ?></div>
            </div>
          </div>
          ...
          <div class="profile-stats-grid">
            <div class="profile-stat-card">
              <div class="profile-stat-label"><?php echo e(__('Projets livrés')); ?></div>
              <div class="profile-stat-value"><?php echo e($subscriptionsCount ?? 0); ?></div>
            </div>
            <div class="profile-stat-card">
              <div class="profile-stat-label"><?php echo e(__('Clients récurrents')); ?></div>
              <div class="profile-stat-value"><?php echo e($activeSubscriptionsCount ?? 0); ?></div>
            </div>
          </div>

          <!-- Dernière connexion -->
          <div class="profile-last-seen">
            <div class="profile-stat-label"><?php echo e(__('Dernière connexion')); ?></div>
            <div class="profile-stat-value" style="font-size: 15px;"><?php echo e(isset($freelancer->last_seen_at) ? $freelancer->last_seen_at->diffForHumans() : __('Il y a 1h')); ?></div>
          </div>
          ...
          <div class="profile-last-seen" style="border-top: 1px solid #E5E7EB; padding-top: 16px;">
            <div class="profile-stat-label"><?php echo e(__('Contact')); ?></div>
            <?php if($canViewContactInfo ?? false): ?>
              <div class="profile-stat-value" style="font-size: 14px;">
                <?php if($user->email_address ?? null): ?>
                  <a href="mailto:<?php echo e($user->email_address); ?>" style="color: var(--junspro-primary); text-decoration: none;"><i class="fas fa-envelope me-1"></i><?php echo e($user->email_address); ?></a>
                <?php endif; ?>
                <?php if(($user->phone_number ?? null) && ($user->email_address ?? null)): ?><br><?php endif; ?>
                <?php if($user->phone_number ?? null): ?>
                  <a href="tel:<?php echo e($user->phone_number); ?>" style="color: var(--junspro-primary); text-decoration: none;"><i class="fas fa-phone me-1"></i><?php echo e($user->phone_number); ?></a>
                <?php endif; ?>
                <?php if(!($user->email_address ?? null) && !($user->phone_number ?? null)): ?>
                  <span style="color: #6B7280;">—</span>
                <?php endif; ?>
              </div>
            <?php else: ?>
              <p class="mb-0" style="font-size: 13px; color: #6B7280;">
                <i class="fas fa-lock me-1"></i><?php echo e(__('Débloqué après réservation confirmée')); ?>
          ...
          <div class="d-grid gap-2 mb-3">
            <?php if(auth()->guard('web')->check()): ?>
              <a href="<?php echo e(route('freelance.booking', $freelancer->id)); ?>" class="profile-cta-primary" style="text-decoration: none; text-align: center; display: flex; align-items: center; justify-content: center;">
                <i class="fas fa-bolt me-2"></i><?php echo e(__('Réserver un Rituel d\'essai')); ?>

              </a>
            <?php else: ?>
              <a href="<?php echo e(route('user.login')); ?>" class="profile-cta-primary" style="text-decoration: none; text-align: center; display: flex; align-items: center; justify-content: center;">
                <i class="fas fa-bolt me-2"></i><?php echo e(__('Réserver un Rituel d\'essai')); ?>

              </a>
            <?php endif; ?>
            <p style="font-size: clamp(0.75rem, 2.5vw, 0.8125rem); color: #9CA3AF; margin: 4px 0 0 0; text-align: center;"><?php echo e(__('Paiement sécurisé')); ?> • <?php echo e(__('Annulation simplifiée')); ?> • <?php echo e(__('Facture')); ?> • <?php echo e(__('Support')); ?></p>
              </div>

          <!-- Boutons secondaires -->
          <div class="d-grid gap-2 mb-3">
            <button type="button" class="profile-cta-secondary" data-bs-toggle="modal" data-bs-target="#contactModal">
              <i class="fas fa-envelope me-2"></i><?php echo e(__('Envoyer un message')); ?>

                  </button>
            <button type="button" class="profile-cta-link" id="save-to-list-btn">
              <i class="fas fa-heart me-2"></i><?php echo e(__('Sauvegarder dans ma liste')); ?>
          ...
          <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.08) 0%, rgba(5, 150, 105, 0.08) 100%); border: 1px solid rgba(16, 185, 129, 0.2); border-radius: 12px; padding: 20px; margin-top: 24px;">
            <p style="font-size: 14px; line-height: 1.6; color: #111827; margin-bottom: 12px;">
              <?php echo e(__('Pas sûr que ce freelance soit le bon ?')); ?> <?php echo e(__('Junspro peut vous proposer des profils similaires.')); ?>

            </p>
            <a href="<?php echo e(route('explore')); ?>" style="color: #4F46E5; font-size: 14px; font-weight: 600; text-decoration: none;">
              <?php echo e(__('Explorer d\'autres freelances')); ?> <i class="fas fa-arrow-right ms-1"></i>
            </a>
          </div>
              </div>
            </div>
    ...
    <div class="freelance-content-column">
      ...
      <div class="freelance-content-section">
        <h2 class="freelance-section-title">
          ...
          <?php echo e(__('Résumé de la mission idéale avec')); ?> <?php echo e(explode(' ', $user->name)[0] ?? $user->name); ?>
        ...
        <div class="mb-4 pb-4" style="border-bottom: 1px solid #E5E7EB;">
          <div class="d-flex align-items-start gap-3 mb-3">
            <i class="fas fa-thumbs-up" style="color: var(--junspro-primary); font-size: 20px; margin-top: 4px;"></i>
              ...
              <h3 style="font-size: 18px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Points forts')); ?></h3>
              <p style="font-size: 16px; line-height: 1.8; color: #4B5563; margin-bottom: 8px;">
                      <?php echo e($user->name); ?> <?php echo e(__('a')); ?> <?php echo e(rand(2, 5)); ?> <?php echo e(__('ans d\'expérience et une note de')); ?> <?php echo e(number_format($averageRating ?? 4.5, 1)); ?> <?php echo e(__('sur')); ?> <?php echo e($reviewsCount ?? 0); ?> <?php echo e(__('avis, ce qui indique ses méthodes de travail efficaces et son bon rapport avec les clients.')); ?>

                    </p>
              <small style="font-size: 13px; color: #9CA3AF; font-style: italic;">
                <i class="fas fa-sparkles me-1"></i><?php echo e(__('Résumé généré par l\'IA à partir des données du profil')); ?>
        ...
        <div class="mb-4 pb-4" style="border-bottom: 1px solid #E5E7EB;">
          <div class="d-flex align-items-start gap-3 mb-3">
            <i class="fas fa-graduation-cap" style="color: var(--junspro-primary); font-size: 20px; margin-top: 4px;"></i>
                  <div class="flex-grow-1">
              <h3 style="font-size: 18px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Style de travail')); ?></h3>
              <p style="font-size: 16px; line-height: 1.8; color: #4B5563; margin-bottom: 8px;">
          ...
          <div class="d-flex align-items-start gap-3 mb-3">
            <i class="fas fa-check-circle" style="color: #10B981; font-size: 20px; margin-top: 4px;"></i>
                  <div class="flex-grow-1">
              <h3 style="font-size: 18px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Freelance qualifié')); ?></h3>
              ...
              <a href="#certifications" style="color: var(--junspro-primary); font-size: 14px; font-weight: 600; text-decoration: none;">
                      <?php echo e(__('En savoir plus')); ?> <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                  </div>
                </div>
              </div>
      ...
      <div class="freelance-content-section">
        <h2 class="freelance-section-title">
          ...
          <?php echo e(__('Séance d\'essai & abonnement Junspro')); ?>

        </h2>
        
        <!-- Séance d'essai -->
        <div class="mb-4 pb-4" style="border-bottom: 1px solid #E5E7EB;">
          <h3 style="font-size: 18px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Séance d\'essai (1h)')); ?></h3>
          <p style="font-size: 15px; line-height: 1.7; color: #6B7280; margin-bottom: 20px;">
            <?php echo e(__('50 minutes de travail concentré + 10 minutes de rapport pédagogique : ce qui a été fait, pourquoi, et les prochaines étapes pour votre projet.')); ?>

          </p>
          <?php if(auth()->guard('web')->check()): ?>
            <a href="<?php echo e(route('freelance.booking', $freelancer->id)); ?>" class="btn w-100" style="background: var(--junspro-gradient); color: white; border-radius: 12px; padding: 14px 24px; font-weight: 600; text-decoration: none; display: block; text-align: center; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.3);">
              <i class="fas fa-play-circle me-2"></i><?php echo e(__('Réserver une séance d\'essai')); ?>

            </a>
          <?php else: ?>
            <a href="<?php echo e(route('user.login')); ?>" class="btn w-100" style="background: var(--junspro-gradient); color: white; border-radius: 12px; padding: 14px 24px; font-weight: 600; text-decoration: none; display: block; text-align: center; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.3);">
              <i class="fas fa-sign-in-alt me-2"></i><?php echo e(__('Se connecter pour réserver')); ?>

            </a>
          <?php endif; ?>
          <p class="text-center mt-3 mb-0" style="font-size: 14px; color: #6B7280;">
            <?php echo e(number_format($freelancer->hourly_rate, 2, ',', ' ')); ?> €
          </p>
          </div>

        <!-- Passer à l'abonnement -->
        <div>
          <h3 style="font-size: 18px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Passer à l\'abonnement')); ?></h3>
          <p style="font-size: 15px; line-height: 1.7; color: #6B7280; margin-bottom: 20px;">
            <?php echo e(__('Choisissez votre formule hebdomadaire pour un accompagnement régulier.')); ?>
          ...
          <?php if(auth()->guard('web')->check()): ?>
            <a href="#subscription" class="btn w-100" style="background: white; border: 2px solid var(--junspro-primary); color: var(--junspro-primary); border-radius: 12px; padding: 14px 24px; font-weight: 600; text-decoration: none; display: block; text-align: center;">
              <i class="fas fa-arrow-right me-2"></i><?php echo e(__('Voir les formules')); ?>

            </a>
          <?php else: ?>
            <a href="<?php echo e(route('user.login')); ?>" class="btn w-100" style="background: white; border: 2px solid var(--junspro-primary); color: var(--junspro-primary); border-radius: 12px; padding: 14px 24px; font-weight: 600; text-decoration: none; display: block; text-align: center;">
              <i class="fas fa-sign-in-alt me-2"></i><?php echo e(__('Se connecter pour s\'abonner')); ?>
      ...
      <!-- Section 4 : Outils & secteurs -->
        ...
        <div class="freelance-content-section">
          <h2 class="freelance-section-title">
            ...
            <?php echo e(__('Outils & secteurs')); ?>

          </h2>
                <div class="row g-3">
                      <div class="col-md-6">
              <h3 style="font-size: 16px; font-weight: 600; color: #111827; margin-bottom: 16px;"><?php echo e(__('Outils & technologies')); ?></h3>
                <div class="d-flex flex-wrap gap-2">
                  ...
                  <span class="badge" style="background: #F3F4F6; color: #374151; border: 1px solid #E5E7EB; padding: 8px 16px; font-size: 14px; border-radius: 8px; font-weight: 500;"><?php echo e($skill); ?></span>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
            <div class="col-md-6">
              <h3 style="font-size: 16px; font-weight: 600; color: #111827; margin-bottom: 16px;"><?php echo e(__('Secteurs clients')); ?></h3>
                <div class="d-flex flex-wrap gap-2">
                <?php
                  $sectors = ['Infopreneurs', 'Coachs', 'E-commerce', 'Associations', 'Startups'];
                ?>
                <?php $__currentLoopData = $sectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <span class="badge" style="background: #F3F4F6; color: #374151; border: 1px solid #E5E7EB; padding: 8px 16px; font-size: 14px; border-radius: 8px; font-weight: 500;"><?php echo e($sector); ?></span>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
                </div>
              </div>
      ...
      <div class="freelance-content-section">
        <h2 class="freelance-section-title">
          ...
          <?php echo e(__('Qualité des prestations')); ?>

        </h2>
        <div style="text-align: center; margin-bottom: 32px;">
          <div style="font-size: 48px; font-weight: 700; color: var(--junspro-primary); margin-bottom: 8px;"><?php echo e(number_format($averageRating ?? 4.5, 1)); ?> / 5.0</div>
        ...
        <div class="row g-3">
            ...
            <div style="text-align: center; padding: 24px; background: #F8FAFC; border-radius: 16px; border: 1px solid #E5E7EB;">
              ...
              <div style="font-size: 14px; color: #6B7280; font-weight: 500;"><?php echo e(__('Soutien')); ?></div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
            <div style="text-align: center; padding: 24px; background: #F8FAFC; border-radius: 16px; border: 1px solid #E5E7EB;">
              ...
              <div style="font-size: 14px; color: #6B7280; font-weight: 500;"><?php echo e(__('Clarté')); ?></div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
            <div style="text-align: center; padding: 24px; background: #F8FAFC; border-radius: 16px; border: 1px solid #E5E7EB;">
              ...
              <div style="font-size: 14px; color: #6B7280; font-weight: 500;"><?php echo e(__('Progrès')); ?></div>
                  </div>
                </div>
                <div class="col-6 col-md-3">
            <div style="text-align: center; padding: 24px; background: #F8FAFC; border-radius: 16px; border: 1px solid #E5E7EB;">
              ...
              <div style="font-size: 32px; font-weight: 700; color: #111827; margin-bottom: 8px;">5.0</div>
              <div style="font-size: 14px; color: #6B7280; font-weight: 500;"><?php echo e(__('Préparation')); ?></div>
                  </div>
                </div>
              </div>
        <p class="text-center mt-4 mb-0" style="font-size: 14px; color: #6B7280;">
                <?php echo e(__('D\'après')); ?> <?php echo e($reviewsCount ?? 0); ?> <?php echo e(__('avis de clients anonymes')); ?>
      ...
      <div class="freelance-content-section">
        <h2 class="freelance-section-title">
          ...
          <?php echo e(__('Projets récents livrés')); ?>

        </h2>
        <?php if(isset($recentProjects) && $recentProjects->isNotEmpty()): ?>
                ...
                <div class="d-flex justify-content-between align-items-start mb-2">
                  <div class="flex-grow-1">
                    <h6 class="mb-1" style="color: #111827; font-weight: 600; font-size: 16px;">
                      <?php if($project->subscription && $project->subscription->client && $project->subscription->client->user): ?>
                        <?php echo e(__('Projet pour')); ?> <?php echo e($project->subscription->client->user->name); ?>

                  <?php else: ?>
                        <?php echo e(__('Projet')); ?> #<?php echo e($project->id); ?>

                  <?php endif; ?>
                          </h6>
                    <small class="text-muted" style="font-size: 14px;">
                      <i class="fas fa-calendar me-1"></i>
                      <?php echo e($project->end_at ? $project->end_at->format('d/m/Y') : __('Date non disponible')); ?>
                  ...
                  <span class="badge" style="background: rgba(16, 185, 129, 0.1); color: #10B981; border: 1px solid rgba(16, 185, 129, 0.2); padding: 8px 14px; border-radius: 8px;">
                    <i class="fas fa-check-circle me-1"></i><?php echo e(__('Livré')); ?>

                  </span>
                  </div>
                <?php if($project->report_text): ?>
                  <p class="mb-0 mt-3" style="font-size: 15px; line-height: 1.7; color: #6B7280;">
                    <?php echo e(Str::limit($project->report_text, 200)); ?>
          ...
          <div style="background: #F8FAFC; border: 1px solid #E5E7EB; border-radius: 16px; padding: 60px; text-align: center;">
            ...
            <p style="color: #6B7280; font-size: 16px; margin-bottom: 0;"><?php echo e(__('Portfolio en cours de construction...')); ?></p>
            </div>
          <?php endif; ?>
        </div>
      ...
      <div class="freelance-content-section" id="agenda">
        ...
        <div style="background: rgba(79, 70, 229, 0.1); border: 1px solid rgba(79, 70, 229, 0.2); border-radius: 16px; padding: 20px; margin-bottom: 24px;">
          <div class="d-flex align-items-start gap-3">
            ...
            <p style="font-size: 15px; color: #374151; margin-bottom: 0; line-height: 1.6;">
              <?php echo e(__('Sélectionnez l\'heure de votre premier Rituel. Les créneaux sont affichés dans votre fuseau horaire.')); ?>
        ...
        <div style="text-align: center; padding: 40px 20px; background: white; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          <div style="margin-bottom: 24px;">
            ...
            <h3 style="font-size: 24px; font-weight: 600; color: #111827; margin-bottom: 12px;"><?php echo e(__('Programmez vos Rituels')); ?></h3>
            <p style="font-size: 16px; color: #6B7280; margin-bottom: 0; max-width: 500px; margin-left: auto; margin-right: auto;">
              <?php echo e(__('Accédez à notre nouveau système de réservation pour sélectionner vos créneaux horaires facilement.')); ?>

            </p>
          </div>
          <?php if(auth()->guard('web')->check()): ?>
            <a href="<?php echo e(route('freelance.booking', $freelancer->id)); ?>" 
               class="btn" 
              ...
              <i class="fas fa-calendar-alt"></i>
              <?php echo e(__('Accéder au calendrier')); ?>
          ...
          <?php else: ?>
            <a href="<?php echo e(route('user.login')); ?>" 
              ...
              <?php echo e(__('Se connecter pour réserver')); ?>
      ...
      <!-- Section 8 : Ces freelances pourraient aussi vous intéresser -->
                <?php if(isset($recommendedFreelancers) && $recommendedFreelancers->isNotEmpty()): ?>
        <div class="freelance-content-section">
          <h2 class="freelance-section-title">
            <i class="fas fa-users"></i>
            <?php echo e(__('Ces freelances pourraient aussi vous intéresser')); ?>

          </h2>
          <div class="row g-4">
            <?php $__currentLoopData = $recommendedFreelancers->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recFreelancer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($recFreelancer->user) && $recFreelancer->user): ?>
                  ...
                  <div style="background: white; border: 1px solid #E5E7EB; border-radius: 20px; padding: 24px; transition: all 0.2s; cursor: pointer; height: 100%;" 
                    ...
                    <div class="text-center mb-3">
                          <?php if($recFreelancer->user->image): ?>
                            <img src="<?php echo e(asset('assets/img/users/' . $recFreelancer->user->image)); ?>" 
                                 alt="<?php echo e($recFreelancer->user->name); ?>" 
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto"
                             style="width: 64px; height: 64px; background: var(--junspro-gradient); color: white; font-weight: 700; font-size: 24px;">
                              <?php echo e(strtoupper(substr($recFreelancer->user->name ?? 'F', 0, 1))); ?>

                            </div>
                              <?php endif; ?>
                            </div>
                    <h4 class="text-center mb-2" style="font-size: 16px; font-weight: 600; color: #111827;"><?php echo e($recFreelancer->user->name); ?></h4>
                    <div class="text-center mb-3">
                          <?php for($i = 0; $i < 5; $i++): ?>
                        <i class="fas fa-star" style="color: #FCD34D; font-size: 14px;"></i>
                          <?php endfor; ?>
                      <small class="text-muted ms-1" style="font-size: 13px;">(<?php echo e(rand(5, 50)); ?>)</small>
                    </div>
                    <div class="text-center mb-3">
                      <strong style="font-size: 18px; color: #111827;"><?php echo e(number_format($recFreelancer->hourly_rate ?? 45, 0)); ?> €</strong>
                        </div>
                        <a href="<?php echo e(route('freelance.show', $recFreelancer->id)); ?>" 
                       class="btn w-100" 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="contactModalLabel"><?php echo e(__('Envoyer un message à')); ?> <?php echo e($user->name); ?></h5>
        ...
        <div class="modal-body">
          <form id="contactFreelancerForm">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
              <label for="contactSubject" class="form-label"><?php echo e(__('Sujet')); ?></label>
              <input type="text" class="form-control" id="contactSubject" name="subject" required>
            </div>
            <div class="mb-3">
              <label for="contactMessage" class="form-label"><?php echo e(__('Message')); ?></label>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\show.blade.php ENDPATH**/ ?>