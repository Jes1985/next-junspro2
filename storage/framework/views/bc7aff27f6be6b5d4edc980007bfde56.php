...
<?php $__env->startSection('content'); ?>
  <div class="onboarding-page">
    <div class="onboarding-container">
      <?php echo $__env->make('frontend.freelance.onboarding.partials.premium-stepper', ['routeStep' => 4], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <!-- Barre de progression -->
      ...
      <div class="onboarding-content">
        ...
        <form action="<?php echo e(route('freelance.onboarding.step4.store')); ?>" method="POST" enctype="multipart/form-data" id="educationForm">
          <?php echo csrf_field(); ?>
          ...
          <div class="checkbox-group">
            <input 
              ...
              <?php echo e(old('no_degree', $data['no_degree']) ? 'checked' : ''); ?>
          ...
          <?php if(old('no_degree', $data['no_degree'])): ?>
            <input type="hidden" name="no_degree_submitted" value="1">
          <?php endif; ?>

          <!-- Formulaire de formation -->
          <div id="educationFormContainer" class="education-form" style="<?php echo e(old('no_degree', $data['no_degree']) ? 'display: none;' : ''); ?>">
            <div class="form-group">
              <label class="form-label">Université ou établissement</label>
              <input 
                type="text" 
                name="university" 
                class="form-input <?php $__errorArgs = ['university'];
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('university', $data['university'])); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input 
                type="text" 
                name="degree" 
                class="form-input <?php $__errorArgs = ['degree'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('degree', $data['degree'])); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <select name="degree_type" class="form-select <?php $__errorArgs = ['degree_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                ...
                <option value="Baccalauréat" <?php echo e(old('degree_type', $data['degree_type']) === 'Baccalauréat' ? 'selected' : ''); ?>>Baccalauréat</option>
                <option value="BTS" <?php echo e(old('degree_type', $data['degree_type']) === 'BTS' ? 'selected' : ''); ?>>BTS</option>
                <option value="DUT" <?php echo e(old('degree_type', $data['degree_type']) === 'DUT' ? 'selected' : ''); ?>>DUT</option>
                <option value="Licence" <?php echo e(old('degree_type', $data['degree_type']) === 'Licence' ? 'selected' : ''); ?>>Licence</option>
                <option value="Master 1" <?php echo e(old('degree_type', $data['degree_type']) === 'Master 1' ? 'selected' : ''); ?>>Master 1</option>
                <option value="Master 2" <?php echo e(old('degree_type', $data['degree_type']) === 'Master 2' ? 'selected' : ''); ?>>Master 2</option>
                <option value="MBA" <?php echo e(old('degree_type', $data['degree_type']) === 'MBA' ? 'selected' : ''); ?>>MBA</option>
                <option value="Doctorat" <?php echo e(old('degree_type', $data['degree_type']) === 'Doctorat' ? 'selected' : ''); ?>>Doctorat</option>
                <option value="Autre" <?php echo e(old('degree_type', $data['degree_type']) === 'Autre' ? 'selected' : ''); ?>>Autre</option>
              </select>
              <?php $__errorArgs = ['degree_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <input 
                type="text" 
                name="specialization" 
                class="form-input <?php $__errorArgs = ['specialization'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('specialization', $data['specialization'])); ?>"
            ...
            <div class="form-group">
              ...
              <div class="years-group">
                <div>
                  ...
                  <select name="study_start_year" class="form-select <?php $__errorArgs = ['study_start_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <?php for($year = date('Y'); $year >= 1950; $year--): ?>
                      <option value="<?php echo e($year); ?>" <?php echo e(old('study_start_year', $data['study_start_year']) == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
                    <?php endfor; ?>
                  </select>
                  <?php $__errorArgs = ['study_start_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                  ...
                  <select name="study_end_year" class="form-select <?php $__errorArgs = ['study_end_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    <option value="">Sélectionner...</option>
                    <option value="" <?php echo e(old('study_end_year', $data['study_end_year']) == '' ? 'selected' : ''); ?>>En cours</option>
                    <?php for($year = date('Y') + 10; $year >= 1950; $year--): ?>
                      <option value="<?php echo e($year); ?>" <?php echo e(old('study_end_year', $data['study_end_year']) == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
                    <?php endfor; ?>
                  </select>
                  <?php $__errorArgs = ['study_end_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="verified-badge-section" id="diplomaBadgeSection" style="<?php echo e(old('no_degree', $data['no_degree']) ? 'display: none;' : ''); ?>">
          ...
          <div class="onboarding-actions">
            <a href="<?php echo e(route('freelance.onboarding.step3')); ?>" class="btn-back">
              ← Retour
            </a>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\onboarding\step4.blade.php ENDPATH**/ ?>