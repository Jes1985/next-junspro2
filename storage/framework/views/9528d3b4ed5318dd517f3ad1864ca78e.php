<?php $__env->startSection('content'); ?>
  ...
  <?php if($data['status'] == 'false'): ?>
    <div class="alert alert-warning alert-block">
      <strong
        class="text-dark"><?php echo e(__('Currently, you have added ' . $data['total_service_added'] . ' services. ' . 'Your current package supports ' . $data['package_support'] . ' services. Please delete ' . $data['total_service_added'] - $data['package_support'] + 1 . ' or more services to enable service management.')); ?></strong>
    </div>
  <?php endif; ?>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="serviceForm" action="<?php echo e(isset($seller_id) ? route('freelance.services.store') : route('seller.service_management.store_service')); ?>"
                            ...
                            <div class="col-lg-6">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <select name="<?php echo e($language->code); ?>_category_id"
                                  class="form-control service-category-seller" data-lang_code="<?php echo e($language->code); ?>">
...
<?php $__env->startSection('script'); ?>
  <script>
    const imgUpUrl = "<?php echo e(isset($seller_id) ? route('freelance.services.upload_image') : route('seller.service_management.upload_slider_image')); ?>";
    const imgRmvUrl = "<?php echo e(isset($seller_id) ? route('freelance.services.remove_image') : route('seller.service_management.remove_slider_image')); ?>";
    <?php if(isset($seller_id)): ?>
    // Override the baseUrl for freelance routes
    window.freelanceMode = true;
    window.freelanceBaseUrl = "<?php echo e(url('/freelance/services')); ?>";
    <?php endif; ?>
  </script>
...
<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\service\create.blade.php ENDPATH**/ ?>