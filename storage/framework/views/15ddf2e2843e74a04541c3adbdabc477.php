...
<div class="freelancer-profile-section-premium" id="agenda">
  ...
  <div class="alert alert-info d-flex align-items-start mb-3" role="alert">
    ...
    <div>
      <small><?php echo e(__('Sélectionnez l\'heure de votre premier cours. Les heures sont affichées dans votre fuseau horaire.')); ?></small>
    </div>
  </div>
    ...
    <table class="table table-bordered text-center agenda-table-premium">
      <thead>
        <tr>
          ...
          <th class="agenda-day-header"><?php echo e(__('Lun')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Mar')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Mer')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Jeu')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Ven')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Sam')); ?></th>
          <th class="agenda-day-header"><?php echo e(__('Dim')); ?></th>
        </tr>
      </thead>
        ...
        <?php for($hour = 0; $hour < 24; $hour++): ?>
          <tr>
            <td class="agenda-time-cell">
              <span class="agenda-time-label"><?php echo e(str_pad($hour, 2, '0', STR_PAD_LEFT)); ?>:00</span>
            </td>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\partials\agenda-premium.blade.php ENDPATH**/ ?>