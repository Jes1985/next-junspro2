  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        <?php echo e(__('À qui voulez-vous le transférer ?')); ?>
    ...
    <div class="transfer-modal-body" style="max-height: calc(90vh - 200px); overflow-y: auto;">
      ...
      <div x-show="loading" class="transfer-loading">
        ...
        <p><?php echo e(__('Chargement des freelances actifs...')); ?></p>
      </div>
      ...
      <div x-show="!loading && activeFreelances.length > 0" class="transfer-freelancers-list">
        <div class="transfer-freelancers-group">
          <div class="transfer-freelancers-group-title"><?php echo e(__('Abonnements actifs')); ?></div>
            ...
            >
              ...
              <div class="transfer-freelance-info">
                ...
                <div class="transfer-freelance-details">
                  ...
                  <span x-text="freelance.rituals_remaining === 1 ? '<?php echo e(__('rituel restant')); ?>' : '<?php echo e(__('rituels restants')); ?>'"></span>
                  · 
                  <span x-text="formatPrice(freelance.price_per_ritual)"></span> <?php echo e(__('par rituel')); ?>
      ...
      <div x-show="!loading && activeFreelances.length === 0" class="transfer-empty-state">
        ...
        <p class="transfer-empty-text"><?php echo e(__('Aucun freelance actif disponible')); ?></p>
      </div>
    </div>
  </div>
</div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\active\step2-select-freelance.blade.php ENDPATH**/ ?>