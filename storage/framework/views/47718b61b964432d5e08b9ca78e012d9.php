...
<?php $__env->startSection('pageHeading'); ?>
    <?php echo e(__('Conditions Générales de Vente')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.legal-document-layout','data' => ['title' => 'Conditions Générales de Vente (CGV)','updatedAt' => '13/02/2026','toc' => $toc,'prefix' => 'cgv']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Conditions Générales de Vente (CGV)','updatedAt' => '13/02/2026','toc' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($toc),'prefix' => 'cgv']); ?>
  ...
  <p>Les traitements de données personnelles sont décrits dans la <a href="<?php echo e(url('/privacy-policy')); ?>">Politique de confidentialité</a> accessible depuis le site.</p>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\sales-terms.blade.php ENDPATH**/ ?>