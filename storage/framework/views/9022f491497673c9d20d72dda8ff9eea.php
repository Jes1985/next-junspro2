  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        <?php echo e(__('Pourquoi souhaitez-vous annuler ?')); ?>

      </h2>
      
      <p class="cancel-reason-subtitle">
        <?php echo e(__('Votre réponse nous aidera à améliorer Junspro.')); ?>
    ...
    <div class="transfer-modal-body">
      <div class="cancel-reason-options">
        ...
        >
          <div class="cancel-reason-option-content">
            ...
            <span class="cancel-reason-option-text"><?php echo e(__('C\'est trop cher')); ?></span>
          </div>
          <input 
            type="radio" 
            name="cancel_reason" 
        ...
        >
          <div class="cancel-reason-option-content">
            ...
            <span class="cancel-reason-option-text"><?php echo e(__('Il y a trop de rituels que je n\'ai pas utilisés')); ?></span>
          </div>
          <input 
            type="radio" 
            name="cancel_reason" 
        ...
        >
          <div class="cancel-reason-option-content">
            ...
            <span class="cancel-reason-option-text"><?php echo e(__('J\'ai atteint mes objectifs')); ?></span>
          </div>
          <input 
            type="radio" 
            name="cancel_reason" 
        ...
        >
          <div class="cancel-reason-option-content">
            ...
            <span class="cancel-reason-option-text"><?php echo e(__('Je voudrais changer de freelance')); ?></span>
          </div>
          <input 
            type="radio" 
            name="cancel_reason" 
        ...
        >
          <div class="cancel-reason-option-content">
            ...
            <span class="cancel-reason-option-text"><?php echo e(__('Autre')); ?></span>
          </div>
          <input 
            type="radio" 
            name="cancel_reason" 
      ...
      <div x-show="selectedReason === 'other'" class="cancel-reason-other-field">
        <textarea 
          x-model="otherReason"
          :placeholder="'<?php echo e(__('Pourquoi voulez-vous arrêter vos rituels avec')); ?> ' + tutorName + ' ?'"
    ...
    <div class="transfer-modal-footer">
      ...
      >
        <?php echo e(__('Continuer et annuler l\'abonnement')); ?>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\cancel\step2-reason.blade.php ENDPATH**/ ?>