  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Edit Partner')); ?></h5>
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('admin.home_page.update_partner')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            <label for=""><?php echo e(__('Partner URL') . '*'); ?></label>
            <input type="url" id="in_url" class="form-control" name="url" placeholder="Enter URL">
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\home-page\partners\edit.blade.php ENDPATH**/ ?>