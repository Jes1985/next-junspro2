    ...
    <div class="transfer-modal-header">
      ...
      <div x-show="creditAmount > 0" class="transfer-balance-box">
        <div class="transfer-balance-content">
          <span><?php echo e(__('Le reste de votre solde avec')); ?> <span x-text="currentTutorName"></span> (<span x-text="formatPrice(creditAmount)"></span>) <?php echo e(__('sera utilisé pour régler l\'abonnement avec')); ?> <span x-text="selectedFreelance?.name"></span>.</span>
        </div>
...
<?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\components\subscription\transfer\replace\step2-pick-plan.blade.php ENDPATH**/ ?>