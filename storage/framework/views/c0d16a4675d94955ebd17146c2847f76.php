                  ...
                  <?php $__currentLoopData = $inputFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inputField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($inputField->type == 1): ?>
                      <form class="ui-state-default"
                        action="<?php echo e(route('seller.service_management.form.delete_input', ['id' => $inputField->id])); ?>"
                        ...
                        <div class="form-group">
                          ...
                          <div class="row no-gutters">
                            ...
                            <div class="col-lg-1">
                              <a href="<?php echo e(route('seller.service_management.form.edit_input', ['form_id' => $form->id, 'input_id' => $inputField->id, 'language' => request()->input('language')])); ?>"
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-3">
              <a href="<?php echo e(route('seller.service_management.forms', ['language' => request()->input('language')])); ?>"
        ...
        <div class="card-body">
          <div class="row">
            <div class="col">
              <form id="ajaxForm"
                action="<?php echo e(route('seller.service_management.form.store_input', ['id' => $form->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
  <script type="text/javascript">
    ...
    const sortURL = "<?php echo e(route('seller.service_management.form.sort_input')); ?>";
  </script>
...
<?php echo $__env->make('seller.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\seller\form-input\index.blade.php ENDPATH**/ ?>