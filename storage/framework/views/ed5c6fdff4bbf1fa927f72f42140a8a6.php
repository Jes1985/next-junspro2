...
<?php $__env->startSection('content'); ?>
  <div class="onboarding-page">
    <div class="onboarding-container">
      <?php echo $__env->make('frontend.freelance.onboarding.partials.premium-stepper', ['routeStep' => 6], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <!-- Barre de progression -->
      ...
      <div class="onboarding-content">
        ...
        <form action="<?php echo e(route('freelance.onboarding.step6.store')); ?>" method="POST" enctype="multipart/form-data" id="videoForm">
          <?php echo csrf_field(); ?>
              ...
              <div>
                ...
                <div class="form-group">
                  ...
                  <input 
                    ...
                    name="video_url" 
                    id="video_url"
                    class="form-input <?php $__errorArgs = ['video_url'];
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('video_url', $data['video_url'])); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Aperçu vidéo -->
                <div id="videoPreviewContainer" class="video-preview-container" style="<?php echo e(empty($data['video_url']) ? 'display: none;' : ''); ?>">
                ...
                <div class="thumbnail-section" style="margin-top: 2rem;">
                  ...
                  <?php if(!empty($data['video_thumbnail_url'])): ?>
                    <!-- Aperçu avec bouton Remplacer -->
                    <div class="thumbnail-preview-container" id="thumbnailPreviewContainer">
                      <img src="<?php echo e($data['video_thumbnail_url']); ?>" alt="Miniature actuelle" id="currentThumbnail">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="onboarding-actions">
            <a href="<?php echo e(route('freelance.onboarding.step5')); ?>" class="btn-back">
              ← Retour
            </a>
  ...
  <script>
    ...
    <?php if(!empty($data['video_url'])): ?>
      updateVideoPreview('<?php echo e($data['video_url']); ?>');
    <?php endif; ?>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\frontend\freelance\onboarding\step6.blade.php ENDPATH**/ ?>