<?php $__env->startSection('content'); ?>
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="<?php echo e(route('admin.blog_management.posts', ['language' => $defaultLang->code])); ?>"><?php echo e(__('Posts')); ?></a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block"
            href="<?php echo e(route('admin.blog_management.posts', ['language' => $defaultLang->code])); ?>">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="postForm" action="<?php echo e(route('admin.blog_management.update_post', ['id' => $post->id])); ?>"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <img src="<?php echo e(asset('assets/img/posts/' . $post->image)); ?>" alt="image" class="uploaded-img">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="serial_number" placeholder="Enter Serial Number"
                    value="<?php echo e($post->serial_number); ?>">
                  <p class="text-warning mt-2 mb-0">
                    <small><?php echo e(__('The higher the serial number is, the later the post will be shown.')); ?></small>
                  </p>
                </div>

                <div id="accordion" class="mt-3">
                  <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $postData = $language->postData; ?>
                            ...
                            <div class="col-lg-6">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <input type="text" class="form-control" name="<?php echo e($language->code); ?>_title"
                                  ...
                                  value="<?php echo e(is_null($postData) ? '' : $postData->title); ?>">
                              </div>
                            </div>
                                  ...
                                  <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($category->id); ?>"
                                        <?php echo e(!empty($postData) && $postData->blog_category_id == $category->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <input type="text" class="form-control" name="<?php echo e($language->code); ?>_author"
                                  ...
                                  value="<?php echo e(is_null($postData) ? '' : $postData->author); ?>">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <textarea class="form-control summernote" name="<?php echo e($language->code); ?>_content" placeholder="Enter Post Content"
                                  data-height="300"><?php echo e(is_null($postData) ? '' : replaceBaseUrl($postData->content, 'summernote')); ?></textarea>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <input class="form-control" name="<?php echo e($language->code); ?>_meta_keywords"
                                  ...
                                  value="<?php echo e(is_null($postData) ? '' : $postData->meta_keywords); ?>">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group <?php echo e($language->direction == 1 ? 'rtl text-right' : ''); ?>">
                                ...
                                <textarea class="form-control" name="<?php echo e($language->code); ?>_meta_description" rows="5"
                                  placeholder="Enter Meta Description"><?php echo e(is_null($postData) ? '' : $postData->meta_description); ?></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\younes\Downloads\junspro-main (1)\junspro-main3\resources\views\backend\blog\post\edit.blade.php ENDPATH**/ ?>