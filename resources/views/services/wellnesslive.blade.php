...
@section('pageHeading')
  Ritual Motion | {{ $websiteInfo->website_title }}
@endsection
...
<div class="services-page-wrapper page-wellnesslive">
  {{-- Hero + Filtres premium (même système que /services/lessons) — une seule version Ritual Motion --}}
  <x-services.hero
    title="Ritual Motion"
    subtitle="Votre énergie, en direct. Votre rythme, toujours."
    micro="Trouvez votre session live ou VOD pour maintenir votre forme.
...
Live : rituel 50+10. VOD : programmes + routines + conseils premium."
  ...
  <div class="container" style="position:relative;z-index:10;">
    <x-home.search-filter
      formId="wellnessliveFiltersForm"
      :formAction="route('services.wellnesslive')"
      universe="wellnesslive"
      keywordPlaceholder="Essayez 'Pilates', 'Yoga', 'HIIT'..."
  ...
  <section id="results" class="preply-results-section" style="overflow: visible;">
    <div class="preply-results-container" style="overflow: visible;">
      <div class="preply-results-header">
        <h2 class="preply-results-count">{{ $freelancers->total() ?? 0 }} coachs disponibles</h2>
        <x-ritual-signature />
