...
@section('pageHeading')
  Rituals Services | {{ $websiteInfo->website_title }}
@endsection
...
<div class="services-page-wrapper page-at-home">
  {{-- Hero conservé --}}
  {{-- Hero + Filtres premium (même système que /services/lessons) — une seule version --}}
  <x-services.hero
    title="Rituals Services"
    subtitle="Le bon service, au bon moment, chez vous."
    micro="Des prestations cadrées, des créneaux clairs, une réservation fluide."
    :cta="['text' => 'Trouver un service', 'url' => '#results', 'variant' => 'primary']"
  />

  <div class="container" style="position:relative;z-index:10;">
    <x-home.search-filter
      formId="atHomeFiltersForm"
      :formAction="route('services.at-home')"
      universe="at-home"
      keywordPlaceholder="Essayez 'Massage', 'Ménage', 'Beauté'..."
      locationPlaceholder="Lieu (ex: Paris, Lyon...)"
  ...
  <section id="results" class="preply-results-section" style="overflow: visible;">
    <div class="preply-results-container" style="overflow: visible;">
      <div class="preply-results-header">
        <h2 class="preply-results-count">{{ $freelancers->total() ?? 0 }} professionnels disponibles</h2>
        <x-ritual-signature />
        <select class="preply-sort-select" id="sortSelect" name="sort">
          <option value="favorites" {{ request('sort', 'favorites') === 'favorites' ? 'selected' : '' }}>Trier par : Nos préférés</option>
                ...
                <div class="freelancer-card-wrapper-premium" data-freelancer-id="{{ $freelancer->id }}">
                  ...
                  @endif
                          ...
                          <div class="freelancer-job-line" style="white-space: nowrap;">
                            🗣️ Le professionnel parle {{ $langDisplay }}
                </div>
