                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select id="plan_term" name="term" class="form-control">
                        ...
                        <option value="weekly" {{ $package->term == 'weekly' ? 'selected' : '' }}>
                          {{ __('Weekly') }}
                        </option>
                        ...
                        <option value="linking" {{ $package->term == 'linking' ? 'selected' : '' }}>
                          {{ __('Linking') }}
                        </option>
                        <option value="project" {{ $package->term == 'project' ? 'selected' : '' }}>
                          {{ __('Project') }}
                        </option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="number_of_service_order" class="form-control"
                        ...
                        value="{{ $package->number_of_service_order }}">
