        ...
        <div class="category-filter-card-content">
          <div class="category-filter-card-header">
            ...
            <label class="category-filter-toggle-wrapper">
              <input type="checkbox" id="superOnlyToggle" class="category-filter-toggle-input" {{ request('super_only') == '1' ? 'checked' : '' }}>
      ...
      <div class="category-filter-card">
        ...
        <div class="category-filter-card-content">
          <div class="category-filter-card-header">
            ...
            <label class="category-filter-toggle-wrapper">
              <input type="checkbox" id="qualifiedOnlyToggle" class="category-filter-toggle-input" {{ request('qualified_only') == '1' ? 'checked' : '' }}>
              <span class="category-filter-toggle-slider"></span>
            </label>
          </div>
      ...
      <div class="category-filter-card">
        ...
        <div class="category-filter-card-content">
          <div class="category-filter-card-header">
            ...
            <label class="category-filter-toggle-wrapper">
              <input type="checkbox" id="newOnlyToggle" class="category-filter-toggle-input" {{ request('new_only') == '1' ? 'checked' : '' }}>
              <span class="category-filter-toggle-slider"></span>
            </label>
          </div>
