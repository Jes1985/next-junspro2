{{-- Modal de renouvellement d'abonnement style Preply --}}
<div class="jsp-renew-modal-overlay" id="jsp-renew-modal-overlay" aria-hidden="true" style="display: none;">
  <div class="jsp-renew-modal-container" role="dialog" aria-modal="true" aria-labelledby="jsp-renew-modal-title">
    <div class="jsp-renew-modal-content">
      {{-- En-tête avec avatar et bouton X --}}
      <div class="jsp-renew-modal-header">
        ...
        <button type="button" class="jsp-renew-modal-close" aria-label="{{ __('Fermer') }}" onclick="closeRenewModal()">
          <i class="fas fa-times"></i>
        </button>
      </div>

      {{-- Titre --}}
      <h2 id="jsp-renew-modal-title" class="jsp-renew-modal-title">{{ __('Renouvelez votre abonnement') }}</h2>
      ...
      <div class="jsp-renew-modal-pricing">
        ...
        <div class="jsp-renew-modal-pricing-row">
          <span>
            {{ __('Taxes et frais') }}
            <i class="fas fa-info-circle jsp-renew-modal-info-icon" title="{{ __('TVA française 13%') }}"></i>
          </span>
      ...
      {{-- Texte info renouvellement automatique --}}
      <div class="jsp-renew-modal-info">
        <p id="jsp-renew-modal-renewal-text">-</p>
      </div>

      {{-- Section mode de paiement avec overlay --}}
      @include('components.payment-method-overlay')
    </div>
  </div>
</div>
