  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="cancel-alternative-title">
        {{ __('Et si vous essayiez les rituels d\'un autre freelance ?') }}
      </h2>
      
      <p class="cancel-alternative-subtitle">
        {{ __('Dites-nous quels sont vos besoins et nous trouverons le freelance qu\'il vous faut.') }}
      </p>
    </div>
    ...
    <div class="transfer-modal-footer">
      ...
      >
        {{ __('Trouver un nouveau freelance') }}
      </button>
