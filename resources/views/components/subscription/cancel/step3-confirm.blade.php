  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        {{ __('Voulez-vous vraiment arrêter d\'apprendre avec') }} <span x-text="tutorName"></span> ?
      </h2>
      
      <p class="cancel-confirm-message">
        {{ __('Nous n\'ajouterons plus de rituels et nous ne débiterons plus votre carte pour cet abonnement.') }}
      </p>
    </div>
