  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <div class="cancel-prevention-avatars">
        <div class="cancel-prevention-avatar">
          <img 
            x-bind:src="tutorAvatar || '{{ asset('assets/img/noimage.jpg') }}'"
      ...
      <h2 class="cancel-prevention-title">
        {{ __('On sait que la vie peut vous mettre des bâtons dans les roues.') }}
      </h2>
      
      <p class="cancel-prevention-message">
        {{ __('Mais en abandonnant maintenant, vous pourriez perdre tout le fruit de vos efforts. Essayez plutôt de faire une pause pouvant aller jusqu\'à 20 jours.') }}
      </p>
    </div>
    ...
    <div class="transfer-modal-body">
      <div class="cancel-prevention-actions">
        ...
        >
          {{ __('Mettre l\'abonnement en pause') }}
        </button>
