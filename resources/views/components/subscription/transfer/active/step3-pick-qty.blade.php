  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        {{ __('Combien de rituels souhaitez-vous suivre avec') }} <span x-text="selectedFreelance?.name"></span> ?
      </h2>
    </div>
    ...
    <div class="transfer-modal-body">
      ...
      <div class="transfer-qty-selector">
        ...
        <div class="transfer-qty-display">
          <div class="transfer-qty-value">
            <span x-text="selectedQty"></span> <span x-text="selectedQty === 1 ? '{{ __('rituel') }}' : '{{ __('rituels') }}'"></span>
          </div>
          <div class="transfer-qty-price">
            <span x-text="formatPrice(pricePerRituel)"></span> {{ __('par rituel') }}
          </div>
        </div>
      ...
      <div class="transfer-balance-block">
        <div class="transfer-balance-header">
          <span>{{ __('Solde :') }} <strong x-text="formatPrice(creditAmount)"></strong></span>
          <span x-text="formatPrice(usedAmount)"></span> {{ __('utilisé(s)') }}
        </div>
