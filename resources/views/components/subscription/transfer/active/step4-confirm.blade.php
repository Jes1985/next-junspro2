  ...
  >
    ...
    <div class="transfer-modal-body">
      ...
      <div class="transfer-confirm-summary">
        ...
        <div class="transfer-confirm-summary-item">
          <span><span x-text="selectedQty"></span> <span x-text="selectedQty === 1 ? '{{ __('rituel') }}' : '{{ __('rituels') }}'"></span> {{ __('avec') }} <span x-text="selectedFreelance?.name"></span> :</span>
      ...
      <div class="transfer-confirm-next">
        ...
        <ul class="transfer-confirm-next-list">
          <li>
            <span>{{ __('Vous recevrez') }} <strong x-text="selectedQty"></strong> <span x-text="selectedQty === 1 ? '{{ __('rituel') }}' : '{{ __('rituels') }}'"></span> (<strong x-text="formatPrice(usedAmount)"></strong>) {{ __('avec') }} <span x-text="selectedFreelance?.name"></span>.</span>
          </li>
        </ul>
      </div>
    </div>
