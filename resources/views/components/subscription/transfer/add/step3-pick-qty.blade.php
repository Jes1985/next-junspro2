  ...
  >
    ...
    <div class="transfer-modal-header">
      ...
      <h2 class="transfer-modal-title">
        {{ __('Pour transférer des rituels, abonnez-vous à') }} <span x-text="selectedFreelance?.name"></span>
      </h2>
      
      <!-- Texte rassurant -->
      <p class="transfer-subtitle-reassurance">
        {{ __('Votre premier paiement interviendra dans 4 semaines. Vous pouvez résilier à tout moment.') }}
      </p>
    </div>
    ...
    <div class="transfer-modal-body">
      ...
      <div class="transfer-plan-cards">
        ...
        >
          <div class="transfer-plan-title">1 {{ __('Rituel') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="1 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 4)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
        ...
        >
          <div class="transfer-plan-title">2 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="2 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 8)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
        ...
        >
          <div class="transfer-plan-badge">{{ __('Populaire') }}</div>
          <div class="transfer-plan-title">3 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="3 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 12)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
      </div>
      ...
      <div x-show="showExtendedPlans" class="transfer-plan-cards-extended">
        ...
        >
          <div class="transfer-plan-title">4 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="4 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 16)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
        ...
        >
          <div class="transfer-plan-title">6 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="6 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 24)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
        ...
        >
          <div class="transfer-plan-title">8 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="8 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 32)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
        ...
        >
          <div class="transfer-plan-title">10 {{ __('Rituels') }} {{ __('par semaine') }}</div>
          <div class="transfer-plan-details">
            <span x-text="10 * 4"></span> {{ __('Rituels') }} · <span x-text="formatPrice(pricePerRituel * 40)"></span> {{ __('toutes les 4 semaines') }}
          </div>
        </button>
      </div>
