  ...
  >
    <div class="change-plan-modal-header">
      ...
      <h2 class="change-plan-modal-title">
        {{ __('Très bon choix ! Passez en revue votre nouvelle formule avec') }} <span x-text="tutorName"></span>
      </h2>
    </div>
    ...
    <div class="change-plan-modal-body">
      ...
      <div class="change-plan-timing-section">
        <h3 class="change-plan-timing-title">{{ __('Quand voulez-vous appliquer ce changement ?') }}</h3>
        ...
        <label class="change-plan-timing-option" :class="{ 'selected': applyWhen === 'now' }">
          ...
          <div class="change-plan-timing-content">
            ...
            <div class="change-plan-timing-text">
              <div class="change-plan-timing-title-option">{{ __('Maintenant') }}</div>
              <div class="change-plan-timing-description">
                {{ __('Activez votre nouvelle formule et effectuez le paiement dès aujourd\'hui. Pensez à programmer tous les Rituels restants de votre formule actuelle avant le') }} 
          ...
          <div class="change-plan-timing-content">
            ...
            <div class="change-plan-timing-text">
              <div class="change-plan-timing-title-option">
                {{ __('À la prochaine date de facturation, le') }} <span x-text="formatDate(nextBillingDate)"></span>
              </div>
