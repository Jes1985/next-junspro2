  ...
  >
    <div class="change-plan-modal-header">
      ...
      <h2 class="change-plan-modal-title">
        {{ __('Changez votre formule avec') }} <span x-text="tutorName"></span>
      </h2>
    </div>
    ...
    <div class="change-plan-modal-body">
      ...
      <div class="change-plan-option-card current">
        <div class="change-plan-option-card-badge">{{ __('Formule actuelle') }}</div>
        <div class="change-plan-option-card-content">
          ...
          <div class="change-plan-option-card-period">{{ __('toutes les 4 semaines') }}</div>
        </div>
      </div>
      ...
      <div class="change-plan-downgrade-note">
        ...
        <span>{{ __('Vous pourrez repasser à une formule supérieure à tout moment.') }}</span>
      </div>
    </div>
