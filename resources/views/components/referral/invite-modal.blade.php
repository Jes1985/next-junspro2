  ...
  >
    ...
    <div class="referral-modal-body">
      <p class="referral-modal-subtitle">
        {{ __('Ils bénéficient de :benefit_label sur leur première réservation éligible, et vous recevez :amount€ après confirmation de leur première prestation.', [
      ...
      <div class="referral-link-block">
        <label class="referral-link-label">{{ __('Votre lien de parrainage') }}</label>
      ...
      <div class="referral-share-buttons">
        <a 
          href="https://wa.me/?text={{ urlencode('Rejoins Junspro avec mon lien de parrainage : ' . $referralLink) }}"
          target="_blank"
        ...
        <a 
          href="mailto:?subject={{ urlencode('Rejoins Junspro') }}&body={{ urlencode('Rejoins Junspro avec mon lien de parrainage : ' . $referralLink) }}"
      ...
      <p class="referral-modal-disclaimer">
        {{ __('Le programme est soumis à des règles anti-abus.') }}
        <a href="{{ route('referral.conditions') }}" class="referral-link">{{ __('Voir les conditions.') }}</a>
      </p>
    </div>
  </div>
</div>
