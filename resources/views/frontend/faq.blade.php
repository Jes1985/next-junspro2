...
@php
  $faqs = [
    ...
    ['category' => 'Reprogrammation & discipline', 'question' => 'Le freelance peut-il annuler un Rituel ?', 'answer' => "<p>Non. Sur Junspro, le freelance ne peut pas annuler, il peut uniquement reprogrammer dans un cadre très précis :</p><ul><li>prévenir au moins 24h à l’avance,</li><li>reprogrammer immédiatement un nouveau créneau,</li><li>dans la même semaine,</li><li>avec un décalage maximum de +72h,</li><li>et 1 seule reprogrammation par heure réservée.</li></ul><p>Ces règles existent pour protéger votre temps et la continuité de votre Rituel.</p>"],
      ...
      <div class="faq-pills-wrap">
        <div class="faq-pills-inner">
          @foreach(array_keys($grouped) as $cat)
            <button class="faq-pill" data-target="#{{ $slugify($cat) }}">
              {{ $cat }}
            </button>
                    @endforeach
                  </div>
    ...
    <section class="pb-4">
      <div class="faq-wrapper">
        @foreach($grouped as $category => $items)
          <div id="{{ $slugify($category) }}" class="faq-section">
