...
@endphp
<main class="junspro-tarifs-explain {{ $isEnterprise ? 'tarifs-universe-enterprise' : 'tarifs-universe-grand-public' }}" data-page="tarifs-explain" data-universe="{{ $universe }}">
  <!-- Progress bar -->
  ...
  <section id="parcours" class="tarifs-container tarifs-container-with-stepper" style="padding-top: 2rem;">
    ...
    <div class="tarifs-card fade-in" id="etape-1" data-step="1">
      ...
      <div class="tarifs-slider-demo">
        ...
        <div class="tarifs-summary-table {{ $isEnterprise ? 'tarifs-order-enterprise' : 'tarifs-order-grand-public' }}">
    ...
    <div class="tarifs-card fade-in" id="etape-2" data-step="2">
      ...
      <div class="tarifs-engagement-summary {{ $isEnterprise ? 'tarifs-order-enterprise' : 'tarifs-order-grand-public' }}">
