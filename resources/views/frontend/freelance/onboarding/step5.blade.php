...
@section('content')
  <div class="onboarding-page">
    <div class="onboarding-container">
      @include('frontend.freelance.onboarding.partials.premium-stepper', ['routeStep' => 5])
      <!-- Barre de progression -->
      ...
      <div class="onboarding-content">
        ...
        @if(session('success') && !empty(old('bio')))
        ...
        <form action="{{ route('freelance.onboarding.step5.store') }}" method="POST" id="descriptionForm">
          @csrf
          ...
          <div class="form-group">
            ...
            <textarea 
              name="bio" 
              id="bio"
              class="form-textarea @error('bio') form-textarea-error @enderror"
          ...
          <div class="onboarding-actions">
            <a href="{{ route('freelance.onboarding.step4') }}" class="btn-back">
              ← Retour
            </a>
