{{-- Composant A: Header Capsule - Accès discret "Pause Souffle" visible partout (desktop + mobile) --}}
<a href="{{ route('presence.pause-souffle') }}" class="pause-souffle-header-capsule" aria-label="Faire une Pause Souffle">
