{{-- ============================================
     COMPOSANT INLINE: Pause Souffle sans encadré
     Variante inline pour intégration dans le flux de page
     Design: texte + CTA + micro-ligne, séparation fine optionnelle
     ============================================ --}}
