    ...
    <div class="legal-page-wrapper">
        <div class="privacy-page-inner">
            <aside class="privacy-sommaire-sidebar">
                <div class="privacy-sommaire-title">{{ __('Sommaire') }}</div>
            ...
            <main class="privacy-page-main">
                <div class="legal-page-header">
                    <h1 class="legal-page-title">{{ __('Politique de confidentialité') }}</h1>
                ...
                <div class="legal-page-footer">
                    ...
                    <a href="#" class="privacy-back-to-top" id="privacy-back-to-top">{{ __('Retour en haut') }}</a>
                </div>
            </main>
        </div>
    </div>
