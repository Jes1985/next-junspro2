...
<section class="why-junspro-section">
  <div class="why-junspro-container">
    <h2 class="why-junspro-title">{{ __('Pourquoi Junspro est la meilleure plateforme pour vos Rituels') }}</h2>
    <div class="why-junspro-cards">
      ...
      <div class="why-junspro-card">
        ...
        <div class="why-junspro-text">{{ __('Rituels livrés avec succès via la plateforme') }}</div>
      </div>
      <div class="why-junspro-card">
      ...
      <div class="why-junspro-card">
        ...
        <div class="why-junspro-text">{{ __('Des clients lancent un 2ᵉ Rituel avec le même freelance') }}</div>
      </div>
    </div>
  </div>
</section>
