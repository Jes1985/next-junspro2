...
<body>
  ...
  @endphp
  <div id="cover-hero" class="cover-container" @if($soieImagePath) style="background-image: url('{{ $soieImagePath }}'); background-size: cover; background-position: center; background-repeat: no-repeat;" @endif>
