      ...
      @if (!empty($websiteInfo->logo))
        <div class="logo">
          <a href="{{ route('index') }}" target="_self" title="">
            <img id="nav-logo" class="lazyload" data-src="{{ asset('assets/img/' . $websiteInfo->logo) }}" alt="Brand Logo">
          </a>
        </div>
      @endif
      <!-- Menu toggle button -->
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        @if (!empty($websiteInfo->logo))
          <a class="navbar-brand" href="{{ route('index') }}" target="_self" title="">
            <img class="lazyload" width="100px" height="70px" data-src="{{ asset('assets/img/' . $websiteInfo->logo) }}" alt="">
          </a>
        @endif
        <!-- Navigation items -->
        ...
        <div class="more-option mobile-item">
          ...
          <div class="item">
            <div class="dropdown">
              <button class="btn btn-sm btn-outline rounded-1 dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                <span>{{ __('Seller') }}</span>
              </button>
          ...
          <div class="item">
            <div class="dropdown">
              <button class="btn btn-sm btn-primary rounded-1 dropdown-toggle" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">
