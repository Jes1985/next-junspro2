...
<nav class="dashboard-nav">
  ...
  <a href="{{ route('user.projects_sessions.index') }}" class="dashboard-nav-item {{ request()->routeIs('user.projects_sessions.*') || request()->routeIs('client.subscriptions.*') ? 'active' : '' }}">{{ __('Projets & sessions') }}</a>
