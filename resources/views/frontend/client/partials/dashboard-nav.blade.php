...
<nav class="dashboard-nav">
  ...
  <a href="{{ route('user.projects_sessions.index') }}" class="dashboard-nav-item {{ request()->routeIs('user.projects_sessions.*') || request()->routeIs('client.subscriptions.*') ? 'active' : '' }}">{{ __('Rituels') }}</a>
  ...
  <a href="{{ route('client.subscriptions.first') }}" class="dashboard-nav-item {{ request()->routeIs('client.subscriptions.show') || request()->routeIs('client.subscriptions.first') ? 'active' : '' }}">{{ __('Rituels') }}</a>
</nav>
