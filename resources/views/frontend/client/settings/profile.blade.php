      ...
      <main class="settings-content">
        ...
        <form action="{{ route('user.update_profile') }}" method="POST" enctype="multipart/form-data" id="settings-form">
          ...
          <div class="form-section">
            ...
            @php
              $__clientCountryCodes = ['FR'=>'France','GP'=>'Guadeloupe','MQ'=>'Martinique','RE'=>'La Réunion','BE'=>'Belgique','CH'=>'Suisse','ES'=>'Espagne','DE'=>'Allemagne','IT'=>'Italie','PT'=>'Portugal','NL'=>'Pays-Bas','GB'=>'Royaume-Uni','CA'=>'Canada','US'=>'États-Unis','MT'=>'Malte','MC'=>'Monaco','LU'=>'Luxembourg','MA'=>'Maroc','TN'=>'Tunisie','SN'=>'Sénégal','CI'=>"Côte d'Ivoire",'IE'=>'Irlande','HR'=>'Croatie','BR'=>'Brésil','JP'=>'Japon','AE'=>'Émirats Arabes Unis','QA'=>'Qatar','SA'=>'Arabie Saoudite','SG'=>'Singapour','AU'=>'Australie','MX'=>'Mexique','CN'=>'Chine','KR'=>'Corée du Sud','IN'=>'Inde','GR'=>'Grèce','TH'=>'Thaïlande','MU'=>'Île Maurice','SC'=>'Seychelles','SE'=>'Suède','DK'=>'Danemark','NO'=>'Norvège','AT'=>'Autriche','CY'=>'Chypre','ID'=>'Indonésie','MY'=>'Malaisie','PH'=>'Philippines'];
