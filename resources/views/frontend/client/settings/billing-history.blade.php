    ...
    <div class="settings-wrapper">
      ...
      <main class="settings-content">
          ...
          <div class="billing-table-wrapper">
            <table class="billing-table">
              <thead>
                <tr>
                  <th>{{ __('Date') }}</th>
                  <th>{{ __('Projet / freelance') }}</th>
                  <th>{{ __('Type') }}</th>
                  <th>{{ __('Montant') }}</th>
                  <th>{{ __('Mode de paiement') }}</th>
                  <th>{{ __('Statut') }}</th>
                  <th class="text-right">{{ __('Facture') }}</th>
                </tr>
              </thead>
              <tbody>
        ...
        @else
          <div class="empty-state">
            ...
            <div class="empty-state-text">
              {{ __('Dès que vous aurez réservé une session ou souscrit un abonnement Junspro, vos paiements apparaîtront ici avec la possibilité de télécharger vos factures.') }}
            </div>
        ...
        <div class="settings-subsection">
          <h2>{{ __('Besoin d\'aide concernant un paiement ?') }}</h2>
          <p>
