...
@section('style')
  ...
  <style>
    /* =====================================================
       CLIENT SETTINGS â€” DESIGN SYSTÃˆME PREMIUM (v2)
       InspirÃ© du hub de paramÃ¨tres Freelance
       ===================================================== */
    :root {
    ...
    /* Tuile spÃ©ciale client (accent bleu) */
    ...
    /* â”€â”€ Formulaire profil (section sous les tiles) â”€â”€ */
    .cs-profile-card {
    ...
    /* Settings-sidebar OLD â€” unused but kept for nav partial compat */
...
@section('content')
  <div class="settings-container">
    ...
    {{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• HERO BANNER â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
    <div class="cs-hero">
      <div class="cs-hero-text">
        ...
        <p class="cs-hero-subtitle">GÃ©rez votre compte, vos paiements, vos notifications et vos prÃ©fÃ©rences Junspro depuis cet espace.</p>
      </div>
    ...
    {{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• SECTION TILES â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
    ...
    <p class="cs-section-subtitle">AccÃ©dez Ã  tous vos rÃ©glages. Cliquez sur une tuile pour la configurer.</p>
    ...
    <div class="settings-tiles-hub">
      ...
      <a href="#profil" class="cs-tile">
        ...
        <div class="cs-tile-desc">Photo, prÃ©nom, nom, ville, pays, fuseau horaire.<br><span style="font-size:.88em;color:#a1a1aa;">Ce que vous prÃ©sentez sur la plateforme.</span></div>
      ...
      <a href="{{ route('user.settings.password') }}" class="cs-tile">
        ...
        <div class="cs-tile-title">SÃ©curitÃ©</div>
      ...
      <a href="{{ route('user.settings.email.edit') }}" class="cs-tile">
        ...
        <div class="cs-tile-desc">E-mail de connexion, vÃ©rification et notifications.</div>
        <span class="cs-tile-btn">Modifier</span>
      </a>

      {{-- 4. Modes de paiement (client spÃ©cifique) --}}
      <a href="{{ route('user.settings.payment_methods.index') }}" class="cs-tile client-accent">
        ...
        <div class="cs-tile-desc">Cartes bancaires Stripe, CB enregistrÃ©es.<br><span style="font-size:.88em;color:#a1a1aa;">NÃ©cessaire pour rÃ©server vos rituels.</span></div>
        <span class="cs-tile-btn">GÃ©rer</span>
        <span class="cs-tile-badge new">Client</span>
      </a>

      {{-- 5. Abonnement Junspro (client spÃ©cifique) --}}
      <a href="{{ route('user.settings.subscription') }}" class="cs-tile client-accent">
        ...
        <div class="cs-tile-desc">Plan actuel, renouvellement, pause ou rÃ©siliation.<br><span style="font-size:.88em;color:#a1a1aa;">GÃ©rez votre accÃ¨s Ã  la plateforme.</span></div>
        <span class="cs-tile-btn">Voir mon plan</span>
      </a>

      {{-- 6. Historique de paiement (client spÃ©cifique) --}}
      <a href="{{ route('user.settings.billing_history') }}" class="cs-tile client-accent">
        ...
        <div class="cs-tile-desc">Factures, reÃ§us et rÃ©capitulatifs de transactions.</div>
        <span class="cs-tile-btn">Consulter</span>
      </a>

      {{-- 7. Agenda & fuseau horaire (client spÃ©cifique) --}}
      <a href="{{ route('user.settings.agenda') }}" class="cs-tile client-success">
        ...
        <div class="cs-tile-desc">Calendrier de rituels, fuseau horaire affichÃ©.<br><span style="font-size:.88em;color:#a1a1aa;">Indispensable pour la gestion de vos sÃ©ances.</span></div>
        <span class="cs-tile-btn">Configurer</span>
      </a>

      {{-- 8. Confirmation automatique (client spÃ©cifique) --}}
      <a href="{{ route('user.settings.auto_confirmation') }}" class="cs-tile client-success">
        ...
        <div class="cs-tile-desc">Acceptation automatique des rituels programmÃ©s.<br><span style="font-size:.88em;color:#a1a1aa;">Simplifiez la gestion de vos rÃ©servations.</span></div>
        <span class="cs-tile-btn">ParamÃ©trer</span>
      ...
      <a href="{{ $connectionsUrl }}" class="cs-tile">
        ...
        <div class="cs-tile-desc">GÃ©rer vos connexions sociales (Google, Facebook) et accÃ¨s OAuth.</div>
        <span class="cs-tile-btn">GÃ©rer</span>
      </a>
      ...
      <a href="{{ $deleteAccountUrl }}" class="cs-tile cs-danger">
        ...
        <div class="cs-tile-desc">DÃ©sactiver ou supprimer dÃ©finitivement votre compte client.<br><span style="font-size:.88em;color:#ef4444;">Action irrÃ©versible. Toutes vos donnÃ©es seront effacÃ©es.</span></div>
    ...
    {{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• DIVIDER â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
    ...
    {{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• FORMULAIRE PROFIL â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
    <div class="cs-profile-card">
      <div class="cs-profile-card-header">
        ...
        <div>
          ...
          <p>Photo, coordonnÃ©es et informations affichÃ©es sur la plateforme.</p>
        </div>
      </div>
      ...
      <form action="{{ route('user.update_profile') }}" method="POST" enctype="multipart/form-data" id="settings-form" class="settings-form">
        ...
        <div class="form-section">
          <h3 class="form-section-title">{{ __('IdentitÃ©') }}</h3>
          <div class="form-row">
            <div class="form-group">
              <label for="first_name" class="form-label">{{ __('PrÃ©nom') }}</label>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="phone_number" class="form-label">{{ __('TÃ©lÃ©phone') }}</label>
          ...
          <div class="social-connection-item">
            <div class="social-connection-info">
              ...
              <div class="social-connection-text">
                ...
                <span id="facebook-status">{{ __("Le compte Facebook n'est pas connectÃ©") }}</span>
              </div>
            </div>
              ...
              <div class="social-connection-text">
                ...
                <span id="google-status">
                  @if($user->provider == 'google')
                    {{ __('ConnectÃ©(e) en tant que') }} {{ $user->email_address }}
                  @else
                    {{ __("Le compte Google n'est pas connectÃ©") }}
                  @endif
                </span>
              </div>
            </div>
            @if($user->provider == 'google')
              <button type="button" class="social-connection-action connected" id="disconnect-google">{{ __('DÃ©connecter') }}</button>
            @else
  ...
  <script>
    ...
    document.getElementById('disconnect-google')?.addEventListener('click', function() {
      if (confirm('{{ __("ÃŠtes-vous sÃ»r de vouloir dÃ©connecter votre compte Google ?") }}')) {
        alert('{{ __("La dÃ©connexion sera disponible prochainement.") }}');
      }
    });

    // Smooth scroll sur les tiles qui restent sur la mÃªme page (#profil)
