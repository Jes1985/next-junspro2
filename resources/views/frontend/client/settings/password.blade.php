    ...
    <div class="settings-wrapper">
      ...
      <main class="settings-content">
        ...
        <div class="settings-header">
          <h1>{{ __('Sécurisez votre compte') }}</h1>
        ...
        <form method="POST" action="{{ route('user.settings.password.update') }}" class="settings-form">
          ...
          <div class="form-group">
            ...
            <input
              ...
              type="password"
              name="new_password"
              class="form-control @error('new_password') has-error @enderror"
            ...
            <p class="form-hint">
              {{ __('Votre nouveau mot de passe doit contenir au minimum :') }}
            </p>
            <ul class="password-rules">
              <li>{{ __('8 caractères ou plus') }}</li>
              <li>{{ __('Une lettre majuscule et une lettre minuscule') }}</li>
              <li>{{ __('Au moins un chiffre') }}</li>
              <li>{{ __('Au moins un caractère spécial (ex. ! @ # ?)') }}</li>
            </ul>
          </div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              class="form-control @error('new_password_confirmation') has-error @enderror"
              autocomplete="new-password"
              required
            >
          ...
          <div class="form-actions">
            <button type="submit" class="btn-primary-gradient">
              <i class="fas fa-save"></i> {{ __('Enregistrer le nouveau mot de passe') }}
            </button>
