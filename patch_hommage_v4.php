...
<div class="activity-content hommage-chantal" style="font-family: Georgia, serif; line-height: 1.9; color: #1a1a2e;">
  ...
  <p style="font-size: 1.05rem; margin-bottom: 1.5rem;">
    ...
    Avec mes rêves que je remettais à plus tard.<br>
    À côté de moi-même.
  </p>
...
<div class="activity-content hommage-chantal" style="font-family: Georgia, serif; line-height: 1.9; color: #1a1a2e;">
  ...
  <p style="font-size: 1.05rem; margin-bottom: 1.5rem;">
    ...
    With my dreams I kept putting off until later.<br>
    Alongside myself.
  </p>
...
echo "✅ v4 — sœur + gratitude + vouloir être pour ses enfants (FR + EN)\n";
echo "✅ v4 — passage 'à côté' reformulé sans 'amis' (FR + EN)\n";
